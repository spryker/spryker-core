...
return Symfony\CS\Config\Config::create()
    ...
    ->addCustomFixer(new \Spryker\Zed\Development\Business\CodeStyleFixer\FunctionSpacingFixer())
    ->addCustomFixer(new \Spryker\Zed\Development\Business\CodeStyleFixer\MethodArgumentDefaultValueFixer())
    ->addCustomFixer(new \Spryker\Zed\Development\Business\CodeStyleFixer\RemoveFunctionAliasFixer())
    ->addCustomFixer(new \Spryker\Zed\Development\Business\CodeStyleFixer\ShortCastFixer())
    ...
    ->addCustomFixer(new \Spryker\Zed\Development\Business\CodeStyleFixer\PreferCastOverFunctionFixer())
