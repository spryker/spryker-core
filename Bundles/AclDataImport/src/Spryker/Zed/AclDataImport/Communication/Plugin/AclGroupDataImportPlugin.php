 ...
 */
class AclGroupDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    public function import(
        ...
        return $this->getFacade()->importAclGroups($dataImporterConfigurationTransfer);
    }
    ...
    {
        return AclDataImportConfig::IMPORT_TYPE_ACL_GROUP;
    }
}
