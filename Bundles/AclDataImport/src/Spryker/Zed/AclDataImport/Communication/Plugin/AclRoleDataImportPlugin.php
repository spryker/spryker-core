 ...
 */
class AclRoleDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    public function import(
        ...
        return $this->getFacade()->importAclRoles($dataImporterConfigurationTransfer);
    }
    ...
    {
        return AclDataImportConfig::IMPORT_TYPE_ACL_ROLE;
    }
}
