 ...
 */
class AclEntitySegmentConnectorDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    {
        return $this->getFacade()->importAclEntitySegmentConnector($dataImporterConfigurationTransfer);
    }
    ...
    {
        return AclEntityDataImportConfig::IMPORT_TYPE_ACL_ENTITY_SEGMENT_CONNECTOR;
    }
}
