 ...
 */
class AclEntitySegmentDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    {
        return $this->getFacade()->importAclEntitySegment($dataImporterConfigurationTransfer);
    }
    ...
    {
        return AclEntityDataImportConfig::IMPORT_TYPE_ACL_ENTITY_SEGMENT;
    }
}
