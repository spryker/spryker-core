...
class ApiCommunicationFactory extends AbstractCommunicationFactory
{
    ...
    public function createServerVariableFilterStrategy(): ServerVariableFilterStrategyInterface
    {
        if (!array_key_exists(
            ...
            ApiConstants::ENV_SERVER_VARIABLE_STRATEGY_FILTERER_MAP
        )) {
        ...
        $strategyClass = ApiConstants::ENV_SERVER_VARIABLE_STRATEGY_FILTERER_MAP[$this->getConfig()->getServerVariablesFilterStrategy()];
