...
namespace Spryker\Client\AppCatalogGui\Dependency\Service;

class AppCatalogGuiToUtilEncodingServiceBridge implements AppCatalogGuiToUtilEncodingServiceInterface
{
    /**
