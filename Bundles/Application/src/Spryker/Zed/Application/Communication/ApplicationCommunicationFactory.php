...
use Spryker\Zed\Application\Communication\Plugin\Subscriber\MigrateSessionEventSubscriber;
...
class ApplicationCommunicationFactory extends AbstractCommunicationFactory
{
     ...
     * @return \Symfony\Component\EventDispatcher\EventSubscriberInterface
     */
    public function createMigrateSessionEventSubscriber(): EventSubscriberInterface
    {
        return new MigrateSessionEventSubscriber();
    }
}
