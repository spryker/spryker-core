 ...
 */
class AvailabilityWishlistItemExpanderPlugin extends AbstractPlugin implements WishlistItemExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Expands `WishlistItem` transfer object with product concrete availability.
     *
     * @api
     *
    ...
    {
        return $this->getFacade()->expandWishlistItemWithAvailability($wishlistItemTransfer);
    }
}
