...
class AvailabilityTable extends AbstractTable
{
    ...
    protected function prepareData(TableConfiguration $config)
    {
        ...
        foreach ($queryResult as $productItem) {
            ...
            $result[] = [
                ...
                AvailabilityHelperInterface::STOCK_QUANTITY => $this->getStockQuantity($isBundleProduct, $productItem),
     ...
     */
    protected function getStockQuantity(bool $isBundleProduct, array $productItem): Decimal
    {
