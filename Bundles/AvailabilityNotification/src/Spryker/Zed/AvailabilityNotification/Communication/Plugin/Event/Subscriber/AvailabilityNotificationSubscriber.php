...
class AvailabilityNotificationSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(AvailabilityEvents::AVAILABILITY_NOTIFICATION, new AvailabilityNotificationListener(), 0, null, $this->getConfig()->getAvailabilityNotificationEventQueueName());
    }
}
