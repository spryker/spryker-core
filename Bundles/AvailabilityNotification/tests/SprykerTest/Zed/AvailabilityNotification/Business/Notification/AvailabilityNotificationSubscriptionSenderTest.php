 ...
 * @group Business
 * @group Notification
 * @group AvailabilityNotificationSubscriptionSenderTest
 * Add your own group annotations below this line
 */
class AvailabilityNotificationSubscriptionSenderTest extends Unit
{
    /**
    ...
    public function testSendNotificationSendsMailTransferExpandedWithStoreName(): void
    {
        ...
        //Act
        $availabilityNotificationSubscriptionSender = new AvailabilityNotificationSubscriptionSender(
            $mailFacadeMock,
            $this->createProductFacadeMock(),
            $this->createUrlGeneratorMock(),
            $this->createProductAttributeFinderMock(),
        );
        $availabilityNotificationSubscriptionSender->send($availabilityNotificationSubscriptionTransfer);
    }
