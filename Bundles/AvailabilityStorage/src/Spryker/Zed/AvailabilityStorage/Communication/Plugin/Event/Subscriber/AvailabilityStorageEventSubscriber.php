...
class AvailabilityStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(AvailabilityEvents::AVAILABILITY_ABSTRACT_PUBLISH, new AvailabilityStoragePublishListener(), 0, null, $this->getConfig()->getAvailabilityEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(AvailabilityEvents::AVAILABILITY_ABSTRACT_UNPUBLISH, new AvailabilityStorageUnpublishListener(), 0, null, $this->getConfig()->getAvailabilityEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(AvailabilityEvents::ENTITY_SPY_AVAILABILITY_ABSTRACT_CREATE, new AvailabilityStoragePublishListener(), 0, null, $this->getConfig()->getAvailabilityEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(AvailabilityEvents::ENTITY_SPY_AVAILABILITY_ABSTRACT_UPDATE, new AvailabilityStoragePublishListener(), 0, null, $this->getConfig()->getAvailabilityEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(AvailabilityEvents::ENTITY_SPY_AVAILABILITY_ABSTRACT_DELETE, new AvailabilityStorageUnpublishListener(), 0, null, $this->getConfig()->getAvailabilityEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_UPDATE, new AvailabilityProductStorageListener(), 0, null, $this->getConfig()->getAvailabilityEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(AvailabilityEvents::ENTITY_SPY_AVAILABILITY_UPDATE, new AvailabilityStockStorageListener(), 0, null, $this->getConfig()->getAvailabilityEventQueueName());
    }
}
