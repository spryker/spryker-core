 ...
 */
class IsOnBehalfCustomerTransferExpanderPlugin extends AbstractPlugin implements CustomerTransferExpanderPluginInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    {
        return $this->getFacade()->expandCustomerWithIsOnBehalf($customerTransfer);
    }
}
