 ...
 */
class DiscountAmountAggregatorForGenericAmountPlugin extends AbstractPlugin implements CalculationPluginInterface
{
    /**
     * @api
     *
    ...
    {
        $this->getFacade()->calculateDiscountAmountAggregationForGenericAmount($calculableObjectTransfer);
    }
}
