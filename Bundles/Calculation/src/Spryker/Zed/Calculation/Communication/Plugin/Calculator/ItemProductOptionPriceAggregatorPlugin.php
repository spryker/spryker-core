 ...
 */
class ItemProductOptionPriceAggregatorPlugin extends AbstractPlugin implements CalculatorPluginInterface
{
    ...
    {
        $this->getFacade()
            ->calculateProductOptionPriceAggregation($quoteTransfer);
    }
