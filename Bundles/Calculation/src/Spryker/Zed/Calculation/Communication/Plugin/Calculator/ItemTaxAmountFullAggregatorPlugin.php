 ...
 */
class ItemTaxAmountFullAggregatorPlugin extends AbstractPlugin implements CalculatorPluginInterface
{
    ...
    {
        $this->getFacade()
            ->calculateItemTaxAmountFullAggregation($quoteTransfer);
    }
}
