...
class CartChangeRequestExpander implements CartChangeRequestExpanderInterface
{
    ...
    /**
     * @param array<\Spryker\Client\CartExtension\Dependency\Plugin\CartChangeRequestExpanderPluginInterface> $addItemsRequestExpanderPlugins
     * @param array<\Spryker\Client\CartExtension\Dependency\Plugin\CartChangeRequestExpanderPluginInterface> $removeItemRequestExpanderPlugins
     */
