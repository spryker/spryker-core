...
class ZedCart implements CartInterface
{
    ...
    public function addItems($cartItemCollection)
    {
        ...
        $order = $this->zedClient->call('cart/gateway/add-items', $transferCartChange);
        $this->setOrder($order);
    ...
    public function removeItems(
        ...
        $order = $this->zedClient->call('cart/gateway/remove-items', $transferCartChange);
        $this->setOrder($order);
    ...
    {
        $transferCartChange = $this->createCartChange($cartItemCollection);
        $order = $this->zedClient->call('cart/gateway/change-quantity', $transferCartChange);
        $this->setOrder($order);
    ...
    public function clear($reason = DeleteReasonConstant::DELETE_REASON_ORDER_PLACEMENT)
    {
        ...
        $transferCartChange->setDeleteReason($reason);
        $order = $order = $this->zedClient->call('cart/gateway/clear-cart-storage', $transferCartChange);
        $this->setOrder($order);
    ...
    public function addCoupon($couponCode)
    {
        ...
        $order = $this->zedClient->call('cart/gateway/add-coupon-code', $cartChange);
        $this->setOrder($order);
    ...
    {
        $cartChange = $this->createCartChange();
        $order = $this->zedClient->call('cart/gateway/clear-coupon-code', $cartChange);
        $this->setOrder($order);
    ...
    public function removeCoupon($couponCode)
    {
        $cartChange = $this->createCartChange();
        $cartChange->setCouponCode($couponCode);
        $order = $this->zedClient->call('cart/gateway/remove-coupon-code', $cartChange);
        $this->setOrder($order);
