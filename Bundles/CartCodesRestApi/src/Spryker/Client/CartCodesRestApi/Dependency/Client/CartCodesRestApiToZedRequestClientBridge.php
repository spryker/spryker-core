...
namespace Spryker\Client\CartCodesRestApi\Dependency\Client;

use Spryker\Shared\Kernel\Transfer\TransferInterface;

class CartCodesRestApiToZedRequestClientBridge implements CartCodesRestApiToZedRequestClientInterface
{
    /**
