...
class GuestCartVouchersResourceRoutePlugin extends AbstractPlugin implements ResourceRoutePluginInterface, ResourceWithParentPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return CartCodesRestApiConfig::RESOURCE_GUEST_CARTS;
    }
}
