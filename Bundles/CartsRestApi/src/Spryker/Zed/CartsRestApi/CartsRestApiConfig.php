...
class CartsRestApiConfig extends AbstractBundleConfig
{
    ...
    public const RESPONSE_ERROR_MAP = [
        ...
        self::GLOSSARY_KEY_PERMISSION_FAILED => SharedCartsRestApiConfig::EXCEPTION_MESSAGE_PERMISSION_FAILED,
        self::GLOSSARY_KEY_CAN_NOT_REMOVE_LAST_CART => SharedCartsRestApiConfig::RESPONSE_CODE_FAILED_DELETING_CART,
        self::MESSAGE_STORE_DATA_IS_MISSING => SharedCartsRestApiConfig::RESPONSE_CODE_STORE_DATA_IS_MISSING,
        self::MESSAGE_CURRENCY_DATA_IS_MISSING => SharedCartsRestApiConfig::RESPONSE_CODE_CURRENCY_DATA_IS_MISSING,
        self::MESSAGE_CURRENCY_DATA_IS_INCORRECT => SharedCartsRestApiConfig::RESPONSE_CODE_CURRENCY_DATA_IS_INCORRECT,
        self::MESSAGE_PRICE_MODE_DATA_IS_MISSING => SharedCartsRestApiConfig::RESPONSE_CODE_PRICE_MODE_DATA_IS_MISSING,
        self::MESSAGE_PRICE_MODE_DATA_IS_INCORRECT => SharedCartsRestApiConfig::RESPONSE_CODE_PRICE_MODE_DATA_IS_INCORRECT,
    ];
}
