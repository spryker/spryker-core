...
class CatalogSearchSuggestionsResourceRoutePlugin extends AbstractPlugin implements ResourceRoutePluginInterface
{
    ...
    {
        return CatalogSearchRestApiConfig::RESOURCE_CATALOG_SEARCH_SUGGESTIONS;
    }
    ...
    {
        return 'catalog-search-suggestions-resource';
    }
    ...
    {
        return RestCatalogSearchSuggestionsAttributesTransfer::class;
    }
}
