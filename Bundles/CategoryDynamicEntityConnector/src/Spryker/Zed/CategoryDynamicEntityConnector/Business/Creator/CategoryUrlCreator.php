...
class CategoryUrlCreator implements CategoryUrlCreatorInterface
{
    ...
    public function createCategoryUrlByDynamicEntityRequest(
        ...
        $categoryUrlCollectionResponseTransfer = $this->categoryFacade->createCategoryUrlCollection(
    ...
    protected function isApplicable(DynamicEntityPostEditRequestTransfer $dynamicEntityPostEditRequestTransfer): bool
    {
        return in_array(
            ...
            $this->categoryDynamicEntityConnectorConfig->getCategoryUrlOnCreateByDynamicEntityApplicableTables(),
            true,
        );
    }
