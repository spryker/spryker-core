...
class CategoryClosureTableUpdater implements CategoryClosureTableUpdaterInterface
{
    ...
    public function updateCategoryClosureTableByDynamicEntityRequest(
        ...
        $categoryClosureTableCollectionResponseTransfer = $this->categoryFacade->updateCategoryClosureTableCollection(
    ...
    protected function isApplicable(DynamicEntityPostEditRequestTransfer $dynamicEntityPostEditRequestTransfer): bool
    {
        return in_array(
            ...
            $this->categoryDynamicEntityConnectorConfig->getCategoryClosureTableOnUpdateByDynamicEntityApplicableTables(),
            true,
        );
    }
