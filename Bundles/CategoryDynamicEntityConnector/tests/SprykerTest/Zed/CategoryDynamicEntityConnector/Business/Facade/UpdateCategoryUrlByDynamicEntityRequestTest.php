 ...
 * @group Business
 * @group Facade
 * @group UpdateCategoryUrlByDynamicEntityRequestTest
 * Add your own group annotations below this line
 */
class UpdateCategoryUrlByDynamicEntityRequestTest extends Unit
{
    /**
     ...
     * @return void
     */
    public function testUpdatesCategoryUrlWhenLocalizedAttributeIsChanged(): void
    {
        // Arrange
        ...
        $categoryLocalizedAttributesTransfer->setName('New name');
        ...
        // Act
        $dynamicEntityPostEditResponseTransfer = $this->tester->getFacade()->updateCategoryUrlByDynamicEntityRequest(
        ...
        $this->tester->assertNotSame($initialCategoryUrlEntity->getUrl(), $categoryUrlEntity->getUrl());
        $this->assertRegExp('/.*\/new-name/', $categoryUrlEntity->getUrl());
    }

    /**
     * @return void
     */
    public function testDoesNothingWhenCategoryDoesNotHaveNode(): void
    {
    ...
    public function testDoesNothingWhenNotApplicableTableNameIsProvided(): void
    {
        ...
        $this->assertSame($initialCategoryUrlEntity->getUrl(), $categoryUrlEntity->getUrl());
        $this->assertNotRegExp('/.*\/new-name/', $categoryUrlEntity->getUrl());
    }
    ...
    protected function createCategoryDynamicEntityConnectorToCategoryFacadeBridgeMock(): CategoryDynamicEntityConnectorToCategoryFacadeInterface
    {
        $categoryDynamicEntityConnectorToCategoryFacadeBridge = $this->getMockBuilder(CategoryDynamicEntityConnectorToCategoryFacadeBridge::class)
            ->onlyMethods(['updateCategoryUrlCollection'])
        ...
        $categoryDynamicEntityConnectorToCategoryFacadeBridge->expects($this->never())
            ->method('updateCategoryUrlCollection');
