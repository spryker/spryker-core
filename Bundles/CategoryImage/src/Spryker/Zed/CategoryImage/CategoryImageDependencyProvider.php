...
class CategoryImageDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    {
        $container->set(static::PROPEL_QUERY_CATEGORY_IMAGE, function (Container $container) {
    ...
    {
        $container->set(static::PROPEL_QUERY_CATEGORY_IMAGE_SET, function (Container $container) {
    ...
    {
        $container->set(static::PROPEL_QUERY_CATEGORY_IMAGE_SET_TO_CATEGORY_IMAGE, function (Container $container) {
