...
use Spryker\Client\CategoryImageStorage\Dependency\CategoryImageStorageToStorageClientBridge;
use Spryker\Client\CategoryImageStorage\Dependency\CategoryImageStorageToSynchronizationServiceBridge;
use Spryker\Client\Kernel\AbstractDependencyProvider;
use Spryker\Client\Kernel\Container;

class CategoryImageStorageDependencyProvider extends AbstractDependencyProvider
{
