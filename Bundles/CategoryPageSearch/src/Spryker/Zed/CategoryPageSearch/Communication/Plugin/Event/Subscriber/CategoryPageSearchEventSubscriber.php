...
class CategoryPageSearchEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_TEMPLATE_CREATE, new CategoryNodeCategoryTemplateSearchPublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_TEMPLATE_UPDATE, new CategoryNodeCategoryTemplateSearchPublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_TEMPLATE_DELETE, new CategoryNodeCategoryTemplateSearchUnpublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_ATTRIBUTE_CREATE, new CategoryNodeCategoryAttributeSearchPublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_ATTRIBUTE_UPDATE, new CategoryNodeCategoryAttributeSearchPublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_ATTRIBUTE_DELETE, new CategoryNodeCategoryAttributeSearchUnpublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_CREATE, new CategoryNodeCategoryPageSearchPublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_UPDATE, new CategoryNodeCategoryPageSearchPublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_DELETE, new CategoryNodeCategoryPageSearchUnpublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::CATEGORY_NODE_PUBLISH, new CategoryNodeSearchPublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::CATEGORY_NODE_UNPUBLISH, new CategoryNodeSearchUnpublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_NODE_CREATE, new CategoryNodeSearchPublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_NODE_UPDATE, new CategoryNodeSearchPublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_NODE_DELETE, new CategoryNodeSearchUnpublishListener(), 0, null, $this->getConfig()->getCategoryPageEventQueueName());
    }
}
