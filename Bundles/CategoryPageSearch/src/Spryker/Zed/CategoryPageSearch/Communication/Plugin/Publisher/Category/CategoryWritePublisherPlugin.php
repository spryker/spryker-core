...
class CategoryWritePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
     * - Publishes category node page search data by `SpyCategory` entity events.
     *
     * @api
     *
    ...
    {
        return [
            CategoryPageSearchConstants::ENTITY_SPY_CATEGORY_CREATE,
            CategoryPageSearchConstants::ENTITY_SPY_CATEGORY_UPDATE,
        ];
    }
}
