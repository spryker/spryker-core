...
namespace Spryker\Zed\CategoryPageSearch\Dependency\Service;

class CategoryPageSearchToUtilSanitizeServiceBridge implements CategoryPageSearchToUtilSanitizeServiceInterface
{
    /**
