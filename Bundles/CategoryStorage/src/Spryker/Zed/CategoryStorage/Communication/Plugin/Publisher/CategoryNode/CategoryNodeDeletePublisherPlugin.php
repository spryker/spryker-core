...
class CategoryNodeDeletePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
     * - Unpublishes category node data by `SpyCategoryNode` entity events.
     * - Unpublishes category node data by `CategoryNode` events.
     *
     * @api
     *
    ...
    {
        $this->getFacade()->deleteCategoryNodeStorageCollectionByCategoryNodeEvents($eventEntityTransfers);
    }
