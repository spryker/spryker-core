 ...
 */
class ClickAndCollectExamplePickupServicePointQuoteItemReplaceStrategyPlugin extends AbstractPlugin implements ServicePointQuoteItemReplaceStrategyPluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    {
        return $this->getFacade()->replacePickupQuoteItemProductOffers($quoteTransfer);
    }
}
