...
namespace Spryker\Zed\CmsBlockCategoryStorage\Dependency\Facade;

class CmsBlockCategoryStorageToEventBehaviorFacadeBridge implements CmsBlockCategoryStorageToEventBehaviorFacadeInterface
{
    /**
