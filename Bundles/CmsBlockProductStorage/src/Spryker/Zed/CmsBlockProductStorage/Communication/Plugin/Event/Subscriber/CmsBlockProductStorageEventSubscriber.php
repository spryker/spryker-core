...
class CmsBlockProductStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockProductConnectorEvents::CMS_BLOCK_PRODUCT_CONNECTOR_PUBLISH, new CmsBlockProductConnectorStoragePublishListener(), 0, null, $this->getConfig()->getCmsBlockProductEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockProductConnectorEvents::CMS_BLOCK_PRODUCT_CONNECTOR_UNPUBLISH, new CmsBlockProductConnectorStorageUnpublishListener(), 0, null, $this->getConfig()->getCmsBlockProductEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockProductConnectorEvents::ENTITY_SPY_CMS_BLOCK_PRODUCT_CONNECTOR_CREATE, new CmsBlockProductConnectorEntityStoragePublishListener(), 0, null, $this->getConfig()->getCmsBlockProductEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockProductConnectorEvents::ENTITY_SPY_CMS_BLOCK_PRODUCT_CONNECTOR_UPDATE, new CmsBlockProductConnectorEntityStoragePublishListener(), 0, null, $this->getConfig()->getCmsBlockProductEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockProductConnectorEvents::ENTITY_SPY_CMS_BLOCK_PRODUCT_CONNECTOR_DELETE, new CmsBlockProductConnectorEntityStorageUnpublishListener(), 0, null, $this->getConfig()->getCmsBlockProductEventQueueName());
    }
}
