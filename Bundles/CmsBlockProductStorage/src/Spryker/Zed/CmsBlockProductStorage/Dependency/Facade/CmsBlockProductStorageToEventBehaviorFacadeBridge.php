...
namespace Spryker\Zed\CmsBlockProductStorage\Dependency\Facade;

class CmsBlockProductStorageToEventBehaviorFacadeBridge implements CmsBlockProductStorageToEventBehaviorFacadeInterface
{
    /**
