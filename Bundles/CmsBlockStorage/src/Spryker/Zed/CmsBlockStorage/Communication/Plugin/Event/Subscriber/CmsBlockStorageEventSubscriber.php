...
class CmsBlockStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockEvents::CMS_BLOCK_PUBLISH, new CmsBlockStoragePublishListener(), 0, null, $this->getConfig()->getCmsBlockEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockEvents::CMS_BLOCK_UNPUBLISH, new CmsBlockStorageUnpublishListener(), 0, null, $this->getConfig()->getCmsBlockEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockEvents::ENTITY_SPY_CMS_BLOCK_UPDATE, new CmsBlockStoragePublishListener(), 0, null, $this->getConfig()->getCmsBlockEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockEvents::ENTITY_SPY_CMS_BLOCK_DELETE, new CmsBlockStorageUnpublishListener(), 0, null, $this->getConfig()->getCmsBlockEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockEvents::ENTITY_SPY_CMS_BLOCK_GLOSSARY_KEY_MAPPING_CREATE, new CmsBlockGlossaryKeyMappingBlockStoragePublishListener(), 0, null, $this->getConfig()->getCmsBlockEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockEvents::ENTITY_SPY_CMS_BLOCK_GLOSSARY_KEY_MAPPING_UPDATE, new CmsBlockGlossaryKeyMappingBlockStoragePublishListener(), 0, null, $this->getConfig()->getCmsBlockEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockEvents::ENTITY_SPY_CMS_BLOCK_GLOSSARY_KEY_MAPPING_DELETE, new CmsBlockGlossaryKeyMappingBlockStorageUnpublishListener(), 0, null, $this->getConfig()->getCmsBlockEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockEvents::ENTITY_SPY_CMS_BLOCK_STORE_CREATE, new CmsBlockStoreStorageListener(), 0, null, $this->getConfig()->getCmsBlockEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockEvents::ENTITY_SPY_CMS_BLOCK_STORE_UPDATE, new CmsBlockStoreStorageListener(), 0, null, $this->getConfig()->getCmsBlockEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsBlockEvents::ENTITY_SPY_CMS_BLOCK_STORE_DELETE, new CmsBlockStoreStorageListener(), 0, null, $this->getConfig()->getCmsBlockEventQueueName());
    }
}
