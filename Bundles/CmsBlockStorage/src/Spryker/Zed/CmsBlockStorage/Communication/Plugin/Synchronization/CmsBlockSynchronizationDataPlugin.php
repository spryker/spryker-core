 ...
 */
class CmsBlockSynchronizationDataPlugin extends AbstractPlugin implements SynchronizationDataQueryContainerPluginInterface
{
    /**
     * Specification:
    ...
    {
        return $this->getFactory()->getConfig()->getCmsBlockSynchronizationPoolName();
    }
}
