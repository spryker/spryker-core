 ...
 */
class CmsVersionPageCollectorStoragePlugin extends AbstractCollectorPlugin
{
    /**
     * @api
     *
    ...
    public function run(
        ...
        $this->getFacade()
            ->runStorageCmsVersionPageCollector($baseQuery, $localeTransfer, $result, $dataReader, $dataWriter, $touchUpdater, $output);
    }
}
