 ...
 */
class CmsBlockProcessorPlugin extends AbstractPlugin implements DataProcessorPluginInterface
{
    ...
    {
        $processedResultSet = $this->getDependencyContainer()->getCmsExporterFacade()->buildBlocks($resultSet, $locale);
