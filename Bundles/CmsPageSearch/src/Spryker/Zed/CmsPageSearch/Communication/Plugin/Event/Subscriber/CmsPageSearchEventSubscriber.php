...
class CmsPageSearchEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(CmsEvents::CMS_VERSION_PUBLISH, new CmsPageSearchListener(), 0, null, $this->getConfig()->getCmsPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsEvents::CMS_VERSION_UNPUBLISH, new CmsPageSearchListener(), 0, null, $this->getConfig()->getCmsPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsEvents::ENTITY_SPY_CMS_PAGE_CREATE, new CmsPageSearchListener(), 0, null, $this->getConfig()->getCmsPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsEvents::ENTITY_SPY_CMS_PAGE_UPDATE, new CmsPageSearchListener(), 0, null, $this->getConfig()->getCmsPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsEvents::ENTITY_SPY_CMS_PAGE_DELETE, new CmsPageSearchListener(), 0, null, $this->getConfig()->getCmsPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsEvents::ENTITY_SPY_CMS_VERSION_CREATE, new CmsPageVersionSearchListener(), 0, null, $this->getConfig()->getCmsPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_CREATE, new CmsPageUrlSearchListener(), 0, null, $this->getConfig()->getCmsPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_UPDATE, new CmsPageUrlSearchListener(), 0, null, $this->getConfig()->getCmsPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_DELETE, new CmsPageUrlSearchListener(), 0, null, $this->getConfig()->getCmsPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsEvents::ENTITY_SPY_CMS_STORE_CREATE, new CmsPageStoreSearchListener(), 0, null, $this->getConfig()->getCmsPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsEvents::ENTITY_SPY_CMS_STORE_UPDATE, new CmsPageStoreSearchListener(), 0, null, $this->getConfig()->getCmsPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsEvents::ENTITY_SPY_CMS_STORE_DELETE, new CmsPageStoreSearchListener(), 0, null, $this->getConfig()->getCmsPageEventQueueName());
    }
}
