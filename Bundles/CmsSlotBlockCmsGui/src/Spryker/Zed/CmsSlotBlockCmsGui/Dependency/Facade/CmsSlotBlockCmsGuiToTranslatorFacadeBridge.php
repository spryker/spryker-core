...
namespace Spryker\Zed\CmsSlotBlockCmsGui\Dependency\Facade;

class CmsSlotBlockCmsGuiToTranslatorFacadeBridge implements CmsSlotBlockCmsGuiToTranslatorFacadeInterface
{
    /**
