...
class CmsSlotBlockStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(CmsSlotBlockEvents::CMS_SLOT_BLOCK_PUBLISH, new CmsSlotBlockStoragePublishListener(), 0, null, $this->getConfig()->getCmsSlotBlockEventQueueName());
    }
}
