...
class CmsSlotTemplateDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    ...
    public function import(
        ...
        return $this->getFacade()->importCmsSlotTemplate($dataImporterConfigurationTransfer);
    }
    ...
    {
        return CmsSlotDataImportConfig::IMPORT_TYPE_CMS_SLOT_TEMPLATE;
    }
}
