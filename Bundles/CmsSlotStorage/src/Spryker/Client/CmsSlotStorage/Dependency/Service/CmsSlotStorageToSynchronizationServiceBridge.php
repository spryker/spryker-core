...
namespace Spryker\Client\CmsSlotStorage\Dependency\Service;

class CmsSlotStorageToSynchronizationServiceBridge implements CmsSlotStorageToSynchronizationServiceInterface
{
    /**
