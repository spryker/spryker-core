...
class CmsSlotStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(CmsSlotEvents::CMS_SLOT_PUBLISH, new CmsSlotStoragePublishListener(), 0, null, $this->getConfig()->getCmsSlotEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsSlotEvents::ENTITY_SPY_CMS_SLOT_CREATE, new CmsSlotStoragePublishListener(), 0, null, $this->getConfig()->getCmsSlotEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CmsSlotEvents::ENTITY_SPY_CMS_SLOT_UPDATE, new CmsSlotStoragePublishListener(), 0, null, $this->getConfig()->getCmsSlotEventQueueName());
    }
}
