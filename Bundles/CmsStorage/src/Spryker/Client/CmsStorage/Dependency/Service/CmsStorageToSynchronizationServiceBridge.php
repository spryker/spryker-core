...
namespace Spryker\Client\CmsStorage\Dependency\Service;

class CmsStorageToSynchronizationServiceBridge implements CmsStorageToSynchronizationServiceInterface
{
    /**
