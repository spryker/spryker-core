...
namespace Spryker\Client\CompanyBusinessUnit\Dependency\Client;

use Spryker\Shared\Kernel\Transfer\TransferInterface;

class CompanyBusinessUnitToZedRequestClientBridge implements CompanyBusinessUnitToZedRequestClientInterface
{
    /**
