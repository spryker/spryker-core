 ...
 */
class CompanyBusinessUnitMerchantAclEntityRuleExpanderPlugin extends AbstractPlugin implements MerchantAclEntityRuleExpanderPluginInterface
{
    /**
    ...
    /**
     * {@inheritDoc}
     * - Expands set of `AclEntityRule` transfer objects with company business unit composite data.
     *
     * @api
     *
    ...
    public function expand(array $aclEntityRuleTransfers): array
    {
        $aclEntityRuleTransfers[] = (new AclEntityRuleTransfer())
            ->setEntity('Orm\Zed\CompanyBusinessUnit\Persistence\SpyCompanyBusinessUnit')
