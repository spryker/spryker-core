...
class CompanyBusinessUnitToCompanyUserFormDataProvider
{
    /**
     * @uses \Spryker\Zed\CompanyBusinessUnitGui\Communication\Form\CompanyBusinessUnitToCompanyUserForm::OPTION_COMPANY_BUSINESS_UNIT_CHOICES
     *
     * @var string
     */
