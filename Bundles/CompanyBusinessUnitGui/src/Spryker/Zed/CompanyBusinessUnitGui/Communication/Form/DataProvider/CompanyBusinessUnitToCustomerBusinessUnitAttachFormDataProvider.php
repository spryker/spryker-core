...
class CompanyBusinessUnitToCustomerBusinessUnitAttachFormDataProvider
{
    /**
     * @uses \Spryker\Zed\CompanyBusinessUnitGui\Communication\Form\CompanyBusinessUnitToCustomerBusinessUnitAttachForm::OPTION_COMPANY_BUSINESS_UNIT_CHOICES
     *
     * @var string
     */
