 ...
 */
class CompanyBusinessUnitToCompanyUserAttachCustomerFormExpanderPlugin extends AbstractPlugin implements CompanyUserAttachCustomerFormExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Expands `CustomerCompanyAttachForm` with a `fk_company_business_unit` form field as an input box with AJAX search and suggestions.
     *
     * @api
     *
    ...
    public function expand(FormBuilderInterface $builder): FormBuilderInterface
    {
        return $this->getFactory()
            ->createCompanyBusinessUnitToCustomerCompanyAttachFormExpander()
            ->expand($builder);
    }
}
