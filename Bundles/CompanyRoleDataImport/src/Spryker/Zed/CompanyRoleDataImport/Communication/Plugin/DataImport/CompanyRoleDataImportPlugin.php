 ...
 */
class CompanyRoleDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    {
        return CompanyRoleDataImportConfig::IMPORT_TYPE_COMPANY_ROLE;
    }
}
