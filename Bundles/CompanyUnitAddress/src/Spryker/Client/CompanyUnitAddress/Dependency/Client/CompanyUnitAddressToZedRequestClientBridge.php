...
namespace Spryker\Client\CompanyUnitAddress\Dependency\Client;

use Spryker\Shared\Kernel\Transfer\TransferInterface;

class CompanyUnitAddressToZedRequestClientBridge implements CompanyUnitAddressToZedRequestClientInterface
{
    /**
