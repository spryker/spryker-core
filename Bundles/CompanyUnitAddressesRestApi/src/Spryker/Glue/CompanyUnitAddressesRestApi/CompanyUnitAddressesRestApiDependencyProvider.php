...
use Spryker\Glue\CompanyUnitAddressesRestApi\Dependency\Client\CompanyUnitAddressesRestApiToCompanyUnitAddressClientBridge;
use Spryker\Glue\Kernel\AbstractBundleDependencyProvider;
use Spryker\Glue\Kernel\Container;

/**
 * @method \Spryker\Glue\CompanyUnitAddressesRestApi\CompanyUnitAddressesRestApiConfig getConfig()
 */
class CompanyUnitAddressesRestApiDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    protected function addCompanyUnitAddressClient(Container $container): Container
    {
        $container[static::CLIENT_COMPANY_UNIT_ADDRESS] = function (Container $container) {
            return new CompanyUnitAddressesRestApiToCompanyUnitAddressClientBridge(
