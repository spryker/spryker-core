...
class CompanyUserStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(CompanyUserEvents::COMPANY_USER_PUBLISH, new CompanyUserStoragePublishListener(), 0, null, $this->getConfig()->getCompanyUserEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CompanyUserEvents::COMPANY_USER_UNPUBLISH, new CompanyUserStorageUnpublishListener(), 0, null, $this->getConfig()->getCompanyUserEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CompanyUserEvents::ENTITY_SPY_COMPANY_USER_CREATE, new CompanyUserStoragePublishListener(), 0, null, $this->getConfig()->getCompanyUserEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CompanyUserEvents::ENTITY_SPY_COMPANY_USER_UPDATE, new CompanyUserStoragePublishListener(), 0, null, $this->getConfig()->getCompanyUserEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CompanyUserEvents::ENTITY_SPY_COMPANY_USER_DELETE, new CompanyUserStorageUnpublishListener(), 0, null, $this->getConfig()->getCompanyUserEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CompanyEvents::ENTITY_SPY_COMPANY_UPDATE, new CompanyUserCompanyStoragePublishListener(), 0, null, $this->getConfig()->getCompanyUserEventQueueName());
    }
}
