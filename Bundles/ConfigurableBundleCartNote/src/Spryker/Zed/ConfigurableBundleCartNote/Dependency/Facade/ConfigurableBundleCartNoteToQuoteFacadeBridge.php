...
namespace Spryker\Zed\ConfigurableBundleCartNote\Dependency\Facade;

use Generated\Shared\Transfer\QuoteTransfer;

class ConfigurableBundleCartNoteToQuoteFacadeBridge implements ConfigurableBundleCartNoteToQuoteFacadeInterface
{
    /**
