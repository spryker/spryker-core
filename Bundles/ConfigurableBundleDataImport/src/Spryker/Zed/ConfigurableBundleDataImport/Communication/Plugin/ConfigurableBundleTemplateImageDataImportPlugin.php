 ...
 */
class ConfigurableBundleTemplateImageDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    public function import(
        ...
        return $this->getFacade()
            ->importConfigurableBundleTemplateImages($dataImporterConfigurationTransfer);
    }
    ...
    {
        return ConfigurableBundleDataImportConfig::IMPORT_TYPE_CONFIGURABLE_BUNDLE_TEMPLATE_IMAGE;
    }
}
