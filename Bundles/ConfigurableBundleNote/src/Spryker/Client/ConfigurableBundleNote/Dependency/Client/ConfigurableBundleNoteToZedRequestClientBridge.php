...
namespace Spryker\Client\ConfigurableBundleNote\Dependency\Client;

use Spryker\Shared\Kernel\Transfer\TransferInterface;

class ConfigurableBundleNoteToZedRequestClientBridge implements ConfigurableBundleNoteToZedRequestClientInterface
{
    /**
