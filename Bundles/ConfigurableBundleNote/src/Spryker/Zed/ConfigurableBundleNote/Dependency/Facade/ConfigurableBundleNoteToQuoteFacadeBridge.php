...
namespace Spryker\Zed\ConfigurableBundleNote\Dependency\Facade;

use Generated\Shared\Transfer\QuoteTransfer;

class ConfigurableBundleNoteToQuoteFacadeBridge implements ConfigurableBundleNoteToQuoteFacadeInterface
{
    /**
