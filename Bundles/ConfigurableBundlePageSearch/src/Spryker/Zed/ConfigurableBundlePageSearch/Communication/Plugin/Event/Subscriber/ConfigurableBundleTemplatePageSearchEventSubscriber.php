...
class ConfigurableBundleTemplatePageSearchEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(ConfigurableBundleEvents::CONFIGURABLE_BUNDLE_TEMPLATE_PUBLISH, new ConfigurableBundleTemplateConfigurableBundlePageSearchPublishListener(), 0, null, $this->getConfig()->getConfigurableBundlePageEventQueueName());
    ...
    {
        $eventCollection->addListenerQueued(ConfigurableBundleEvents::ENTITY_SPY_CONFIGURABLE_BUNDLE_TEMPLATE_DELETE, new ConfigurableBundleTemplateConfigurableBundlePageSearchUnpublishListener(), 0, null, $this->getConfig()->getConfigurableBundlePageEventQueueName());
