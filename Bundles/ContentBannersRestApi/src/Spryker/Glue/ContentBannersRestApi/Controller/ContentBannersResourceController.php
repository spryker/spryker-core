...
namespace Spryker\Glue\ContentBannersRestApi\Controller;
 ...
 */
class ContentBannersResourceController extends AbstractController
{
    /**
     * @Glue({
     *     "getResourceById": {
    ...
    public function getAction(RestRequestInterface $restRequest): RestResponseInterface
    {
        return $this->getFactory()
            ...
            ->getContentBannerById($restRequest);
    }
}
