 ...
 */
class ShortCodeToHtmlCmsGlossaryAfterFindPlugin extends AbstractPlugin implements CmsGlossaryAfterFindPluginInterface
{
    /**
     * {@inheritDoc}
     * - Executes after finding CmsGlossaryTransfer data in the database.
     * - Converts twig short-codes to content item html editor widgets in CmsPlaceholderTranslationTransfer translations.
     *
     * @api
     *
    ...
    {
        return $this->getFacade()->convertCmsGlossaryShortCodeToHtml($cmsGlossaryTransfer);
    }
}
