 ...
 */
class CurrencyStoreAclEntityConfigurationExpanderPlugin extends AbstractPlugin implements AclEntityConfigurationExpanderPluginInterface
{
    /**
    ...
    public function expand(AclEntityMetadataConfigTransfer $aclEntityMetadataConfigTransfer): AclEntityMetadataConfigTransfer
    {
        $aclEntityMetadataConfigTransfer
            ...
            ->addAclEntityMetadata(
                'Orm\Zed\Currency\Persistence\SpyCurrencyStore',
                (new AclEntityMetadataTransfer())
                    ->setEntityName('Orm\Zed\Currency\Persistence\SpyCurrencyStore')
