 ...
 */
class DefaultCurrencyStorePreUpdateValidationPlugin extends AbstractPlugin implements StorePreUpdateValidationPluginInterface
{
    /**
     * {@inheritDoc}
     * - Validate default currency before store is updated.
     *
     * @api
     *
