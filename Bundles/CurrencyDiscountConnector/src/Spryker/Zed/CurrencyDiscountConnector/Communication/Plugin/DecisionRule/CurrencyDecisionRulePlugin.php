...
namespace Spryker\Zed\CurrencyDiscountConnector\Communication\Plugin\DecisionRule;
...
class CurrencyDecisionRulePlugin extends AbstractPlugin implements DecisionRulePluginInterface, DiscountRuleWithValueOptionsPluginInterface
{
    ...
    public function isSatisfiedBy(
        ...
        return $this->getFacade()->isCurrencyDecisionRuleSatisfiedBy($quoteTransfer, $itemTransfer, $clauseTransfer);
    }
