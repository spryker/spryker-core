...
interface CustomerConstants
{
    ...
    public const REGISTRATION_CONFIRMATION_BASE_URL = 'REGISTRATION_CONFIRMATION_BASE_URL';
    public const REGISTRATION_CONFIRMATION_URL = 'REGISTRATION_CONFIRMATION_URL';
}
