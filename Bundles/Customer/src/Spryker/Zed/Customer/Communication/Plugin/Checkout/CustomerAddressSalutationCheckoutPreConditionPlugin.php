 ...
 */
class CustomerAddressSalutationCheckoutPreConditionPlugin extends AbstractPlugin implements CheckoutPreConditionPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFacade()->validateCustomerAddressCheckoutSalutation($quoteTransfer, $checkoutResponseTransfer);
    }
}
