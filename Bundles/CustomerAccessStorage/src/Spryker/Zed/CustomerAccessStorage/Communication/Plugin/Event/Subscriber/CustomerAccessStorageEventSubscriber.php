...
class CustomerAccessStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(CustomerAccessEvents::ENTITY_SPY_UNAUTHENTICATED_CUSTOMER_ACCESS_UPDATE, new CustomerAccessStorageBulkListener(), 0, null, $this->getConfig()->getCustomerAccessEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CustomerAccessEvents::ENTITY_SPY_UNAUTHENTICATED_CUSTOMER_ACCESS_CREATE, new CustomerAccessStorageBulkListener(), 0, null, $this->getConfig()->getCustomerAccessEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CustomerAccessEvents::ENTITY_SPY_UNAUTHENTICATED_CUSTOMER_ACCESS_DELETE, new CustomerAccessStorageBulkListener(), 0, null, $this->getConfig()->getCustomerAccessEventQueueName());
    }
}
