...
namespace Spryker\Zed\CustomerAccessStorage\Dependency\Facade;

class CustomerAccessStorageToEventBehaviorFacadeBridge implements CustomerAccessStorageToEventBehaviorInterface
{
    /**
