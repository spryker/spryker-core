...
class CustomersRestApiConfig extends AbstractBundleConfig
{
    ...
    public const RESPONSE_MESSAGE_CUSTOMER_PASSWORD_INVALID_CHARACTER_SET = 'The password is required to have at least 1 of the allowed characters: upper case, lower case, digit and special character.';
