...
interface CustomerWriterInterface
{
     ...
     */
    public function registerCustomer(RestRequestInterface $restRequest, RestCustomersAttributesTransfer $restCustomersAttributesTransfer): RestResponseInterface;
