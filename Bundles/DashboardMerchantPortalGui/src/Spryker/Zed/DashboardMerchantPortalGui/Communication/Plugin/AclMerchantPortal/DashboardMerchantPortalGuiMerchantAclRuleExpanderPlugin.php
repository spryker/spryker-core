...
namespace Spryker\Zed\DashboardMerchantPortalGui\Communication\Plugin\AclMerchantPortal;
 ...
 */
class DashboardMerchantPortalGuiMerchantAclRuleExpanderPlugin extends AbstractPlugin implements MerchantAclRuleExpanderPluginInterface
{
    /**
    ...
    /**
     * {@inheritDoc}
     * - Adds `dashboard-merchant-portal-gui` to list of `AclRules`.
     *
     * @api
     *
