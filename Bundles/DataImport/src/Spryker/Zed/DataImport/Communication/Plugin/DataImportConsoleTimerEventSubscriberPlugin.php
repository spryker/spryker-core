 ...
 */
class DataImportConsoleTimerEventSubscriberPlugin extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    public function getSubscribedEvents(EventCollectionInterface $eventCollection)
    {
        ...
        $eventCollection
            ->addListener(DataImportEvents::BEFORE_IMPORT, $dataImportConsoleTimerListener)
            ->addListener(DataImportEvents::BEFORE_DATA_SET_IMPORT, $dataImportConsoleTimerListener)
            ...
            ->addListener(DataImportEvents::AFTER_DATA_SET_IMPORT, $dataImportConsoleTimerListener)
            ->addListener(DataImportEvents::AFTER_IMPORT, $dataImportConsoleTimerListener);
