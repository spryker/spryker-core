...
class BundleMethodGeneratorTest extends Unit
{
    ...
    {
        $generator = new BundleMethodGenerator($this->createTwigEnvironment(), $this->getGeneratorOptions());
...
/**
 * @method \Spryker\FooApplication\Business\FooBundleFacadeInterface facade()
 */
interface FooBundle
{}
