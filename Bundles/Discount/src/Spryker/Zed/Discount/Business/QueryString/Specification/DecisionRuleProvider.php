...
{
    /**
     * @var array<\Spryker\Zed\DiscountExtension\Dependency\Plugin\DecisionRulePluginInterface>
     */
    protected $decisionRulePlugins = [];

    /**
     * @param array<\Spryker\Zed\DiscountExtension\Dependency\Plugin\DecisionRulePluginInterface> $decisionRulePlugins
     */
