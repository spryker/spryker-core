 ...
 */
class ItemByPriceCollectorPlugin extends AbstractPlugin implements CollectorPluginInterface
{
    /**
     * @api
     *
    ...
    {
        return $this->getFacade()->collectByItemPrice($quoteTransfer, $clauseTransfer);
    }
