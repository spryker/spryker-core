 ...
 */
class ItemQuantityDecisionRulePlugin extends AbstractPlugin implements DecisionRulePluginInterface
{
    /**
     * @api
     *
    ...
    {
        return $this->getFacade()->isItemQuantitySatisfiedBy($quoteTransfer, $itemTransfer, $clauseTransfer);
    }
