...
class DiscountCalculationConnectorFacade extends AbstractFacade
{
    ...
    public function recalculateDiscountTotals(
        ...
        $calculator = $this->getBusinessFactory()->getDiscountTotalsCalculator();
    ...
    public function recalculateGrandTotalWithDiscountsTotals(
        ...
        $calculator = $this->getBusinessFactory()->getGrandTotalWithDiscountsTotalsCalculator();
    ...
    {
        $calculator = $this->getBusinessFactory()->getRemoveAllCalculatedDiscountsCalculator();
