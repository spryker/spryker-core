...
namespace Spryker\Zed\DiscountCartConnector\Dependency\Facade;

use Generated\Shared\Transfer\MessageTransfer;

class DiscountCartConnectorToMessengerFacadeBridge implements DiscountCartConnectorToMessengerFacadeInterface
{
    /**
