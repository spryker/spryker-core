...
namespace Spryker\Zed\DiscountPromotion\Dependency\Service;

class DiscountPromotionToUtilQuantityServiceBridge implements DiscountPromotionToUtilQuantityServiceInterface
{
    /**
