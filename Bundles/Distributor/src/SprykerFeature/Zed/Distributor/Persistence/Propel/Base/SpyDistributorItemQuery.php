 ...
 *
 *
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery orderByIdDistributorItem($order = Criteria::ASC) Order by the id_distributor_item column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery orderByTouched($order = Criteria::ASC) Order by the touched column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery orderByFkItemType($order = Criteria::ASC) Order by the fk_item_type column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery orderByFkGlossaryTranslation($order = Criteria::ASC) Order by the fk_glossary_translation column
 *
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery groupByIdDistributorItem() Group by the id_distributor_item column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery groupByTouched() Group by the touched column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery groupByFkItemType() Group by the fk_item_type column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery groupByFkGlossaryTranslation() Group by the fk_glossary_translation column
 *
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery leftJoinSpyDistributorItemType($relationAlias = null) Adds a LEFT JOIN clause to the query using the SpyDistributorItemType relation
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery rightJoinSpyDistributorItemType($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SpyDistributorItemType relation
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery innerJoinSpyDistributorItemType($relationAlias = null) Adds a INNER JOIN clause to the query using the SpyDistributorItemType relation
 *
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery leftJoinSpyGlossaryTranslation($relationAlias = null) Adds a LEFT JOIN clause to the query using the SpyGlossaryTranslation relation
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery rightJoinSpyGlossaryTranslation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SpyGlossaryTranslation relation
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery innerJoinSpyGlossaryTranslation($relationAlias = null) Adds a INNER JOIN clause to the query using the SpyGlossaryTranslation relation
 *
 ...
 *
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem findOne(ConnectionInterface $con = null) Return the first ChildSpyDistributorItem matching the query
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem findOneOrCreate(ConnectionInterface $con = null) Return the first ChildSpyDistributorItem matching the query, or a new ChildSpyDistributorItem object populated from the query conditions when no match is found
 *
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem findOneByIdDistributorItem(int $id_distributor_item) Return the first ChildSpyDistributorItem filtered by the id_distributor_item column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem findOneByTouched(string $touched) Return the first ChildSpyDistributorItem filtered by the touched column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem findOneByFkItemType(int $fk_item_type) Return the first ChildSpyDistributorItem filtered by the fk_item_type column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem findOneByFkGlossaryTranslation(int $fk_glossary_translation) Return the first ChildSpyDistributorItem filtered by the fk_glossary_translation column *

 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem requirePk($key, ConnectionInterface $con = null) Return the ChildSpyDistributorItem by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem requireOne(ConnectionInterface $con = null) Return the first ChildSpyDistributorItem matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem requireOneByIdDistributorItem(int $id_distributor_item) Return the first ChildSpyDistributorItem filtered by the id_distributor_item column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem requireOneByTouched(string $touched) Return the first ChildSpyDistributorItem filtered by the touched column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem requireOneByFkItemType(int $fk_item_type) Return the first ChildSpyDistributorItem filtered by the fk_item_type column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem requireOneByFkGlossaryTranslation(int $fk_glossary_translation) Return the first ChildSpyDistributorItem filtered by the fk_glossary_translation column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem[]|\Propel\Runtime\Collection\ObjectCollection find(ConnectionInterface $con = null) Return ChildSpyDistributorItem objects based on current ModelCriteria
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem[]|\Propel\Runtime\Collection\ObjectCollection findByIdDistributorItem(int $id_distributor_item) Return ChildSpyDistributorItem objects filtered by the id_distributor_item column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem[]|\Propel\Runtime\Collection\ObjectCollection findByTouched(string $touched) Return ChildSpyDistributorItem objects filtered by the touched column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem[]|\Propel\Runtime\Collection\ObjectCollection findByFkItemType(int $fk_item_type) Return ChildSpyDistributorItem objects filtered by the fk_item_type column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem[]|\Propel\Runtime\Collection\ObjectCollection findByFkGlossaryTranslation(int $fk_glossary_translation) Return ChildSpyDistributorItem objects filtered by the fk_glossary_translation column
 * @method     \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem[]|\Propel\Runtime\Util\PropelModelPager paginate($page = 1, $maxPerPage = 10, ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 *
 */
abstract class SpyDistributorItemQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \SprykerFeature\Zed\Distributor\Persistence\Propel\Base\SpyDistributorItemQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\SprykerFeature\\Zed\\Distributor\\Persistence\\Propel\\SpyDistributorItem', $modelAlias = null)
    {
     ...
     *
     * @return \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery
     */
     ...
     *
     * @return \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem|array|mixed the result, formatted by the current formatter
     */
     ...
     *
     * @return \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem A model object, or null if the key is not found
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = $locator->distributor()->entitySpyDistributorItem();
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|\SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery The current query, for fluid interface
     */
     ...
     *
     * @param \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemType|\Propel\Runtime\Collection\ObjectCollection $spyDistributorItemType The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery The current query, for fluid interface
     */
    public function filterBySpyDistributorItemType($spyDistributorItemType, $comparison = null)
    {
        if ($spyDistributorItemType instanceof \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemType) {
            return $this
            ...
            throw new PropelException('filterBySpyDistributorItemType() only accepts arguments of type \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemType or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemTypeQuery A secondary query class using the current class as primary query
     */
     ...
     *
     * @param \SprykerFeature\Zed\Glossary\Persistence\Propel\SpyGlossaryTranslation|\Propel\Runtime\Collection\ObjectCollection $spyGlossaryTranslation The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
     ...
     *
     * @param   \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem $spyDistributorItem Object to remove from the list of results
     *
     * @return $this|\SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery The current query, for fluid interface
     */
