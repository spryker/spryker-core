...
*/
abstract class SpyDistributorItemType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\SprykerFeature\\Zed\\Distributor\\Persistence\\Propel\\Map\\SpyDistributorItemTypeTableMap';
    ...
    /**
     * @var        \Propel\Runtime\Collection\ObjectCollection|\SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem[] Collection to store aggregation of ChildSpyDistributorItem objects.
     */
     ...
     * @var \Propel\Runtime\Collection\ObjectCollection|\SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem[]
     */
    protected $spyDistributorItemsScheduledForDeletion = null;

    /**
     * Initializes internal state of SprykerFeature\Zed\Distributor\Persistence\Propel\Base\SpyDistributorItemType object.
     */
     ...
     *
     * @return $this|\SprykerFeature\Zed\Distributor\Persistence\Propel\Base\SpyDistributorItemType The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\SprykerFeature\\Zed\\Distributor\\Persistence\\Propel\\SpyDistributorItemType'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->spyDistributorItemsScheduledForDeletion !== null) {
                if (!$this->spyDistributorItemsScheduledForDeletion->isEmpty()) {
                    \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemType
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemType The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemType Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function initSpyDistributorItems($overrideExisting = true)
    {
        ...
        $this->collSpyDistributorItems->setModel('\SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem');
    }
     ...
     * @return \Propel\Runtime\Collection\ObjectCollection|\SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem[] List of ChildSpyDistributorItem objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     *
     * @param      \Propel\Runtime\Collection\Collection $spyDistributorItems A Propel collection.
     * @param      \Propel\Runtime\Connection\ConnectionInterface $con Optional connection object
     * @return $this|\SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemType The current object (for fluent API support)
     */
    public function setSpyDistributorItems(Collection $spyDistributorItems, ConnectionInterface $con = null)
    {
        /** @var \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem[] $spyDistributorItemsToDelete */
     ...
     *
     * @param  \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem $l ChildSpyDistributorItem
     * @return $this|\SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemType The current object (for fluent API support)
     */
    ...
    /**
     * @param \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem $spyDistributorItem The ChildSpyDistributorItem object to add.
     */
    ...
    /**
     * @param  \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem $spyDistributorItem The ChildSpyDistributorItem object to remove.
     * @return $this|\SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemType The current object (for fluent API support)
     */
