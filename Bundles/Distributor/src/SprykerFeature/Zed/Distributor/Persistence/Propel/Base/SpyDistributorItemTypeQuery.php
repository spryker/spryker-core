...
abstract class SpyDistributorItemTypeQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \SprykerFeature\Zed\Distributor\Persistence\Propel\Base\SpyDistributorItemTypeQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\SprykerFeature\\Zed\\Distributor\\Persistence\\Propel\\SpyDistributorItemType', $modelAlias = null)
    {
    ...
    {
        if ($spyDistributorItem instanceof \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem) {
            return $this
            ...
            throw new PropelException('filterBySpyDistributorItem() only accepts arguments of type \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItem or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery A secondary query class using the current class as primary query
     */
    public function useSpyDistributorItemQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SpyDistributorItem', '\SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemQuery');
    }
