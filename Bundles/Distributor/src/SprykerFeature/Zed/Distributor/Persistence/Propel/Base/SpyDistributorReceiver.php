...
abstract class SpyDistributorReceiver implements ActiveRecordInterface
{
    ...
    /**
     * Initializes internal state of SprykerFeature\Zed\Distributor\Persistence\Propel\Base\SpyDistributorReceiver object.
     */
    ...
    /**
     * Get the [id_distributor_receiver] column value.
     *
     * @return int
     */
    public function getIdDistributorReceiver()
    {
        return $this->id_distributor_receiver;
    }
    ...
    /**
     * Set the value of [id_distributor_receiver] column.
     *
    ...
    public function setIdDistributorReceiver($v)
    {
        ...
        if ($this->id_distributor_receiver !== $v) {
            $this->id_distributor_receiver = $v;
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = SpyDistributorReceiverTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\SprykerFeature\\Zed\\Distributor\\Persistence\\Propel\\SpyDistributorReceiver'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSpyDistributorReceiverQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpyDistributorReceiverQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SpyDistributorReceiverTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[SpyDistributorReceiverTableMap::COL_ID_DISTRIBUTOR_RECEIVER] = true;
        if (null !== $this->id_distributor_receiver) {
        ...
        $sql = sprintf(
            'INSERT INTO spy_distributor_receiver (%s) VALUES (%s)',
        ...
        try {
            $pk = $con->lastInsertId('spy_distributor_receiver_pk_seq');
        } catch (Exception $e) {
            throw new PropelException('Unable to get autoincrement id.', 0, $e);
        }
        $this->setIdDistributorReceiver($pk);
    ...
    {
        $pos = SpyDistributorReceiverTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        $criteria = ChildSpyDistributorReceiverQuery::create();
        $criteria->add(SpyDistributorReceiverTableMap::COL_ID_DISTRIBUTOR_RECEIVER, $this->id_distributor_receiver);
    ...
    {
        $validPk = null !== $this->getIdDistributorReceiver();
    ...
    {
        $this->setIdDistributorReceiver($key);
    }
    ...
    {
        return null === $this->getIdDistributorReceiver();
    }
