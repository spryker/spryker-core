...
class SpyDistributorItemTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'vendor.spryker.spryker.Bundles.Distributor.src.SprykerFeature.Zed.Distributor.Persistence.Propel.Map.SpyDistributorItemTypeTableMap';
     ...
     */
    const OM_CLASS = '\\SprykerFeature\\Zed\\Distributor\\Persistence\\Propel\\SpyDistributorItemType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'vendor.spryker.spryker.Bundles.Distributor.src.SprykerFeature.Zed.Distributor.Persistence.Propel.SpyDistributorItemType';
     ...
     */
    const COL_KEY = 'spy_distributor_item_type.key';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdDistributorItemType', 'Key', 'LastDistribution', ),
        self::TYPE_CAMELNAME     => array('idDistributorItemType', 'key', 'lastDistribution', ),
        self::TYPE_COLNAME       => array(SpyDistributorItemTypeTableMap::COL_ID_DISTRIBUTOR_ITEM_TYPE, SpyDistributorItemTypeTableMap::COL_KEY, SpyDistributorItemTypeTableMap::COL_LAST_DISTRIBUTION, ),
        self::TYPE_FIELDNAME     => array('id_distributor_item_type', 'key', 'last_distribution', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdDistributorItemType' => 0, 'Key' => 1, 'LastDistribution' => 2, ),
        self::TYPE_CAMELNAME     => array('idDistributorItemType' => 0, 'key' => 1, 'lastDistribution' => 2, ),
        self::TYPE_COLNAME       => array(SpyDistributorItemTypeTableMap::COL_ID_DISTRIBUTOR_ITEM_TYPE => 0, SpyDistributorItemTypeTableMap::COL_KEY => 1, SpyDistributorItemTypeTableMap::COL_LAST_DISTRIBUTION => 2, ),
        self::TYPE_FIELDNAME     => array('id_distributor_item_type' => 0, 'key' => 1, 'last_distribution' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\SprykerFeature\\Zed\\Distributor\\Persistence\\Propel\\SpyDistributorItemType');
    ...
    {
        $this->addRelation('SpyDistributorItem', '\\SprykerFeature\\Zed\\Distributor\\Persistence\\Propel\\SpyDistributorItem', RelationMap::ONE_TO_MANY, array('id_distributor_item_type' => 'fk_item_type', ), null, null, 'SpyDistributorItems');
    } // buildRelations()
    ...
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if (null !== ($obj = SpyDistributorItemTypeTableMap::getInstanceFromPool($key))) {
            ...
            /** @var SpyDistributorItemType $obj */
                ...
                $obj = $locator->distributor()->entitySpyDistributorItemType();
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpyDistributorItemTypeTableMap::COL_KEY);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorItemType) { // it's a model object
