...
class SpyDistributorReceiverTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'vendor.spryker.spryker.Bundles.Distributor.src.SprykerFeature.Zed.Distributor.Persistence.Propel.Map.SpyDistributorReceiverTableMap';
     ...
     */
    const OM_CLASS = '\\SprykerFeature\\Zed\\Distributor\\Persistence\\Propel\\SpyDistributorReceiver';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'vendor.spryker.spryker.Bundles.Distributor.src.SprykerFeature.Zed.Distributor.Persistence.Propel.SpyDistributorReceiver';
     ...
     */
    const COL_KEY = 'spy_distributor_receiver.key';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdDistributorReceiver', 'Key', ),
        self::TYPE_CAMELNAME     => array('idDistributorReceiver', 'key', ),
        self::TYPE_COLNAME       => array(SpyDistributorReceiverTableMap::COL_ID_DISTRIBUTOR_RECEIVER, SpyDistributorReceiverTableMap::COL_KEY, ),
        self::TYPE_FIELDNAME     => array('id_distributor_receiver', 'key', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdDistributorReceiver' => 0, 'Key' => 1, ),
        self::TYPE_CAMELNAME     => array('idDistributorReceiver' => 0, 'key' => 1, ),
        self::TYPE_COLNAME       => array(SpyDistributorReceiverTableMap::COL_ID_DISTRIBUTOR_RECEIVER => 0, SpyDistributorReceiverTableMap::COL_KEY => 1, ),
        self::TYPE_FIELDNAME     => array('id_distributor_receiver' => 0, 'key' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\SprykerFeature\\Zed\\Distributor\\Persistence\\Propel\\SpyDistributorReceiver');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpyDistributorReceiverTableMap::COL_KEY);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SprykerFeature\Zed\Distributor\Persistence\Propel\SpyDistributorReceiver) { // it's a model object
