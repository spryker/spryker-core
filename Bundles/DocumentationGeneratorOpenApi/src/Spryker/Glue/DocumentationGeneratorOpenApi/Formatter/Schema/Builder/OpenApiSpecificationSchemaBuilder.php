...
class OpenApiSpecificationSchemaBuilder implements SchemaBuilderInterface
{
     ...
     * @var string
     */
    protected const SCHEMA_NAME_LINKS = 'Links';

    /**
     * @var string
     */
    protected const SCHEMA_NAME_RELATIONSHIPS = 'Relationships';

    /**
     * @var string
     */
    protected const SCHEMA_NAME_RELATIONSHIPS_DATA = 'RelationshipsData';
    ...
    /**
     * @var \Spryker\Glue\DocumentationGeneratorOpenApi\Formatter\Schema\Builder\SchemaComponentBuilderInterface
     */
    protected $schemaComponentBuilder;

    /**
     * @param \Spryker\Glue\DocumentationGeneratorOpenApi\Formatter\Schema\Builder\SchemaComponentBuilderInterface $schemaComponentBuilder
     */
    ...
    public function createIncludedDataSchema(string $schemaName, array $relationshipResponses): SchemaDataTransfer
    {
        return $this->schemaComponentBuilder
            ...
            ->setItems($this->schemaComponentBuilder->createRelationshipSchemaItemsTransfer($relationshipResponses));
    }
