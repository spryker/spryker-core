 ...
 */
class ControllerAnnotationsContextExpanderPlugin extends AbstractPlugin implements ContextExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Adds controller annotations information to the documentation generation context.
     *
     * @api
     *
    ...
    public function expand(ApiApplicationSchemaContextTransfer $apiApplicationSchemaContextTransfer): ApiApplicationSchemaContextTransfer
    {
        return $this->getFactory()
            ->createControllerAnnotationsContextExpander()
