 ...
 */
class RelationshipPluginAnnotationsContextExpanderPlugin extends AbstractPlugin implements ContextExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Adds relationship annotations information to the documentation generation context.
     *
     * @api
     *
    ...
    public function expand(ApiApplicationSchemaContextTransfer $apiApplicationSchemaContextTransfer): ApiApplicationSchemaContextTransfer
    {
        return $this->getFactory()
            ->createRelationshipPluginAnnotationsContextExpander()
