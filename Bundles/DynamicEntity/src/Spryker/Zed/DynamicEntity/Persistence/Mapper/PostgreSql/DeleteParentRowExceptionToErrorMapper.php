...
class DeleteParentRowExceptionToErrorMapper implements DatabaseExceptionToErrorMapperInterface
{
     ...
     * @var string
     */
    protected const ERROR_CODE_INTEGRITY_CONSTRAINT = '23503';
     ...
     * @var string
     */
    protected const FOREIGN_KEY_CONSTRAINT_FAILS = 'foreign key constraint';
    ...
    protected function getChildEntity(array $params): string
    {
        ...
        preg_match(static::REFERENCE_TABLE_REGEX, $previousExceptionMessage, $matches);
