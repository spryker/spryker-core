...
namespace Spryker\Glue\DynamicEntityBackendApi\Dependency\Service;

class DynamicEntityBackendApiToUtilEncodingServiceBridge implements DynamicEntityBackendApiToUtilEncodingServiceInterface
{
    /**
