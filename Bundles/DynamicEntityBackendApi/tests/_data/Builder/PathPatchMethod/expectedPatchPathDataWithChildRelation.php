     ...
     [
      'patch' =>
       [
        ...
        'requestBody' =>
         [
          'description' => 'Data to update collection of entities.  Request data can contain also child relation, for example: `{ ...fields, test-child-relation: { ...childFields } }`.',
          'required' => true,
          'content' =>
           [
            'application/json' =>
     ...
     [
      'patch' =>
       [
        ...
        'requestBody' =>
         [
          'description' => 'Data to update entity.  Request data can contain also child relation, for example: `{ ...fields, test-child-relation: { ...childFields } }`.',
          'required' => true,
          'content' =>
           [
            'application/json' =>
