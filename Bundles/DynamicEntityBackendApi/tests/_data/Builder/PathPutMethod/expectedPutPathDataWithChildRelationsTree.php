     ...
     [
      'put' =>
       [
        ...
        'requestBody' =>
         [
          'description' => 'Data to create new or update collection of entities.  Request data can contain also child relation, for example: `{ ...fields, test-first-level-child-relation: { ...childFields } }`.',
          'required' => true,
          'content' =>
           [
            'application/json' =>
