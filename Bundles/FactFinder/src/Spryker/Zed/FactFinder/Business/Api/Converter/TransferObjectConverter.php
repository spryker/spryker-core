...
use Generated\Shared\Transfer\FactFinderResponseTransfer;

class TransferObjectConverter extends BaseConverter
{

    /**
     * @return \Generated\Shared\Transfer\FactFinderResponseTransfer
     */
    public function convert()
    {
//        $responseTransfer = new FactFinderResponseTransfer();
//        $responseTransfer
