...
namespace Spryker\Yves\FactFinderDemo\Dependency\Clients;
...
class FactFinderDemoToFactFinderClientBridge implements FactFinderDemoToFactFinderClientInterface
{
