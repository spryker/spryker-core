...
namespace Spryker\Client\FileManager\Dependency\Client;

class FileManagerToSynchronizationServiceBridge implements FileManagerToSynchronizationServiceInterface
{
    /**
