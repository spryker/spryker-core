...
namespace Spryker\Zed\FileManagerGui\Dependency\Service;

class FileManagerGuiToUtilEncodingServiceBridge implements FileManagerGuiToUtilEncodingServiceInterface
{
    /**
