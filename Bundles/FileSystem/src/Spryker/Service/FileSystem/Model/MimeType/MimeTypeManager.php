...
class MimeTypeManager implements MimeTypeManagerInterface
{
    ...
    {
        $ext = mb_strtolower($this->getExtensionByFilename($filename));

        if (trim($ext) === '' || !array_key_exists($ext, $this->mimeTypes)) {
