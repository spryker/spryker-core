...
namespace Spryker\Service\FlysystemLocalFileSystem\Dependency\Service;

class FlysystemLocalFileSystemToFlysystemBridge implements FlysystemLocalFileSystemToFlysystemInterface
{
