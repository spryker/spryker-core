 ...
 */
class GiftCardUsageMailTypeBuilderPlugin extends AbstractPlugin implements MailTypeBuilderPluginInterface
{
    /**
     * @var string
     */
    protected const MAIL_TYPE = 'gift card usage mail';

    /**
     * @var string
     */
    protected const MAIL_TEMPLATE_HTML = 'giftCardMailConnector/mail/gift_card_usage.html.twig';

    /**
     * @var string
     */
    protected const MAIL_TEMPLATE_TEXT = 'giftCardMailConnector/mail/gift_card_usage.text.twig';

    /**
     * @var string
     */
    protected const GLOSSARY_KEY_MAIL_SUBJECT = 'mail.giftCard.usage.subject';

    /**
     * {@inheritDoc}
     * - Returns the name of mail for a gift card usage mail.
     *
     * @api
     *
     * @return string
    ...
    /**
     * {@inheritDoc}
     * - Builds the `MailTransfer` with data for a gift card usage mail.
     *
     * @api
     *
