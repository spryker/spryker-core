...
namespace Spryker\Glue\GlueBackendApiApplicationAuthorizationConnector\Plugin\GlueApplication;
...
class IsProtectedTableColumnExpanderPlugin extends AbstractPlugin implements TableColumnExpanderPluginInterface
{
     ...
     * @var string
     */
    protected const APPLICATION_NAME = 'GlueBackendApiApplication';
    ...
    public function getRowData(Route $route): string
    {
        ...
        if (!$this->getFacade()->isProtected($routeTransfer)) {
