...
/**
 * Use this plugin to format response specific to the JSON:API convention.
 */
interface ResponseFormatterPluginInterface
{
    /**
     * Specification:
     * - Transform format according to the used conventions (e.g.: content to JSON:API specific format).
     *
     * @api
     *
