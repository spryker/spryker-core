    ...
    public function validate(
        ...
        if ($resource instanceof GenericResource && $glueRequestTransfer->getResourceOrFail()->getScope()) {
            if (
                ...
                !in_array($glueRequestTransfer->getResourceOrFail()->getScope(), $glueRequestTransfer->getRequestCustomer()->getScopes())
            ) {
        ...
        if ($glueRequestTransfer->getRequestCustomer()) {
            ...
            if (isset($scopes[$method]) && in_array($scopes[$method], $glueRequestTransfer->getRequestCustomer()->getScopes())) {
                return (new GlueRequestValidationTransfer())->setIsValid(true);
            }
        }
