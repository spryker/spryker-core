...
abstract class AbstractGuiTableConfigurationProvider
{
     ...
     */
    protected function createColumnText(string $id, string $title, bool $isSortable, bool $isHideable): GuiTableColumnConfigurationTransfer
    {
     ...
     * @return \Generated\Shared\Transfer\GuiTableColumnConfigurationTransfer
     */
    protected function createColumnImage(string $id, string $title, bool $isSortable, bool $isHideable): GuiTableColumnConfigurationTransfer
    {
        return (new GuiTableColumnConfigurationTransfer())
            ->setId($id)
            ->setTitle($title)
     ...
     */
    protected function createFilterSelect(string $id, string $title, bool $isMultiselect, array $values): GuiTableFilterTransfer
    {
