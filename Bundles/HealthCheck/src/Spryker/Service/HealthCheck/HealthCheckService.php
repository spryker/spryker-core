...
class HealthCheckService extends AbstractService implements HealthCheckServiceInterface
{
    ...
    {
        return $this->getFactory()->createYvesHealthCheckServiceProcessor()->process($healthCheckRequestTransfer);
    }
    ...
    {
        return $this->getFactory()->createZedHealthCheckServiceProcessor()->process($healthCheckRequestTransfer);
    }
    ...
    {
        return $this->getFactory()->createGlueHealthCheckServiceProcessor()->process($healthCheckRequestTransfer);
    }
}
