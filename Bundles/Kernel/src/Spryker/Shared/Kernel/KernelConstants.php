...
interface KernelConstants
{
    ...
    const AUTO_LOADER_UNRESOLVABLE_CACHE_ENABLED = ApplicationConstants::AUTO_LOADER_UNRESOLVABLE_CACHE_ENABLED;
    const AUTO_LOADER_UNRESOLVABLE_CACHE_PROVIDER = ApplicationConstants::AUTO_LOADER_UNRESOLVABLE_CACHE_PROVIDER;
