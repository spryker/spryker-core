...
class BusinessFactoryNotFoundException extends Exception
{
    /**
    ...
    protected function buildMessage(ClassInfo $callerClassInfo)
    {
        ...
        $message .= sprintf(
            'Can not resolve %1$sBusinessFactory for your module "%1$s"',
        ...
        $message .= sprintf(
            'E.g. %1$s\\Zed\\%2$s\\Business\\%2$sBusinessFactory' . PHP_EOL . PHP_EOL,
