...
class PersistenceFactoryNotFoundException extends Exception
{
    /**
    ...
    protected function buildMessage(ClassInfo $callerClassInfo)
    {
        ...
        $message .= sprintf(
            'Can not resolve %1$sPersistenceFactory for your module "%1$s"',
        ...
        $message .= sprintf(
            'E.g. %1$s\\Zed\\%2$s\\Persistence\\%2$sPersistenceFactory' . PHP_EOL . PHP_EOL,
