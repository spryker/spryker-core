...
class ConsoleMethodTagBuilder extends AbstractMultiFileMethodTagBuilder
{

    const METHOD_STRING_PATTERN = '@method \{{className}} console{{methodName}}()';
    const PATH_PATTERN = 'Communication/Console/';
