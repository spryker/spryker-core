...
class LocaleManager
{
    ...
    {
        if (!isset(self::$localesById[$idLocale])) {
            self::$localesById[$idLocale] = $this->localeQueryContainer
                ->queryLocales()
        ...
        return $this->transferGenerator->convertLocale(self::$localesById[$idLocale]);
    }
