 ...
 */
class LocaleStoreAclEntityConfigurationExpanderPlugin extends AbstractPlugin implements AclEntityConfigurationExpanderPluginInterface
{
    /**
    ...
    public function expand(AclEntityMetadataConfigTransfer $aclEntityMetadataConfigTransfer): AclEntityMetadataConfigTransfer
    {
        $aclEntityMetadataConfigTransfer
            ...
            ->addAclEntityMetadata(
                'Orm\Zed\Locale\Persistence\SpyLocaleStore',
                (new AclEntityMetadataTransfer())
                    ->setEntityName('Orm\Zed\Locale\Persistence\SpyLocaleStore')
