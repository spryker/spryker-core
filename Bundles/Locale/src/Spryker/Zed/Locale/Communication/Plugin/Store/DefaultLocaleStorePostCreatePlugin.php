 ...
 */
class DefaultLocaleStorePostCreatePlugin extends AbstractPlugin implements StorePostCreatePluginInterface
{
    /**
     * {@inheritDoc}
     * - Updates default locale after store is created.
     *
     * @api
     *
