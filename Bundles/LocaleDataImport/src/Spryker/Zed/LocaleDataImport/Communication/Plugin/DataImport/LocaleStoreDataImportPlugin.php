 ...
 */
class LocaleStoreDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    public function import(
        ...
        return $this->getFacade()->importLocaleStore($dataImporterConfigurationTransfer);
    }
    ...
    {
        return LocaleDataImportConfig::IMPORT_TYPE_LOCALE_STORE;
    }
}
