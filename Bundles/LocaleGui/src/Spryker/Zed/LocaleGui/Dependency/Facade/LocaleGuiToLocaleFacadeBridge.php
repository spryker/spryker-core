...
class LocaleGuiToLocaleFacadeBridge implements LocaleGuiToLocaleFacadeInterface
{
    /**
    ...
    {
        return $this->localeFacade->expandStoreTransfersWithLocales($storeTransfers);
    }
}
