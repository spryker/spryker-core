...
/**
 * This plugin is used to provide configuration for audit logging for Glue Backend application.
 *
 * @method \Spryker\Glue\Log\LogFactory getFactory()
 * @method \Spryker\Glue\Log\LogConfig getConfig()
 */
class GlueBackendSecurityAuditLoggerConfigPlugin extends AbstractPlugin implements AuditLoggerConfigPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    /**
     * {@inheritDoc}
     * - Returns Glue Backend application security specific handlers.
     *
     * @api
     *
    ...
    {
        return $this->getFactory()->getGlueBackendSecurityAuditLogHandlerPlugins();
    }

    /**
     * {@inheritDoc}
     * - Returns Glue Backend application security specific processors.
     *
     * @api
     *
    ...
    {
        return $this->getFactory()->getGlueBackendSecurityAuditLogProcessorPlugins();
    }
}
