...
/**
 * This plugin is used to provide configuration for audit logging for Zed application.
 *
 * @method \Spryker\Zed\Log\Communication\LogCommunicationFactory getFactory()
 * @method \Spryker\Zed\Log\LogConfig getConfig()
 * @method \Spryker\Zed\Log\Business\LogFacadeInterface getFacade()
 */
class ZedSecurityAuditLoggerConfigPlugin extends AbstractPlugin implements AuditLoggerConfigPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    /**
     * {@inheritDoc}
     * - Returns Zed application security specific handlers.
     *
     * @api
     *
    ...
    {
        return $this->getFactory()->getZedSecurityAuditLogHandlerPlugins();
    }

    /**
     * {@inheritDoc}
     * - Returns Zed application security specific processors.
     *
     * @api
     *
    ...
    {
        return $this->getFactory()->getZedSecurityAuditLogProcessorPlugins();
    }
}
