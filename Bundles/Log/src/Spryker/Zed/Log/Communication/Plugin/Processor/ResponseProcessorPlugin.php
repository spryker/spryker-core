 ...
 */
class ResponseProcessorPlugin extends AbstractPlugin implements LogProcessorPluginInterface
{
    /**
     * @api
     *
    ...
    {
        return $this->getFactory()->createResponseProcessorPublic()->__invoke($data);
    }
}
