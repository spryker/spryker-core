...
namespace SprykerTest\Glue\Log\Plugin\Handler;
...
class ExceptionStreamHandlerPluginTest extends Unit
{
    ...
    /**
     * @var \SprykerTest\Glue\Log\LogPluginTester
     */
    protected $tester;

    /**
     * @return \Spryker\Glue\Log\Plugin\Handler\ExceptionStreamHandlerPlugin
     */
