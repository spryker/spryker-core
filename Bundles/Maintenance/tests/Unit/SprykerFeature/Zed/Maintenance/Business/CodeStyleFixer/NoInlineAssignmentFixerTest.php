...
use SprykerFeature\Zed\Maintenance\Business\CodeStyleFixer\NoInlineAssignmentFixer;
 ...
 */
class NoInlineAssignmentFixerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        parent::setUp();
        $this->fixer = new NoInlineAssignmentFixer();
    }
