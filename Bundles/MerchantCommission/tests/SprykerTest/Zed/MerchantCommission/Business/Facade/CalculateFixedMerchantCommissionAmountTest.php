...
class CalculateFixedMerchantCommissionAmountTest extends Unit
{
    ...
    /**
     * @dataProvider calculatesMerchantCommissionAmountAccordingToOrderPriceModeDataProvider
     *
     * @param \Generated\Shared\Transfer\MerchantCommissionTransfer $merchantCommissionTransfer
     * @param \Generated\Shared\Transfer\MerchantCommissionCalculationRequestItemTransfer $merchantCommissionCalculationRequestItemTransfer
     * @param \Generated\Shared\Transfer\MerchantCommissionCalculationRequestTransfer $merchantCommissionCalculationRequestTransfer
     ...
     * @return void
     */
    public function testCalculatesMerchantCommissionAmountAccordingToOrderPriceMode(
        MerchantCommissionTransfer $merchantCommissionTransfer,
        MerchantCommissionCalculationRequestItemTransfer $merchantCommissionCalculationRequestItemTransfer,
        MerchantCommissionCalculationRequestTransfer $merchantCommissionCalculationRequestTransfer,
        int $expectedAmount
     ...
     * @return array<string, mixed>
     */
    protected function calculatesMerchantCommissionAmountAccordingToOrderPriceModeDataProvider(): array
    {
        return [
            'Merchant commission gross amount EUR, item quantity 1, order with EUR, order in gross mode' => [
                (new MerchantCommissionBuilder())->withMerchantCommissionAmount([
                    MerchantCommissionAmountTransfer::GROSS_AMOUNT => 100,
                    MerchantCommissionAmountTransfer::CURRENCY => [CurrencyTransfer::CODE => static::CURRENCY_EUR],
                ])->build(),
            ...
            'Merchant commission net amount EUR, item quantity 1, order with EUR, order in net mode' => [
                (new MerchantCommissionBuilder())->withMerchantCommissionAmount([
                    MerchantCommissionAmountTransfer::NET_AMOUNT => 100,
                    MerchantCommissionAmountTransfer::CURRENCY => [CurrencyTransfer::CODE => static::CURRENCY_EUR],
                ])->build(),
            ...
            'Merchant commission gross amount EUR, item quantity 10, order with EUR, order in gross mode' => [
                (new MerchantCommissionBuilder())->withMerchantCommissionAmount([
                    MerchantCommissionAmountTransfer::GROSS_AMOUNT => 100,
                    MerchantCommissionAmountTransfer::CURRENCY => [CurrencyTransfer::CODE => static::CURRENCY_EUR],
                ])->build(),
            ...
            'Merchant commission net amount EUR, item quantity 10, order with EUR, order in net mode' => [
                (new MerchantCommissionBuilder())->withMerchantCommissionAmount([
                    MerchantCommissionAmountTransfer::NET_AMOUNT => 100,
                    MerchantCommissionAmountTransfer::CURRENCY => [CurrencyTransfer::CODE => static::CURRENCY_EUR],
                ])->build(),
            ...
            'Merchant commission without gross amount EUR, item quantity 1, order with EUR, order in gross mode' => [
                (new MerchantCommissionBuilder())->withMerchantCommissionAmount([
                    MerchantCommissionAmountTransfer::GROSS_AMOUNT => null,
                    MerchantCommissionAmountTransfer::CURRENCY => [CurrencyTransfer::CODE => static::CURRENCY_EUR],
                ])->build(),
            ...
            'Merchant commission without net amount EUR, item quantity 1, order with EUR, order in net mode' => [
                (new MerchantCommissionBuilder())->withMerchantCommissionAmount([
                    MerchantCommissionAmountTransfer::NET_AMOUNT => null,
                    MerchantCommissionAmountTransfer::CURRENCY => [CurrencyTransfer::CODE => static::CURRENCY_EUR],
                ])->build(),
            ...
            'Merchant commission with gross amount EUR, item quantity 1, order with USD, order in gross mode' => [
                (new MerchantCommissionBuilder())->withMerchantCommissionAmount([
                    MerchantCommissionAmountTransfer::GROSS_AMOUNT => null,
                    MerchantCommissionAmountTransfer::CURRENCY => [CurrencyTransfer::CODE => static::CURRENCY_EUR],
                ])->build(),
            ...
            'Merchant commission with net amount EUR, item quantity 1, order with USD, order in net mode' => [
                (new MerchantCommissionBuilder())->withMerchantCommissionAmount([
                    MerchantCommissionAmountTransfer::NET_AMOUNT => null,
                    MerchantCommissionAmountTransfer::CURRENCY => [CurrencyTransfer::CODE => static::CURRENCY_EUR],
                ])->build(),
