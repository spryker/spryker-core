 ...
 */
class MerchantCommissionAmountDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    public function import(
        ...
        return $this->getFacade()->importMerchantCommissionAmount($dataImporterConfigurationTransfer);
    }
    ...
    {
        return MerchantCommissionDataImportConfig::IMPORT_TYPE_MERCHANT_COMMISSION_AMOUNT;
    }
}
