 ...
 */
class MerchantCommissionDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    public function import(
        ...
        return $this->getFacade()->importMerchantCommission($dataImporterConfigurationTransfer);
    }
    ...
    {
        return MerchantCommissionDataImportConfig::IMPORT_TYPE_MERCHANT_COMMISSION;
    }
}
