 ...
 */
class MerchantCommissionGroupDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFacade()->importMerchantCommissionGroups($dataImporterConfigurationTransfer);
    }
    ...
    {
        return MerchantCommissionDataImportConfig::IMPORT_TYPE_MERCHANT_COMMISSION_GROUP;
    }
}
