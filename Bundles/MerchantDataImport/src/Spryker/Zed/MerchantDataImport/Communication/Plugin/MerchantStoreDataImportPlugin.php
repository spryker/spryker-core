 ...
 */
class MerchantStoreDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    public function import(
        ...
        return $this->getFacade()->importMerchantStores($dataImporterConfigurationTransfer);
    }
    ...
    {
        return MerchantDataImportConfig::IMPORT_TYPE_MERCHANT_STORE;
    }
}
