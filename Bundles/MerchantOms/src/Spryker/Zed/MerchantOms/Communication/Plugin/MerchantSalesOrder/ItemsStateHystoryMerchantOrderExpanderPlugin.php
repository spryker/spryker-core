 ...
 */
class ItemsStateHystoryMerchantOrderExpanderPlugin extends AbstractPlugin implements MerchantOrderExpanderPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFacade()->expandMerchantOrderItemsWithStateHistory($merchantOrderTransfer);
    }
}
