...
namespace Spryker\Zed\MerchantProductOfferStorage\Communication\Plugin\Publisher\ProductConcrete;
 ...
 */
class ProductConcreteWritePublisherPlugin extends AbstractPlugin
{
    /**
     * @api
     *
