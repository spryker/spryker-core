...
namespace Spryker\Zed\MerchantProductOfferStorage\Communication\Plugin\Publisher\ProductOffer;
 ...
 */
class ProductOfferDeletePublisherPlugin extends AbstractPlugin
{
    /**
     * @api
     *
