...
describe('MerchantRelationRequestComponent', () => {
    const { testModule, createComponent } = getTestingForComponent(MerchantRelationRequestComponent, {
    ...
    it('should render <mp-merchant-relation-request-table> component', async () => {
        const host = await createComponentWrapper(createComponent);
        const productListTableComponent = host.queryCss('mp-merchant-relation-request-table');
    ...
    it('should bound `@Input(tableConfig)` to the `config` input of <mp-merchant-relation-request-table> component', async () => {
    ...
    it('should bound `@Input(tableId)` to the `tableId` input of <mp-merchant-relation-request-table> component', async () => {
