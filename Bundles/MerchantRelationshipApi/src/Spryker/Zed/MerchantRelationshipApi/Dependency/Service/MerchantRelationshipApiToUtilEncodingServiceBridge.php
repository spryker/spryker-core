...
namespace Spryker\Zed\MerchantRelationshipApi\Dependency\Service;

class MerchantRelationshipApiToUtilEncodingServiceBridge implements MerchantRelationshipApiToUtilEncodingServiceInterface
{
    /**
