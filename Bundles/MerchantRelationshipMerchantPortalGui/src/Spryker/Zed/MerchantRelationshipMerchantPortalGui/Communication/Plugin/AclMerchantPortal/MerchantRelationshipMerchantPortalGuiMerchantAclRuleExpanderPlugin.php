...
namespace Spryker\Zed\MerchantRelationshipMerchantPortalGui\Communication\Plugin\AclMerchantPortal;
 ...
 */
class MerchantRelationshipMerchantPortalGuiMerchantAclRuleExpanderPlugin extends AbstractPlugin implements MerchantAclRuleExpanderPluginInterface
{
    /**
    ...
    /**
     * {@inheritDoc}
     * - Adds `merchant-relationship-merchant-portal-gui` to list of `AclRules`.
     *
     * @api
     *
    ...
    public function expand(array $ruleTransfers): array
    {
        $ruleTransfers[] = (new RuleTransfer())
            ->setBundle('merchant-relationship-merchant-portal-gui')
