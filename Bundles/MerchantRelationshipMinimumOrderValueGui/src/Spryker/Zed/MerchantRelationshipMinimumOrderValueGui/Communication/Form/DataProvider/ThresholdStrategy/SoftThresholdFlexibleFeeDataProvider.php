...
class SoftThresholdFlexibleFeeDataProvider implements ThresholdStrategyDataProviderInterface
{
    ...
    public function getData(array $data, MerchantRelationshipMinimumOrderValueTransfer $merchantRelationshipMinimumOrderValueTransfer): array
    {
        ...
        $data[ThresholdType::FIELD_SOFT_FLEXIBLE_FEE] = $merchantRelationshipMinimumOrderValueTransfer->getMinimumOrderValueThreshold()->getFee();
        $data[ThresholdType::FIELD_SOFT_STRATEGY] = MerchantRelationshipMinimumOrderValueGuiConfig::SOFT_TYPE_STRATEGY_FLEXIBLE;
