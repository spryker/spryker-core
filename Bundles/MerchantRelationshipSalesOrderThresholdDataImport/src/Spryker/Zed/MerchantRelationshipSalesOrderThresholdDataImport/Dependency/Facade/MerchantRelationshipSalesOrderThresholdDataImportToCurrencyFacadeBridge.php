...
class MerchantRelationshipSalesOrderThresholdDataImportToCurrencyFacadeBridge implements MerchantRelationshipSalesOrderThresholdDataImportToCurrencyFacadeInterface
{
    /**
