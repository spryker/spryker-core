 ...
 */
class MerchantRelationshipHardMaximumThresholdType extends AbstractMerchantRelationshipThresholdType
{
    /**
    ...
    {
        $this->addStrategyField($builder, $options[MerchantRelationshipThresholdType::OPTION_HARD_MAXIMUM_TYPES_ARRAY]);
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setRequired(MerchantRelationshipThresholdType::OPTION_HARD_MAXIMUM_TYPES_ARRAY);
    }
}
