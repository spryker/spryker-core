 ...
 */
class MerchantRelationshipHardThresholdType extends AbstractMerchantRelationshipThresholdType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setRequired(MerchantRelationshipThresholdType::OPTION_HARD_TYPES_ARRAY);
    }
}
