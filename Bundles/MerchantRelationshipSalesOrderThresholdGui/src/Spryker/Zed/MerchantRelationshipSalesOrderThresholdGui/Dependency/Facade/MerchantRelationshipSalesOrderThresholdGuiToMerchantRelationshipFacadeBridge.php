...
class MerchantRelationshipSalesOrderThresholdGuiToMerchantRelationshipFacadeBridge implements MerchantRelationshipSalesOrderThresholdGuiToMerchantRelationshipFacadeInterface
{
    /**
