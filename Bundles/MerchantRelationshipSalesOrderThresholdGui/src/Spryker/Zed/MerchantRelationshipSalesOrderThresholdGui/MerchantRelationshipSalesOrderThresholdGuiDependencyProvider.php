...
class MerchantRelationshipSalesOrderThresholdGuiDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    {
        $container->set(static::PROPEL_QUERY_MERCHANT_RELATIONSHIP, function () {
    ...
    {
        $container->set(static::PROPEL_QUERY_MERCHANT_RELATIONSHIP_SALES_ORDER_THRESHOLD, function () {
