...
class MerchantOrderDataReader implements MerchantSalesOrderDataReaderInterface
{
    /**
    ...
    {
        return $this->merchantSalesOrderDataExportRepository->getMerchantOrderData($dataExportConfigurationTransfer, $offset, $limit);
    }
}
