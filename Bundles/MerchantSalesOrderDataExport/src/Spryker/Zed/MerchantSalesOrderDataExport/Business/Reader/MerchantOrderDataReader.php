...
class MerchantOrderDataReader implements DataReaderInterface
{
    /**
    ...
    {
        return $this->merchantSalesOrderDataExportRepository->getMerchantOrderData($dataExportConfigurationTransfer);
    }
}
