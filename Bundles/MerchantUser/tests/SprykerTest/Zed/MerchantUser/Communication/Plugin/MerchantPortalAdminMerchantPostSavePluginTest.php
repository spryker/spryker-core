 ...
 * @group Communication
 * @group Plugin
 * @group MerchantPortalAdminMerchantPostSavePluginTest
 * Add your own group annotations below this line
 */
class MerchantPortalAdminMerchantPostSavePluginTest extends Unit
{
    /**
    ...
    public function testMerchantPortalAdminPostUpdateReturnsTrueIfUserDoesNotExist(): void
    {
        ...
        $merchantPortalAdminMerchantPostSavePlugin = new MerchantPortalAdminMerchantPostSavePlugin();

        // Act
        $merchantResponseTransfer = $merchantPortalAdminMerchantPostSavePlugin->postUpdate($merchantTransfer, $merchantTransfer);
    ...
    public function testMerchantPortalAdminPostUpdateReturnsFalseIfUserAlreadyConnectedToAnotherMerchant(): void
    {
        ...
        // Act
        $merchantResponseTransfer = $merchantPortalAdminMerchantPostSavePlugin->postUpdate($merchantTransfer, $merchantTransferWithSameEmail);
    ...
    public function testMerchantPortalAdminPostCreateReturnsTrueIfUserDoesNotExist(): void
    {
        ...
        // Act
        $merchantResponseTransfer = $merchantPortalAdminMerchantPostSavePlugin->postCreate($merchantTransfer);
    ...
    public function testMerchantPortalAdminPostCreateReturnsFalseIfUserAlreadyConnectedToAnotherMerchant(): void
    {
        ...
        // Act
        $merchantResponseTransfer = $merchantPortalAdminMerchantPostSavePlugin->postCreate($merchantTransferWithSameEmail);
