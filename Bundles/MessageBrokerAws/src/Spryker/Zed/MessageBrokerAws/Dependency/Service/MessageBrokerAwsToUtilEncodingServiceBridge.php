...
namespace Spryker\Zed\MessageBrokerAws\Dependency\Service;

class MessageBrokerAwsToUtilEncodingServiceBridge implements MessageBrokerAwsToUtilEncodingServiceInterface
{
    /**
