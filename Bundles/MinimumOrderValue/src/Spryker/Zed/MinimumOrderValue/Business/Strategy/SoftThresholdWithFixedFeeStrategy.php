...
class SoftThresholdWithFixedFeeStrategy extends AbstractMinimumOrderValueStrategy implements MinimumOrderValueStrategyInterface
{
    ...
    {
        return $minimumOrderValueTransfer->getFee();
    }
}
