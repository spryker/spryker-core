 ...
 */
class AddMinimumOrderValueThresholdsToQuoteCartPostSavePlugin extends AbstractPlugin implements PostSavePluginInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    {
        return $this->getFacade()->addMinimumOrderValueThresholdsToQuote($quoteTransfer);
    }
}
