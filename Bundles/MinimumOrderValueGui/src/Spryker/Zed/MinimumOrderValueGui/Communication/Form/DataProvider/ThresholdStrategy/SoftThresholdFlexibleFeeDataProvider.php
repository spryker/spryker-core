...
class SoftThresholdFlexibleFeeDataProvider implements ThresholdStrategyDataProviderInterface
{
    ...
    public function getData(array $data, GlobalMinimumOrderValueTransfer $globalMinimumOrderValueTransfer): array
    {
        ...
        $data[GlobalThresholdType::FIELD_SOFT_FLEXIBLE_FEE] = $globalMinimumOrderValueTransfer->getMinimumOrderValue()->getFee();
        $data[GlobalThresholdType::FIELD_SOFT_STRATEGY] = MinimumOrderValueGuiConstants::SOFT_TYPE_STRATEGY_FLEXIBLE;
