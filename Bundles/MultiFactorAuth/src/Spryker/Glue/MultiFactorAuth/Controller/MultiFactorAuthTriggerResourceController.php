 ...
 */
class MultiFactorAuthTriggerResourceController extends AbstractController
{
    /**
     * @Glue({
     *     "post": {
    ...
    public function postAction(
        ...
        return $this->getFactory()
            ->createMultiFactorAuthTriggerProcessor()
            ->triggerMultiFactorAuthCode($restRequest, $restMultiFactorAuthAttributesTransfer);
    }
}
