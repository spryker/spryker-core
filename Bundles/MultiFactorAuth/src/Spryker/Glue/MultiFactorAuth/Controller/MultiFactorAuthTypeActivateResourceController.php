 ...
 */
class MultiFactorAuthTypeActivateResourceController extends AbstractController
{
    /**
     * @Glue({
     *     "post": {
    ...
    public function postAction(
        ...
        return $this->getFactory()
            ->createMultiFactorAuthActivateProcessor()
            ->activateMultiFactorAuth($restRequest, $restMultiFactorAuthAttributesTransfer);
    }
}
