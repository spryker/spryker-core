 ...
 */
class MultiFactorAuthTypeDeactivateResourceController extends AbstractController
{
    /**
     * @Glue({
     *     "post": {
    ...
    public function postAction(
        ...
        return $this->getFactory()
            ->createMultiFactorAuthTypeDeactivateProcessor()
            ->deactivateMultiFactorAuth($restRequest, $restMultiFactorAuthAttributesTransfer);
    }
}
