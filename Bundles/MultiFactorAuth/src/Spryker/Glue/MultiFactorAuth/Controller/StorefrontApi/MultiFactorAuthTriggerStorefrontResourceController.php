 ...
 */
class MultiFactorAuthTriggerStorefrontResourceController extends AbstractController
{
    /**
     * @Glue({
     *      "post": {
     *           "summary": [
     *               "Triggers sending of multi-factor authentication code."
     *           ],
     *           "parameters": [
     *               {
     *                   "ref": "acceptLanguage"
    ...
    public function postAction(
        ...
        return $this->getFactory()
            ->createMultiFactorAuthStorefrontApiTriggerProcessor()
            ->triggerMultiFactorAuth($glueRequestTransfer, $restMultiFactorAuthAttributesTransfer);
    }
}
