 ...
 */
class MultiFactorAuthActivateResourcePlugin extends AbstractPlugin implements ResourceRoutePluginInterface
{
    /**
     * {@inheritDoc}
     * - Configures available actions for multi-factor-auth-activate resource.
     *
     * @api
     *
    ...
    {
        return MultiFactorAuthConfig::CONTROLLER_MULTI_FACTOR_AUTH_TYPE_ACTIVATE;
    }
