 ...
 */
class MultiFactorAuthTypesResourcePlugin extends AbstractPlugin implements ResourceRoutePluginInterface
{
    /**
     * {@inheritDoc}
     * - Configures available actions for multi-factor-auth-types resource.
     *
     * @api
     *
    ...
    {
        return MultiFactorAuthConfig::CONTROLLER_MULTI_FACTOR_AUTH_TYPES;
    }
