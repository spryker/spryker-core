 ...
 */
class CustomerEmailMultiFactorAuthPlugin extends AbstractPlugin implements MultiFactorAuthPluginInterface
{
    /**
     * @var string
     */
    ...
    /**
     * {@inheritDoc}
     * - Generates the multi-factor authentication code for the customer.
     * - Sends the multi-factor authentication code to the customer's email.
     *
     * @api
     *
     * @param \Generated\Shared\Transfer\MultiFactorAuthTransfer $multiFactorAuthTransfer
