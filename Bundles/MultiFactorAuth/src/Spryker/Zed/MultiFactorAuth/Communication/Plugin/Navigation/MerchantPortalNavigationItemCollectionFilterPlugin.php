...
{
    /**
     * @uses {@link \Spryker\Zed\MultiFactorAuth\Communication\Controller\UserManagementMerchantPortalController::setUpAction()}
     *
     * @var string
     */
    protected const NAVIGATION_ITEM_NAME = 'multi-factor-auth:user-management-merchant-portal:set-up';
