...
namespace Spryker\Zed\MultiFactorAuth\Communication\Plugin\Sender\Customer;
 ...
 */
class CustomerEmailCodeSenderStrategyPlugin extends AbstractPlugin implements SendStrategyPluginInterface
{
    /**
