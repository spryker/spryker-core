...
namespace SprykerTest\Zed\MultiFactorAuth\Communication\Plugin\Sender\Customer;
 ...
 * @group Sender
 * @group Customer
 * @group CustomerEmailCodeSenderStrategyPluginTest
 * Add your own group annotations below this line
 */
class CustomerEmailCodeSenderStrategyPluginTest extends Unit
{
    /**
     * @var string
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->customerEmailCodeSenderStrategyPlugin = new CustomerEmailCodeSenderStrategyPlugin();
    ...
    public function testIsApplicableReturnsTrueWhenTypeIsEmail(): void
    {
        ...
        $result = $this->customerEmailCodeSenderStrategyPlugin->isApplicable($multiFactorAuthTransfer);
    ...
    public function testSendCallsHandleMail(): void
    {
        ...
        $this->customerEmailCodeSenderStrategyPlugin->send($multiFactorAuthTransfer);
    }
}
