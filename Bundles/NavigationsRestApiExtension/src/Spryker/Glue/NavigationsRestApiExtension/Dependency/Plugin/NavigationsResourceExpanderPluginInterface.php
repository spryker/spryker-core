...
namespace Spryker\Glue\NavigationsRestApiExtension\Dependency\Plugin;

use Generated\Shared\Transfer\RestNavigationAttributesTransfer;
use Spryker\Glue\GlueApplication\Rest\Request\Data\RestRequestInterface;

interface NavigationsResourceExpanderPluginInterface
{
    /**
     * Specification:
     *  - Expands navigations resource with additional data.
     *
     * @api
     *
