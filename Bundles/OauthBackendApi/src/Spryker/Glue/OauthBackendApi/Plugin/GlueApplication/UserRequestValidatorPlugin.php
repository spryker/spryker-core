 ...
 */
class UserRequestValidatorPlugin extends AbstractPlugin implements RequestValidatorPluginInterface
{
    /**
     * {@inheritDoc}
     * - Validates if `GlueRequestTransfer.requestUser` is set in case if the request has Authorization header.
     *
     * @api
     *
