 ...
 */
class CustomerAuthCodeGrantTypeBuilder implements GrantTypeBuilderInterface
{
    /**
    ...
    public function buildGrant(
        ...
        $customerAuthCodeGrantType = new AuthCodeGrantType(
            $this->getConfig(),
            $this->createAuthCodeRepository(),
            $repositoryBuilder->createRefreshTokenRepository(),
        );

        return $customerAuthCodeGrantType;
    }
