 ...
 */
class OmsMerchantAclEntityRuleExpanderPlugin extends AbstractPlugin implements MerchantAclEntityRuleExpanderPluginInterface
{
    /**
    ...
    /**
     * {@inheritDoc}
     * - Expands set of `AclEntityRule` transfer objects with oms composite data.
     *
     * @api
     *
