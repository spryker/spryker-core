 ...
 */
class StateHistoryOrderItemExpanderPlugin extends AbstractPlugin implements OrderItemExpanderPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFacade()->expandOrderItemsWithStateHistory($itemTransfers);
    }
}
