 ...
 */
class IsPaymentAppPaymentStatusAuthorizationFailedConditionPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    public function check(SpySalesOrderItem $orderItem): bool
    {
        ...
        $paymentAppPaymentStatusRequestTransfer
            ...
            ->setStatus(PaymentStatus::STATUS_AUTHORIZATION_FAILED);
