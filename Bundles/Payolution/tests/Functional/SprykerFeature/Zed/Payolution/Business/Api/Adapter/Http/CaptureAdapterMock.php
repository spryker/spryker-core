...
class CaptureAdapterMock extends AbstractAdapterMock
{
    ...
    public function getSuccessResponse()
    {
        return [
            ...
            'IDENTIFICATION_REFERENCEID' => '8a8294494fd6cc31014fdf6be19a528d',
            ...
            'IDENTIFICATION_TRANSACTIONID' => 'tran_55fbc19447ad1',
...
'CLEARING_FXDATE' => "2015-09-18 07:47:32\r\n",
    ...
    public function getFailureResponse()
    {
        return [
            ...
            'RESPONSE_VERSION' => '1.0',
            'IDENTIFICATION_REFERENCEID' => '8a8294494fd6cc31014fdf8697700982',
            'TRANSACTION_RESPONSE' => 'SYNC',
            'P3_VALIDATION' => 'ACK',
            ...
            'IDENTIFICATION_TRANSACTIONID' => 'tran_55fbc86189adb',
