 ...
 */
class DatabaseQuoteStorageStrategy extends AbstractPlugin implements QuoteStorageStrategyPluginInterface, QuotResetLockQuoteStorageStrategyPluginInterface
{
    /**
     * @return string
     */
