 ...
 */
class PushNotificationPickingListPostCreatePlugin extends AbstractPlugin implements PickingListPostCreatePluginInterface
{
    /**
     * @var string
     */
    ...
    public function postCreate(PickingListCollectionResponseTransfer $pickingListCollectionResponseTransfer): PickingListCollectionResponseTransfer
    {
        $pushNotificationCollectionRequestTransfer = (new PushNotificationCollectionRequestTransfer())
            ...
            ->setAction(static::ACTION_CREATE);
