...
namespace Spryker\Glue\PickingListsProductsBackendResourceRelationship\Processor\Reader;
...
{
    /**
     * @var \Spryker\Glue\PickingListsProductsBackendResourceRelationship\Dependency\Resource\PickingListsProductsBackendResourceRelationshipToProductsBackendApiResourceInterface
     */
    protected PickingListsProductsBackendResourceRelationshipToProductsBackendApiResourceInterface $productsBackendApiResource;

    /**
     * @param \Spryker\Glue\PickingListsProductsBackendResourceRelationship\Dependency\Resource\PickingListsProductsBackendResourceRelationshipToProductsBackendApiResourceInterface $productsBackendApiResource
     */
    public function __construct(
        PickingListsProductsBackendResourceRelationshipToProductsBackendApiResourceInterface $productsBackendApiResource
    ) {
