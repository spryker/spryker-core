...
namespace SprykerTest\Glue\PickingListsProductsBackendResourceRelationship\Plugin\GlueBackendApiApplicationGlueJsonApiConventionConnector;
 ...
 * @group SprykerTest
 * @group Glue
 * @group PickingListsProductsBackendResourceRelationship
 * @group Plugin
...
class ConcreteProductsByPickingListItemsBackendResourceRelationshipPluginTest extends Unit
{
    ...
    /**
     * @var \SprykerTest\Glue\PickingListsProductsBackendResourceRelationship\PickingListsProductsBackendResourceRelationshipTester
     */
    protected PickingListsProductsBackendResourceRelationshipTester $tester;
