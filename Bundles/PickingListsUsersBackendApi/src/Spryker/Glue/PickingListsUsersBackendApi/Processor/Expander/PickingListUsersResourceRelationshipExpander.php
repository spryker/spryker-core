...
namespace Spryker\Glue\PickingListsUsersBackendApi\Processor\Expander;
...
{
    /**
     * @var \Spryker\Glue\PickingListsUsersBackendApi\Processor\Filter\PickingListResourceFilterInterface
     */
    protected PickingListResourceFilterInterface $pickingListResourceFilter;

    /**
     * @var \Spryker\Glue\PickingListsUsersBackendApi\Processor\Reader\PickingListUsersResourceRelationshipReaderInterface
     */
    protected PickingListUsersResourceRelationshipReaderInterface $pickingListUsersResourceRelationshipReader;

    /**
     * @param \Spryker\Glue\PickingListsUsersBackendApi\Processor\Filter\PickingListResourceFilterInterface $pickingListResourceFilter
     * @param \Spryker\Glue\PickingListsUsersBackendApi\Processor\Reader\PickingListUsersResourceRelationshipReaderInterface $pickingListUsersResourceRelationshipReader
     */
