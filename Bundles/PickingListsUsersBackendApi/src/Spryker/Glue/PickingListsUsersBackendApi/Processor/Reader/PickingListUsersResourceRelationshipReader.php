...
namespace Spryker\Glue\PickingListsUsersBackendApi\Processor\Reader;
...
{
    /**
     * @var \Spryker\Glue\PickingListsUsersBackendApi\Dependency\Facade\PickingListsUsersBackendApiToPickingListFacadeInterface
     */
    protected PickingListsUsersBackendApiToPickingListFacadeInterface $pickingListFacade;

    /**
     * @var \Spryker\Glue\PickingListsUsersBackendApi\Dependency\Resource\PickingListsUsersBackendApiToUsersBackendApiResourceInterface
     */
    protected PickingListsUsersBackendApiToUsersBackendApiResourceInterface $usersBackendApiResource;

    /**
     * @param \Spryker\Glue\PickingListsUsersBackendApi\Dependency\Facade\PickingListsUsersBackendApiToPickingListFacadeInterface $pickingListFacade
     * @param \Spryker\Glue\PickingListsUsersBackendApi\Dependency\Resource\PickingListsUsersBackendApiToUsersBackendApiResourceInterface $usersBackendApiResource
     */
    public function __construct(
        PickingListsUsersBackendApiToPickingListFacadeInterface $pickingListFacade,
        PickingListsUsersBackendApiToUsersBackendApiResourceInterface $usersBackendApiResource
    ) {
