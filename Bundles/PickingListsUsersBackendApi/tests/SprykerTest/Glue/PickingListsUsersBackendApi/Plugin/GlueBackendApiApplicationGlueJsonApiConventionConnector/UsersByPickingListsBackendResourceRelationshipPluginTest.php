...
namespace SprykerTest\Glue\PickingListsUsersBackendApi\Plugin\GlueBackendApiApplicationGlueJsonApiConventionConnector;
...
use SprykerTest\Glue\PickingListsUsersBackendApi\PickingListsUsersBackendApiTester;
 ...
 * @group SprykerTest
 * @group Glue
 * @group PickingListsUsersBackendApi
 * @group Plugin
...
class UsersByPickingListsBackendResourceRelationshipPluginTest extends Unit
{
    ...
    /**
     * @var \SprykerTest\Glue\PickingListsUsersBackendApi\PickingListsUsersBackendApiTester
     */
    protected PickingListsUsersBackendApiTester $tester;
