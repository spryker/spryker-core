 ...
 *
 * @SuppressWarnings(\SprykerTest\Glue\PickingListsUsersBackendApi\PHPMD)
 */
class PickingListsUsersBackendApiTester extends Actor
{
    use _generated\PickingListsUsersBackendApiTesterActions;
