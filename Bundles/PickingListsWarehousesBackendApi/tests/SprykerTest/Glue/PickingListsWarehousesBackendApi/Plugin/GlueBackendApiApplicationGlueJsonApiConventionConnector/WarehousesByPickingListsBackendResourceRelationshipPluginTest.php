...
namespace SprykerTest\Glue\PickingListsWarehousesBackendApi\Plugin\GlueBackendApiApplicationGlueJsonApiConventionConnector;
...
use SprykerTest\Glue\PickingListsWarehousesBackendApi\PickingListsWarehousesBackendApiTester;
 ...
 * @group SprykerTest
 * @group Glue
 * @group PickingListsWarehousesBackendApi
 * @group Plugin
...
class WarehousesByPickingListsBackendResourceRelationshipPluginTest extends Unit
{
    ...
    /**
     * @var \SprykerTest\Glue\PickingListsWarehousesBackendApi\PickingListsWarehousesBackendApiTester
     */
    protected PickingListsWarehousesBackendApiTester $tester;
