...
namespace SprykerTest\Glue\PickingListsWarehousesBackendApi;
 ...
 *
 * @SuppressWarnings(\SprykerTest\Glue\PickingListsWarehousesBackendApi\PHPMD)
 */
class PickingListsWarehousesBackendApiTester extends Actor
{
    use _generated\PickingListsWarehousesBackendApiTesterActions;
