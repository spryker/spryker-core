...
class PriceProductConcreteTableConfigurationExpander implements PriceProductConcreteTableConfigurationExpanderInterface
{
    /**
     * @uses \Spryker\Zed\ProductMerchantPortalGui\Communication\GuiTable\ConfigurationProvider\PriceProductConcreteGuiTableConfigurationProvider::FORMAT_STRING_PRICES_URL
     *
     * @var string
     */
    ...
    /**
     * @uses \Spryker\Zed\ProductMerchantPortalGui\Communication\GuiTable\ConfigurationProvider\PriceProductConcreteGuiTableConfigurationProvider::URL_SAVE_PRICES
     *
     * @var string
     */
    ...
    /**
     * @uses \Spryker\Zed\ProductMerchantPortalGui\Communication\GuiTable\ConfigurationProvider\PriceProductConcreteGuiTableConfigurationProvider::URL_DELETE_PRICE
     *
     * @var string
     */
    ...
    /**
     * @uses \Spryker\Zed\ProductMerchantPortalGui\Communication\GuiTable\ConfigurationProvider\PriceProductConcreteGuiTableConfigurationProvider::ID_ROW_ACTION_URL_DELETE_PRICE
     *
     * @var string
     */
    ...
    protected function reorderTableColumns(array $columns): array
    {
        $customerColumn = [
            PriceProductTableViewTransfer::ID_MERCHANT_RELATIONSHIP =>
                $columns[PriceProductTableViewTransfer::ID_MERCHANT_RELATIONSHIP],
        ];
