...
namespace Spryker\Zed\PriceProductMerchantRelationshipMerchantPortalGui\Communication\Plugin\AclMerchantPortal;
 ...
 */
class PriceProductMerchantRelationshipMerchantPortalGuiMerchantAclRuleExpanderPlugin extends AbstractPlugin implements MerchantAclRuleExpanderPluginInterface
{
    /**
    ...
    /**
     * {@inheritDoc}
     * - Adds `price-product-merchant-relationship-merchant-portal-gui` to list of `AclRules`.
     *
     * @api
     *
    ...
    public function expand(array $ruleTransfers): array
    {
        $ruleTransfers[] = (new RuleTransfer())
            ->setBundle('price-product-merchant-relationship-merchant-portal-gui')
