 ...
 */
class PriceProductAbstractMerchantRelationEventResourceBulkRepositoryPlugin extends AbstractPlugin implements EventResourceBulkRepositoryPluginInterface
{
    /**
    ...
    public function getData(int $offset, int $limit): array
    {
        ...
        return $this->getRepository()
            ->getFilteredPriceProductAbstractMerchantRelationshipEntities($filterTransfer);
    }
