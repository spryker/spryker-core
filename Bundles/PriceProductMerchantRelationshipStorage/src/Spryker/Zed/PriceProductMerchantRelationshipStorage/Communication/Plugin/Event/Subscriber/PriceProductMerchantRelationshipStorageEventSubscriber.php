...
use Spryker\Zed\PriceProductMerchantRelationshipStorage\Communication\Plugin\Event\Listener\MerchantRelationshipDeleteListener;
...
class PriceProductMerchantRelationshipStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    protected function addMerchantRelationshipDeleteListener(EventCollectionInterface $eventCollection): self
    {
        $eventCollection->addListenerQueued(
            ...
            new MerchantRelationshipDeleteListener()
        );
