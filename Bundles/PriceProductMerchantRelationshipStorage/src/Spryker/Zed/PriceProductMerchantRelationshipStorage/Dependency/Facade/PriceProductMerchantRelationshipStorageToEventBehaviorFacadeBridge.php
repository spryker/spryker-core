...
class PriceProductMerchantRelationshipStorageToEventBehaviorFacadeBridge implements PriceProductMerchantRelationshipStorageToEventBehaviorFacadeInterface
{
    /**
