...
namespace Spryker\Zed\PriceStorage\Dependency\Facade;

class PriceStorageToEventBehaviorFacadeBridge implements PriceStorageToEventBehaviorFacadeInterface
{
    /**
