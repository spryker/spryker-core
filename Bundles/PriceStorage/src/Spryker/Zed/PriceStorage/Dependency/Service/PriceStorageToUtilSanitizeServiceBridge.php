...
namespace Spryker\Zed\PriceStorage\Dependency\Service;

class PriceStorageToUtilSanitizeServiceBridge implements PriceStorageToUtilSanitizeServiceInterface
{
