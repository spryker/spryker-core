...
use Spryker\Client\Product\Storage\AttributeMapStorageInterface;
use Spryker\Client\Product\Storage\ProductConcreteStorageInterface;
use Spryker\Shared\Product\ProductConfig;

class AttributeVariantMapper implements AttributeVariantMapperInterface
{
    /**
     * @var \Spryker\Client\Product\Storage\ProductConcreteStorageInterface
     */
    protected $productConcreteStorage;

    /**
     * @var \Spryker\Client\Product\Storage\AttributeMapStorageInterface
     */
    protected $attributeMapStorage;
    ...
    /**
     * @param \Spryker\Client\Product\Storage\ProductConcreteStorageInterface $productConcreteStorage
     * @param \Spryker\Client\Product\Storage\AttributeMapStorageInterface $attributeMapStorage
     */
    public function __construct(ProductConcreteStorageInterface $productConcreteStorage, AttributeMapStorageInterface $attributeMapStorage)
    {
        $this->productConcreteStorage = $productConcreteStorage;
        $this->attributeMapStorage = $attributeMapStorage;
    }
    ...
    {
        return $this->productConcreteStorage->getProductConcreteById($idProductConcrete);
    }
    ...
    protected function getAttributeMapFromStorage($idProductAbstract)
    {
        if (!isset($this->attributeMap[$idProductAbstract])) {
            $this->attributeMap[$idProductAbstract] = $this->attributeMapStorage->getAttributeMapByIdProductAbstract($idProductAbstract);
        }
