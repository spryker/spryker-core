 ...
 */
class ProductConcreteCreatedMessageBrokerPublisherPlugin extends AbstractProductMessageBrokerPublisherPlugin
{
    /**
     * {@inheritDoc}
    ...
    public function getSubscribedEvents(): array
    {
        $messageSendingContextTransfer = (new MessageSendingContextTransfer())
            ->setMessageName(ProductCreatedTransfer::class);
