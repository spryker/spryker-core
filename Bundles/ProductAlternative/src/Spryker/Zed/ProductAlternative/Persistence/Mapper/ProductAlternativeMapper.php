...
class ProductAlternativeMapper implements ProductAlternativeMapperInterface
{
    ...
    public function mapProductAlternativeTransferToEntity(
        ...
        $spyProductAlternative->fromArray(
            $productAlternativeTransfer->modifiedToArray(false)
        );

        return $spyProductAlternative;
    }
    ...
    public function mapEntityToProductAlternativeTransfer(
        ...
        return $productAlternativeTransfer->fromArray(
            $spyProductAlternative->toArray()
        );
    }
}
