...
class ProductAlternativesRestApiToProductAlternativeStorageClientBridge implements ProductAlternativesRestApiToProductAlternativeStorageClientInterface
{
    /**
