 ...
 */
class ProductBundleOrderItemExpanderPlugin extends AbstractPlugin implements OrderItemExpanderPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFacade()->expandItemsWithProductBundles($itemTransfers);
    }
}
