...
namespace Spryker\Glue\ProductBundlesCartsRestApi\Dependency\Client;

use ArrayObject;

class ProductBundlesCartsRestApiToProductBundleClientBridge implements ProductBundlesCartsRestApiToProductBundleClientInterface
{
    /**
