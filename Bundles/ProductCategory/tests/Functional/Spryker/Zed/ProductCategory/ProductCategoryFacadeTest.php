...
class ProductCategoryFacadeTest extends Test
{
    ...
    public function testCreateAttributeTypeCreatesAndReturnsId()
    {
        ...
        $productConcreteTransfer = $this->buildProductConcreteTransfer($idProductAbstract, $concreteSku, $localizedAttributesTransfer);
     ...
     */
    protected function buildProductConcreteTransfer($idProductAbstract, $concreteSku, LocalizedAttributesTransfer $localizedAttributesTransfer)
    {
