...
namespace Spryker\Zed\ProductCategoryFilterStorage\Dependency\Facade;

class ProductCategoryFilterStorageToEventBehaviorFacadeBridge implements ProductCategoryFilterStorageToEventBehaviorFacadeInterface
{
    /**
