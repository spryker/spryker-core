...
class ProductCategoryStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(ProductCategoryEvents::PRODUCT_CATEGORY_PUBLISH, new ProductCategoryPublishStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductCategoryEvents::PRODUCT_CATEGORY_UNPUBLISH, new ProductCategoryPublishStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductCategoryEvents::ENTITY_SPY_PRODUCT_CATEGORY_CREATE, new ProductCategoryStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductCategoryEvents::ENTITY_SPY_PRODUCT_CATEGORY_UPDATE, new ProductCategoryStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductCategoryEvents::ENTITY_SPY_PRODUCT_CATEGORY_DELETE, new ProductCategoryStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_CREATE, new CategoryStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_UPDATE, new CategoryStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_DELETE, new CategoryStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_ATTRIBUTE_CREATE, new CategoryAttributeStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_ATTRIBUTE_UPDATE, new CategoryAttributeStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_ATTRIBUTE_DELETE, new CategoryAttributeStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_NODE_CREATE, new CategoryNodeStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_NODE_UPDATE, new CategoryNodeStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_NODE_DELETE, new CategoryNodeStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_CREATE, new CategoryUrlStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_UPDATE, new CategoryUrlStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_DELETE, new CategoryUrlStorageListener(), 0, null, $this->getConfig()->getProductCategoryEventQueueName());
    }
}
