...
class CategoryWritePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
     * - Publishes product category data by `SpyCategory` entity events.
     *
     * @api
     *
    ...
    {
        $this->getFacade()->writeCollectionByCategoryEvents($eventEntityTransfers);
    }
    ...
    {
        return [
            ProductCategoryStorageConfig::ENTITY_SPY_CATEGORY_DELETE,
        ];
    }
}
