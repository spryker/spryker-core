 ...
 */
class CategoryAttributeNameWritePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return [
            ProductCategoryStorageConfig::ENTITY_SPY_CATEGORY_ATTRIBUTE_CREATE,
            ProductCategoryStorageConfig::ENTITY_SPY_CATEGORY_ATTRIBUTE_UPDATE,
        ];
    }
}
