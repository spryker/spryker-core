...
namespace Spryker\Zed\ProductCategoryStorage\Communication\Plugin\Publisher\CategoryAttribute;
 ...
 */
class CategoryAttributeWritePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        $this->getFacade()->writeCollectionByCategoryAttributeEvents($eventEntityTransfers);
    }
    ...
    {
        return [
            ProductCategoryStorageConfig::ENTITY_SPY_CATEGORY_ATTRIBUTE_DELETE,
        ];
    }
}
