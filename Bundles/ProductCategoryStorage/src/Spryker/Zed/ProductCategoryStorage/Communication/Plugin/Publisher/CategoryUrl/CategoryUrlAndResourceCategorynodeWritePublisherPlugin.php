...
namespace Spryker\Zed\ProductCategoryStorage\Communication\Plugin\Publisher\CategoryUrl;
 ...
 */
class CategoryUrlAndResourceCategorynodeWritePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        $this->getFacade()->writeCollectionByCategoryUrlAndResourceCategorynodeEvents($eventEntityTransfers);
    }
    ...
    {
        return [
            ProductCategoryStorageConfig::ENTITY_SPY_URL_CREATE,
            ProductCategoryStorageConfig::ENTITY_SPY_URL_UPDATE,
        ];
    }
}
