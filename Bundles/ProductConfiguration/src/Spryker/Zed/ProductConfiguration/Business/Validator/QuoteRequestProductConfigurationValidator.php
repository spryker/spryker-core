...
namespace Spryker\Zed\ProductConfiguration\Business\Validator;
...
class QuoteRequestProductConfigurationValidator implements QuoteRequestProductConfigurationValidatorInterface
{
    ...
    {
        return $quoteRequestTransfer->getLatestVersion() && $quoteRequestTransfer->getLatestVersion()->getQuote();
    }
    ...
    {
        return (bool)$itemTransfer->getProductConfigurationInstance()->getIsComplete();
    }
