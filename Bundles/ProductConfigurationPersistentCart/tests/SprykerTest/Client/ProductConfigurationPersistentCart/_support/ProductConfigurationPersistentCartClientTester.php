...
namespace SprykerTest\Client\ProductConfigurationPersistentCart;

use Codeception\Actor;
use Spryker\Client\ProductConfigurationPersistentCart\ProductConfigurationPersistentCartClientInterface;
 ...
 */
class ProductConfigurationPersistentCartClientTester extends Actor
{
    use _generated\ProductConfigurationPersistentCartClientTesterActions;
    ...
    /**
     * @return \Spryker\Client\ProductConfigurationPersistentCart\ProductConfigurationPersistentCartClientInterface
     */
    public function getClient(): ProductConfigurationPersistentCartClientInterface
    {
        return $this->getLocator()->productConfigurationPersistentCart()->client();
    }
