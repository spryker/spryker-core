...
namespace Spryker\Client\ProductConfigurationStorage\Plugin\PersistentCart;
...
class ProductConfigurationPersistentCartRequestExpanderPlugin extends AbstractPlugin implements PersistentCartChangeExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Expands provided persistent cart change items with product configuration instance.
     *
     * @api
     *
