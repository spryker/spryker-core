...
class ProductConfigurationWishlistsRestApiToProductConfigurationServiceBridge implements ProductConfigurationWishlistsRestApiToProductConfigurationServiceInterface
{
    /**
