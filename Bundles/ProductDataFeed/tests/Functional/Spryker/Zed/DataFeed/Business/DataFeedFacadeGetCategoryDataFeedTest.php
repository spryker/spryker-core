 ...
 */
class DataFeedFacadeGetCategoryDataFeedTest extends Test
{
     ...
     */
    protected $categoryFeedJoinTransfer;
    ...
    public function setUp()
    {
        ...
        $this->categoryFeedJoinTransfer = $this->createCategoryFeedJoinTransfer();
    ...
    public function testGetCategoryDataFeed()
    {
        ...
        $this->dataFeedTransfer->setCategoryFeedJoin($this->categoryFeedJoinTransfer);
    ...
    {
        $this->localeTransfer->setIdLocale(46);
        $this->categoryFeedJoinTransfer->setIsJoinProduct(true);
        $this->dataFeedTransfer->setCategoryFeedJoin($this->categoryFeedJoinTransfer);
        $this->dataFeedTransfer->setLocale($this->localeTransfer);
    ...
    /**
     * @return CategoryFeedJoinTransfer
     */
    protected function createCategoryFeedJoinTransfer()
    {
        $categoryFeedJoinTransfer = new CategoryFeedJoinTransfer();
