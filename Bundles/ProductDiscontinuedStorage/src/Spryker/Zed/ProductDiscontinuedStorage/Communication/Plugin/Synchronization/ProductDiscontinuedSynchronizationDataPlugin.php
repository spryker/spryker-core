...
/**
 * @deprecated Use `ProductDiscontinuedSynchronizationDataBulkPlugin` instead.
 * @see \Spryker\Zed\ProductDiscontinuedStorage\Communication\Plugin\Synchronization\ProductDiscontinuedSynchronizationDataBulkPlugin
 *
