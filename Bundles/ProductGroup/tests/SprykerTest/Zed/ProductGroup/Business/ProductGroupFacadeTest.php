...
namespace SprykerTest\Zed\ProductGroup\Business;

use Codeception\TestCase\Test;
use Generated\Shared\Transfer\ProductGroupTransfer;

class ProductGroupFacadeTest extends Test
{
    ...
    public function testUpdateProductGroupPersistChangesToDatabase()
    {
        ...
        $productGroupTransfer->addIdProductAbstract($productAbstractTransfer3->getIdProductAbstract());
        ...
        // Assert
        $actualProductGroupTransfer = $this->tester->getFacade()->findProductGroup($productGroupTransfer);
        $this->assertCount(3, $actualProductGroupTransfer->getIdProductAbstracts(), 'Product group should have expected number of products.');
    }
