...
namespace Spryker\Zed\ProductGroupStorage\Dependency\Facade;

class ProductGroupStorageToEventBehaviorFacadeBridge implements ProductGroupStorageToEventBehaviorFacadeInterface
{
    /**
