...
class AbstractProductImageSetsRoutePlugin extends AbstractPlugin implements ResourceRoutePluginInterface, ResourceWithParentPluginInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    {
        return ProductImageSetsRestApiConfig::RESOURCE_ABSTRACT_PRODUCT_IMAGE_SETS;
    }
    ...
    {
        return 'abstract-product-image-sets-resource';
    }
