...
namespace Spryker\Zed\ProductImageStorage\Dependency\Service;

class ProductImageStorageToUtilSanitizeServiceBridge implements ProductImageStorageToUtilSanitizeServiceInterface
{
    /**
