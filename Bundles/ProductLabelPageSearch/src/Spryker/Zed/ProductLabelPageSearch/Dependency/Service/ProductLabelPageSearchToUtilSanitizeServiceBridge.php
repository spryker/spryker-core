...
namespace Spryker\Zed\ProductLabelPageSearch\Dependency\Service;

class ProductLabelPageSearchToUtilSanitizeServiceBridge implements ProductLabelPageSearchToUtilSanitizeServiceInterface
{
