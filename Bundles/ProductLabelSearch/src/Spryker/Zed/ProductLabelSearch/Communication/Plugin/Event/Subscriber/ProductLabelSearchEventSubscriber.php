...
class ProductLabelSearchEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(ProductLabelEvents::ENTITY_SPY_PRODUCT_LABEL_PRODUCT_ABSTRACT_CREATE, new ProductLabelProductAbstractSearchListener(), 0, null, $this->getConfig()->getProductLabelEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductLabelEvents::ENTITY_SPY_PRODUCT_LABEL_PRODUCT_ABSTRACT_UPDATE, new ProductLabelProductAbstractSearchListener(), 0, null, $this->getConfig()->getProductLabelEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductLabelEvents::ENTITY_SPY_PRODUCT_LABEL_PRODUCT_ABSTRACT_DELETE, new ProductLabelProductAbstractSearchListener(), 0, null, $this->getConfig()->getProductLabelEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductLabelEvents::ENTITY_SPY_PRODUCT_LABEL_UPDATE, new ProductLabelSearchListener(), 0, null, $this->getConfig()->getProductLabelEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductLabelEvents::ENTITY_SPY_PRODUCT_LABEL_DELETE, new ProductLabelSearchListener(), 0, null, $this->getConfig()->getProductLabelEventQueueName());
    }
}
