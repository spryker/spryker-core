...
class KeyStrategy implements KeyStrategyInterface
{
    /**
     ...
     * @return string|null
     */
    public function getDictionaryKey(ProductLabelDictionaryItemTransfer $productLabelDictionaryItemTransfer): ?string
    {
