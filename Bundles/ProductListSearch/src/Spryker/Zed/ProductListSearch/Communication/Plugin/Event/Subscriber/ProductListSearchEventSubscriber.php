...
class ProductListSearchEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_CREATE, new ProductSearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_UPDATE, new ProductSearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_DELETE, new ProductSearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductCategoryEvents::ENTITY_SPY_PRODUCT_CATEGORY_CREATE, new ProductListCategorySearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductCategoryEvents::ENTITY_SPY_PRODUCT_CATEGORY_UPDATE, new ProductListCategorySearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductCategoryEvents::ENTITY_SPY_PRODUCT_CATEGORY_DELETE, new ProductListCategorySearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::PRODUCT_LIST_CATEGORY_PUBLISH, new ProductListProductCategoryPublishSearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_CATEGORY_CREATE, new ProductListProductCategorySearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_CATEGORY_UPDATE, new ProductListProductCategorySearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_CATEGORY_DELETE, new ProductListProductCategorySearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::PRODUCT_LIST_PRODUCT_CONCRETE_PUBLISH, new ProductListProductConcretePublishSearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_PRODUCT_CONCRETE_CREATE, new ProductListProductConcreteSearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_PRODUCT_CONCRETE_UPDATE, new ProductListProductConcreteSearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_PRODUCT_CONCRETE_DELETE, new ProductListProductConcreteSearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_UPDATE, new ProductListSearchListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_UPDATE, new ProductListProductConcretePageSearchPublishListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_PRODUCT_CONCRETE_CREATE, new ProductListProductConcreteProductConcretePageSearchPublishListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_PRODUCT_CONCRETE_UPDATE, new ProductListProductConcreteProductConcretePageSearchPublishListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_PRODUCT_CONCRETE_DELETE, new ProductListProductConcreteProductConcretePageSearchPublishListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_CATEGORY_CREATE, new ProductListCategoryProductConcretePageSearchPublishListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_CATEGORY_UPDATE, new ProductListCategoryProductConcretePageSearchPublishListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductListEvents::ENTITY_SPY_PRODUCT_LIST_CATEGORY_DELETE, new ProductListCategoryProductConcretePageSearchPublishListener(), 0, null, $this->getConfig()->getProductListEventQueueName());
    }
}
