...
class ProductListSearchDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    {
        $container->set(static::PROPEL_PRODUCT_QUERY, function () {
    ...
    {
        $container->set(static::PROPEL_PRODUCT_CATEGORY_QUERY, function () {
    ...
    {
        $container->set(static::PROPEL_PRODUCT_LIST_CATEGORY_QUERY, function () {
    ...
    {
        $container->set(static::PROPEL_PRODUCT_LIST_PRODUCT_CONCRETE_QUERY, function () {
