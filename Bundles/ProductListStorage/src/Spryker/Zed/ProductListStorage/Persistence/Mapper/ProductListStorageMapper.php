...
class ProductListStorageMapper implements ProductListStorageMapperInterface
{
    /**
    ...
    public function mapProductConcreteProductListStorageEntitiesToTransfers(
        ...
        return $productConcreteProductListStorageEntityTransfer->fromArray(
            $productConcreteProductListStorageEntity->toArray(),
            true
        );
    }
    ...
    public function mapProductAbstractProductListStorageEntitiesToTransfers(
        ...
        return $productAbstractProductListStorageEntityTransfer->fromArray(
            $productAbstractProductListStorageEntity->toArray(),
            true
        );
    }
}
