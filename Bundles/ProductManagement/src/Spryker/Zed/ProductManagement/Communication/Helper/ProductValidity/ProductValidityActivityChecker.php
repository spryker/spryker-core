...
{
    const DEACTIVATION_IN_FUTURE_MESSAGE = 'This product will be deactivated at %s. Check field "Valid To".';
    const DEACTIVATION_NOW_MESSAGE = <<<'EOD'
        This product will be deactivated shortly.
        Because validity overrule activity.
        Check field "Valid To", it is set in past, to %s.
EOD;

    const ACTIVATION_IN_FUTURE_MESSAGE = 'This product will be activated at %s. Check field "Valid From".';
    const ACTIVATION_NOW_MESSAGE = <<<'EOD'
        This product will be activated shortly.
        Because validity overrule activity.
        Check field "Valid From", it is set in past, to %s.
EOD;
