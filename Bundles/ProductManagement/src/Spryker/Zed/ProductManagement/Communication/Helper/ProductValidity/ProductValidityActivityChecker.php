...
{
    const DEACTIVATION_IN_FUTURE_MESSAGE = 'This product will be deactivated at %s. Check the field "Valid To".';
...
EOD;
    ...
    const ACTIVATION_IN_FUTURE_MESSAGE = 'This product will be activated at %s. Check the field "Valid From".';
