...
class ProductManagementDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    public const PRODUCT_CONCRETE_EDIT_FORM_EXPANDER_PLUGINS = 'PRODUCT_MANAGEMENT:PRODUCT_CONCRETE_EDIT_FORM_EXPANDER_PLUGINS';
    public const PRODUCT_CONCRETE_FORM_EDIT_DATA_PROVIDER_EXPANDER_PLUGINS = 'PRODUCT_MANAGEMENT:PRODUCT_CONCRETE_FORM_EDIT_DATA_PROVIDER_EXPANDER_PLUGINS';
    public const PRODUCT_FORM_TRANSFER_MAPPER_EXPANDER_PLUGINS = 'PRODUCT_MANAGEMENT:PRODUCT_FORM_TRANSFER_MAPPER_EXPANDER_PLUGINS';
