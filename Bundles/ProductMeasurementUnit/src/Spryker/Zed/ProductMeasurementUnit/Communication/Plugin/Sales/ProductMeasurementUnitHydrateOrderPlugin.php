 ...
 */
class ProductMeasurementUnitHydrateOrderPlugin extends AbstractPlugin implements HydrateOrderPluginInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    {
        return $this->getFacade()->hydrateOrderWithQuantitySalesUnit($orderTransfer);
    }
}
