...
class ProductMeasurementSalesUnitStoreDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    ...
    {
        return $this->getFacade()->importProductMeasurementSalesUnitStore($dataImporterConfigurationTransfer);
    }
    ...
    {
        return ProductMeasurementUnitDataImportConfig::IMPORT_TYPE_PRODUCT_MEASUREMENT_SALES_UNIT_STORE;
    }
}
