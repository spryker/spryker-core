...
class SuperAttributeForm extends AbstractType
{
     ...
     * @return $this
     */
    protected function addAttributeField(FormBuilderInterface $builder)
    {
        $builder->add(static::FIELD_ATTRIBUTE, ProductAttributeValueForm::class, [
            'label' => false,
            'required' => true,
            'constraints' => [
                new NotBlank(),
