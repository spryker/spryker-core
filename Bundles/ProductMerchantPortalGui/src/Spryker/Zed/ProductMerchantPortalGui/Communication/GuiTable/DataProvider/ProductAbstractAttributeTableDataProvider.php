...
class ProductAbstractAttributeTableDataProvider extends AbstractGuiTableDataProvider
{
    ...
    protected function createCriteria(GuiTableDataRequestTransfer $guiTableDataRequestTransfer): AbstractTransfer
    {
        ...
        $productAttributeTableCriteriaTransfer->setIdProductAbstract($this->idProductAbstract);
    ...
    protected function fetchData(AbstractTransfer $criteriaTransfer): GuiTableDataResponseTransfer
    {
        ...
        $idProductAbstract = $criteriaTransfer->getIdProductAbstractOrFail();
        ...
        return $this->mapDataToGuiTableDataResponse($attributes);
    }
     ...
     * @return \Generated\Shared\Transfer\GuiTableDataResponseTransfer
     */
    protected function mapDataToGuiTableDataResponse(array $data): GuiTableDataResponseTransfer
    {
