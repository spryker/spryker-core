...
namespace Spryker\Zed\ProductMerchantPortalGui\Communication\Plugin\AclMerchantPortal;
 ...
 */
class ProductMerchantPortalGuiMerchantAclRuleExpanderPlugin extends AbstractPlugin implements MerchantAclRuleExpanderPluginInterface
{
    /**
    ...
    public function expand(array $ruleTransfers): array
    {
        $ruleTransfers[] = (new RuleTransfer())
            ->setBundle('product-merchant-portal-gui')
