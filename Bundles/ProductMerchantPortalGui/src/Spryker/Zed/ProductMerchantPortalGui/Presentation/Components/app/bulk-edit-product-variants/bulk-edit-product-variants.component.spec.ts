...
describe('BulkEditProductVariantsComponent', () => {
  ...
  it('should render default projected title in the `.mp-bulk-edit-product-variants__title` element', () => {
    const projectedTitle = fixture.debugElement.query(By.css('.mp-bulk-edit-product-variants__title .projected-title'));
  ...
  it('should render default projected action in the `.mp-bulk-edit-product-variants__heading-col` element', () => {
    const projectedAction = fixture.debugElement.query(By.css('.mp-bulk-edit-product-variants__heading-col .projected-action'));
  ...
  describe('Validity section', () => {
    ...
    it('should bound `sections.validity.placeholder.from` to `placeholderFrom` of the `spy-date-range-picker` component', () => {
      ...
      expect(getRangeComponent().properties.placeholderFrom).toContain(mockValiditySection.validity.placeholder.from);
    });
