...
{
    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_OFFER_REFERENCE
     */
    protected const COL_KEY_OFFER_REFERENCE = 'offerReference';

    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_MERCHANT_SKU
     */
    protected const COL_KEY_MERCHANT_SKU = 'merchantSku';

    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_CONCRETE_SKU
     */
    protected const COL_KEY_CONCRETE_SKU = 'concreteSku';

    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_IMAGE
     */
    protected const COL_KEY_IMAGE = 'image';

    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_PRODUCT_NAME
     */
    protected const COL_KEY_PRODUCT_NAME = 'productName';

    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_STORES
     */
    protected const COL_KEY_STORES = 'stores';

    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_STOCK
     */
    protected const COL_KEY_STOCK = 'stock';

    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_VISIBILITY
     */
    protected const COL_KEY_VISIBILITY = 'visibility';

    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_VALID_FROM
     */
    protected const COL_KEY_VALID_FROM = 'validFrom';

    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_VALID_TO
     */
    protected const COL_KEY_VALID_TO = 'validTo';

    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_APPROVAL_STATUS
     */
    protected const COL_KEY_APPROVAL_STATUS = 'approvalStatus';

    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_CREATED_AT
     */
    protected const COL_KEY_CREATED_AT = 'createdAt';

    /**
     * @uses \Spryker\Zed\ProductOfferGuiPage\Communication\Table\ProductOfferTable\ProductTable::COL_KEY_UPDATED_AT
     */
