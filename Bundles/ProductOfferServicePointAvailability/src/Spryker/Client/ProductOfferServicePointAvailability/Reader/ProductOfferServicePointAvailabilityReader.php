...
{
    /**
     * @var \Spryker\Client\ProductOfferServicePointAvailability\Dependency\Client\ProductOfferServicePointAvailabilityToProductOfferAvailabilityStorageClientInterface
     */
    protected ProductOfferServicePointAvailabilityToProductOfferAvailabilityStorageClientInterface $productOfferAvailabilityStorageClient;

    /**
     * @var \Spryker\Client\ProductOfferServicePointAvailability\Reader\ProductOfferStorageReaderInterface
     */
    protected ProductOfferStorageReaderInterface $productOfferStorageReader;

    /**
     * @var \Spryker\Client\ProductOfferServicePointAvailability\Extractor\ProductOfferStorageExtractorInterface
     */
    protected ProductOfferStorageExtractorInterface $productOfferStorageExtractor;

    /**
     * @var \Spryker\Client\ProductOfferServicePointAvailability\Sanitizer\ProductOfferServicePointAvailabilitySanitizerInterface
     */
    protected ProductOfferServicePointAvailabilitySanitizerInterface $productOfferServicePointAvailabilitySanitizer;

    /**
     * @var list<\Spryker\Client\ProductOfferServicePointAvailabilityExtension\Dependency\Plugin\ProductOfferServicePointAvailabilityFilterPluginInterface>
     */
    protected array $productOfferServicePointAvailabilityFilterPlugins;

    /**
     * @param \Spryker\Client\ProductOfferServicePointAvailability\Dependency\Client\ProductOfferServicePointAvailabilityToProductOfferAvailabilityStorageClientInterface $productOfferAvailabilityStorageClient
     * @param \Spryker\Client\ProductOfferServicePointAvailability\Reader\ProductOfferStorageReaderInterface $productOfferStorageReader
     * @param \Spryker\Client\ProductOfferServicePointAvailability\Extractor\ProductOfferStorageExtractorInterface $productOfferStorageExtractor
     * @param \Spryker\Client\ProductOfferServicePointAvailability\Sanitizer\ProductOfferServicePointAvailabilitySanitizerInterface $productOfferServicePointAvailabilitySanitizer
     * @param list<\Spryker\Client\ProductOfferServicePointAvailabilityExtension\Dependency\Plugin\ProductOfferServicePointAvailabilityFilterPluginInterface> $productOfferServicePointAvailabilityFilterPlugins
     */
    public function __construct(
        ProductOfferServicePointAvailabilityToProductOfferAvailabilityStorageClientInterface $productOfferAvailabilityStorageClient,
