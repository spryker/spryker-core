...
namespace SprykerTest\Client\ProductOfferServicePointAvailabilityCalculator;
 ...
 * @method \Spryker\Client\ProductOfferServicePointAvailabilityCalculator\ProductOfferServicePointAvailabilityCalculatorClientInterface getClient()
 *
 * @SuppressWarnings(\SprykerTest\Client\ProductOfferServicePointAvailabilityCalculator\PHPMD)
 */
class ProductOfferServicePointAvailabilityCalculatorClientTester extends Actor
{
    use _generated\ProductOfferServicePointAvailabilityCalculatorClientTesterActions;
