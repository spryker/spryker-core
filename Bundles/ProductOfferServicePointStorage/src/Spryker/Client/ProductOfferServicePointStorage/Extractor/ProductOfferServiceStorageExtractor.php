...
class ProductOfferServiceStorageExtractor implements ProductOfferServiceStorageExtractorInterface
{
    /**
    ...
    public function extractServicePointUuidsFromProductOfferServiceStorageTransfers(ArrayObject $productOfferServiceStorageTransfers): array
    {
        ...
        foreach ($productOfferServiceStorageTransfers as $productOfferServiceStorageTransfer) {
            $servicePointUuids[] = $productOfferServiceStorageTransfer->getServicePointUuidOrFail();
        }
