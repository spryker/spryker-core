...
class ProductOfferServiceStorageMapper implements ProductOfferServiceStorageMapperInterface
{
    /**
    ...
    public function mapProductOfferServiceStorageDataToProductOfferServiceStorageTransfer(
        ...
        return $productOfferServiceStorageTransfer->fromArray($productOfferServiceStorageData, true);
    }
}
