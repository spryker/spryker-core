...
namespace Spryker\Client\ProductOfferShipmentTypeAvailability\Filter;
...
class ProductOfferServicePointAvailabilityFilter implements ProductOfferServicePointAvailabilityFilterInterface
{
    ...
    /**
     * @var \Spryker\Client\ProductOfferShipmentTypeAvailability\Reader\ShipmentTypeStorageReaderInterface
     */
    protected ShipmentTypeStorageReaderInterface $shipmentTypeStorageReader;

    /**
     * @param \Spryker\Client\ProductOfferShipmentTypeAvailability\Reader\ShipmentTypeStorageReaderInterface $shipmentTypeStorageReader
     */
