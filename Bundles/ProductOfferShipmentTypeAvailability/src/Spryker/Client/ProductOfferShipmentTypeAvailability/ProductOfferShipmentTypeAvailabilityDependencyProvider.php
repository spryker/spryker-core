...
class ProductOfferShipmentTypeAvailabilityDependencyProvider extends AbstractDependencyProvider
{
    /**
     * @var string
     */
    ...
    protected function addShipmentTypeStorageClient(Container $container): Container
    {
        $container->set(static::CLIENT_SHIPMENT_TYPE_STORAGE, function (Container $container) {
            return new ProductOfferShipmentTypeAvailabilityToShipmentTypeStorageClientBridge(
