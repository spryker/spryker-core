...
namespace SprykerTest\Client\ProductOfferShipmentTypeAvailability\Client;
...
use Spryker\Client\ProductOfferShipmentTypeAvailability\Dependency\Client\ProductOfferShipmentTypeAvailabilityToShipmentTypeStorageClientBridge;
use Spryker\Client\ProductOfferShipmentTypeAvailability\ProductOfferShipmentTypeAvailabilityDependencyProvider;
use SprykerTest\Client\ProductOfferShipmentTypeAvailability\ProductOfferShipmentTypeAvailabilityClientTester;
...
class FilterProductOfferServicePointAvailabilityCollectionTest extends Unit
{
    ...
    /**
     * @var \SprykerTest\Client\ProductOfferShipmentTypeAvailability\ProductOfferShipmentTypeAvailabilityClientTester
     */
    protected ProductOfferShipmentTypeAvailabilityClientTester $tester;
    ...
    {
        $shipmentTypeStorageClient = $this->createMock(ProductOfferShipmentTypeAvailabilityToShipmentTypeStorageClientBridge::class);
        $shipmentTypeStorageClient
            ->method('getShipmentTypeStorageCollection')
            ->willReturn($shipmentTypeStorageCollectionTransfer);

        $this->tester->setDependency(ProductOfferShipmentTypeAvailabilityDependencyProvider::CLIENT_SHIPMENT_TYPE_STORAGE, $shipmentTypeStorageClient);
    }
}
