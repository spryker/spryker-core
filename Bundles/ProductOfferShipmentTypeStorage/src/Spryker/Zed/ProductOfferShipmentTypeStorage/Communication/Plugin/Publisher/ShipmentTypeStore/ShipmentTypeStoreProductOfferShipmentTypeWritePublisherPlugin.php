...
namespace Spryker\Zed\ProductOfferShipmentTypeStorage\Communication\Plugin\Publisher\ShipmentTypeStore;
 ...
 */
class ShipmentTypeStoreProductOfferShipmentTypeWritePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        $this->getFacade()->writeCollectionByShipmentTypeStoreEvents($eventEntityTransfers);
    }
    ...
    {
        return [
            ProductOfferShipmentTypeStorageConfig::ENTITY_SPY_SHIPMENT_TYPE_STORE_CREATE,
            ProductOfferShipmentTypeStorageConfig::ENTITY_SPY_SHIPMENT_TYPE_STORE_DELETE,
        ];
    }
}
