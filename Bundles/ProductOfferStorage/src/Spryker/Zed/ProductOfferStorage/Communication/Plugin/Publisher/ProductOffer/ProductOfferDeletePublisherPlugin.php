 ...
 */
class ProductOfferDeletePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    {
        $this->getFacade()->deleteProductOfferStorageCollectionByProductOfferEvents($eventEntityTransfers);
    }
