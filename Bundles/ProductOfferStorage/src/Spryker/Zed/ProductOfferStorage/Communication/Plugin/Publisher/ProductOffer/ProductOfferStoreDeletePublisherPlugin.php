 ...
 */
class ProductOfferStoreDeletePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
     * - Unpublishes product offers by provided `EventEntity.foreign_keys.fk_product_offer` and `EventEntity.foreign_keys.fk_store` transfer properties.
     *
     * @api
     *
    ...
    {
        $this->getFacade()->deleteCollectionByProductOfferStoreEvents($eventEntityTransfers);
    }
