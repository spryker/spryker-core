...
use SprykerFeature\Zed\ProductOption\Persistence\Propel\Map\SpyProductOptionConfigurationPresetTableMap;
use SprykerFeature\Zed\Product\Persistence\Propel\SpyProduct;
use SprykerFeature\Zed\Product\Persistence\Propel\SpyProductQuery;

/**
 * Base class that represents a row from the 'spy_product_option_configuration_preset' table.
 *
 *
 *
...
*/
abstract class SpyProductOptionConfigurationPreset implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\Map\\SpyProductOptionConfigurationPresetTableMap';
    ...
    /**
     * The value for the id_product_option_configuration_preset field.
     * @var        int
     */
    protected $id_product_option_configuration_preset;
    ...
    /**
     * Initializes internal state of SprykerFeature\Zed\ProductOption\Persistence\Propel\Base\SpyProductOptionConfigurationPreset object.
     */
    ...
    /**
     * Compares this with another <code>SpyProductOptionConfigurationPreset</code> instance.  If
     * <code>obj</code> is an instance of <code>SpyProductOptionConfigurationPreset</code>, delegates to
     * <code>equals(SpyProductOptionConfigurationPreset)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SpyProductOptionConfigurationPreset The current object, for fluid interface
     */
    ...
    /**
     * Get the [id_product_option_configuration_preset] column value.
     *
     * @return int
     */
    public function getIdProductOptionConfigurationPreset()
    {
        return $this->id_product_option_configuration_preset;
    }
    ...
    public function setIdProductOptionConfigurationPreset($v)
    {
        ...
        if ($this->id_product_option_configuration_preset !== $v) {
            $this->id_product_option_configuration_preset = $v;
            $this->modifiedColumns[SpyProductOptionConfigurationPresetTableMap::COL_ID_PRODUCT_OPTION_CONFIGURATION_PRESET] = true;
        }

        return $this;
    } // setIdProductOptionConfigurationPreset()
    ...
    public function setIsDefault($v)
    {
        ...
        if ($this->is_default !== $v) {
            $this->is_default = $v;
            $this->modifiedColumns[SpyProductOptionConfigurationPresetTableMap::COL_IS_DEFAULT] = true;
        }
    ...
    public function setSequence($v)
    {
        ...
        if ($this->sequence !== $v) {
            $this->sequence = $v;
            $this->modifiedColumns[SpyProductOptionConfigurationPresetTableMap::COL_SEQUENCE] = true;
        }
    ...
    public function setFkProduct($v)
    {
        ...
        if ($this->fk_product !== $v) {
            $this->fk_product = $v;
            $this->modifiedColumns[SpyProductOptionConfigurationPresetTableMap::COL_FK_PRODUCT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpyProductOptionConfigurationPresetTableMap::translateFieldName('IdProductOptionConfigurationPreset', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_product_option_configuration_preset = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyProductOptionConfigurationPresetTableMap::translateFieldName('IsDefault', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_default = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyProductOptionConfigurationPresetTableMap::translateFieldName('Sequence', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sequence = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyProductOptionConfigurationPresetTableMap::translateFieldName('FkProduct', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = SpyProductOptionConfigurationPresetTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionConfigurationPreset'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSpyProductOptionConfigurationPresetQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SpyProductOptionConfigurationPreset::setDeleted()
     * @see SpyProductOptionConfigurationPreset::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpyProductOptionConfigurationPresetQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SpyProductOptionConfigurationPresetTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->spyProductOptionConfigurationPresetValuesScheduledForDeletion !== null) {
                if (!$this->spyProductOptionConfigurationPresetValuesScheduledForDeletion->isEmpty()) {
                    \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionConfigurationPresetValueQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpyProductOptionConfigurationPresetTableMap::COL_ID_PRODUCT_OPTION_CONFIGURATION_PRESET)) {
            $modifiedColumns[':p' . $index++]  = 'id_product_option_configuration_preset';
        }
        if ($this->isColumnModified(SpyProductOptionConfigurationPresetTableMap::COL_IS_DEFAULT)) {
            $modifiedColumns[':p' . $index++]  = 'is_default';
        }
        if ($this->isColumnModified(SpyProductOptionConfigurationPresetTableMap::COL_SEQUENCE)) {
            $modifiedColumns[':p' . $index++]  = 'sequence';
        }
        if ($this->isColumnModified(SpyProductOptionConfigurationPresetTableMap::COL_FK_PRODUCT)) {
            $modifiedColumns[':p' . $index++]  = 'fk_product';
        }

        $sql = sprintf(
            'INSERT INTO spy_product_option_configuration_preset (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_product_option_configuration_preset':
                        $stmt->bindValue($identifier, $this->id_product_option_configuration_preset, PDO::PARAM_INT);
                        break;
                    case 'is_default':
        ...
        if ($pk !== null) {
            $this->setIdProductOptionConfigurationPreset($pk);
        }
    ...
    {
        $pos = SpyProductOptionConfigurationPresetTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdProductOptionConfigurationPreset();
                break;
            case 1:
                return $this->getIsDefault();
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SpyProductOptionConfigurationPreset'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SpyProductOptionConfigurationPreset'][$this->hashCode()] = true;
        $keys = SpyProductOptionConfigurationPresetTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdProductOptionConfigurationPreset(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionConfigurationPreset
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdProductOptionConfigurationPreset($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdProductOptionConfigurationPreset($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionConfigurationPreset The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpyProductOptionConfigurationPresetTableMap::COL_ID_PRODUCT_OPTION_CONFIGURATION_PRESET)) {
            $criteria->add(SpyProductOptionConfigurationPresetTableMap::COL_ID_PRODUCT_OPTION_CONFIGURATION_PRESET, $this->id_product_option_configuration_preset);
        }
        if ($this->isColumnModified(SpyProductOptionConfigurationPresetTableMap::COL_IS_DEFAULT)) {
            $criteria->add(SpyProductOptionConfigurationPresetTableMap::COL_IS_DEFAULT, $this->is_default);
        }
        if ($this->isColumnModified(SpyProductOptionConfigurationPresetTableMap::COL_SEQUENCE)) {
            $criteria->add(SpyProductOptionConfigurationPresetTableMap::COL_SEQUENCE, $this->sequence);
        }
        if ($this->isColumnModified(SpyProductOptionConfigurationPresetTableMap::COL_FK_PRODUCT)) {
            $criteria->add(SpyProductOptionConfigurationPresetTableMap::COL_FK_PRODUCT, $this->fk_product);
        }
    ...
    {
        $criteria = ChildSpyProductOptionConfigurationPresetQuery::create();
        $criteria->add(SpyProductOptionConfigurationPresetTableMap::COL_ID_PRODUCT_OPTION_CONFIGURATION_PRESET, $this->id_product_option_configuration_preset);
    ...
    {
        $validPk = null !== $this->getIdProductOptionConfigurationPreset();
    ...
    /**
     * Generic method to set the primary key (id_product_option_configuration_preset column).
     *
    ...
    {
        $this->setIdProductOptionConfigurationPreset($key);
    }
    ...
    {
        return null === $this->getIdProductOptionConfigurationPreset();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionConfigurationPreset (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdProductOptionConfigurationPreset(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionConfigurationPreset Clone of current object.
     * @throws PropelException
     */
    ...
    public function setSpyProduct(SpyProduct $v = null)
    {
        ...
        if ($v !== null) {
            $v->addSpyProductOptionConfigurationPreset($this);
        }
    ...
    public function getSpyProduct(ConnectionInterface $con = null)
    {
        if ($this->aSpyProduct === null && ($this->fk_product !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSpyProduct->addSpyProductOptionConfigurationPresets($this);
             */
        }
    ...
    public function initSpyProductOptionConfigurationPresetValues($overrideExisting = true)
    {
        ...
        $this->collSpyProductOptionConfigurationPresetValues->setModel('\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionConfigurationPresetValue');
    }
     ...
     * If this ChildSpyProductOptionConfigurationPreset is new, it will return
        ...
        if (null === $this->collSpyProductOptionConfigurationPresetValues || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collSpyProductOptionConfigurationPresetValues) {
                ...
                $collSpyProductOptionConfigurationPresetValues = ChildSpyProductOptionConfigurationPresetValueQuery::create(null, $criteria)
                    ->filterBySpyProductOptionConfigurationPreset($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSpyProductOptionConfigurationPreset The current object (for fluent API support)
     */
    public function setSpyProductOptionConfigurationPresetValues(Collection $spyProductOptionConfigurationPresetValues, ConnectionInterface $con = null)
    {
        ...
        foreach ($spyProductOptionConfigurationPresetValuesToDelete as $spyProductOptionConfigurationPresetValueRemoved) {
            $spyProductOptionConfigurationPresetValueRemoved->setSpyProductOptionConfigurationPreset(null);
        }
    ...
    protected function doAddSpyProductOptionConfigurationPresetValue(ChildSpyProductOptionConfigurationPresetValue $spyProductOptionConfigurationPresetValue)
    {
        ...
        $spyProductOptionConfigurationPresetValue->setSpyProductOptionConfigurationPreset($this);
    }
    ...
    public function removeSpyProductOptionConfigurationPresetValue(ChildSpyProductOptionConfigurationPresetValue $spyProductOptionConfigurationPresetValue)
    {
        if ($this->getSpyProductOptionConfigurationPresetValues()->contains($spyProductOptionConfigurationPresetValue)) {
            ...
            $spyProductOptionConfigurationPresetValue->setSpyProductOptionConfigurationPreset(null);
        }
     ...
     * Otherwise if this SpyProductOptionConfigurationPreset is new, it will return
     * an empty collection; or if this SpyProductOptionConfigurationPreset has previously
     * been saved, it will retrieve related SpyProductOptionConfigurationPresetValues from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SpyProductOptionConfigurationPreset.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildSpyProductOptionConfigurationPresetValue[] List of ChildSpyProductOptionConfigurationPresetValue objects
     */
    public function getSpyProductOptionConfigurationPresetValuesJoinSpyProductOptionValueUsage(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSpyProductOptionConfigurationPresetValueQuery::create(null, $criteria);
        $query->joinWith('SpyProductOptionValueUsage', $joinBehavior);
    ...
    {
        if (null !== $this->aSpyProduct) {
            $this->aSpyProduct->removeSpyProductOptionConfigurationPreset($this);
        }
        $this->id_product_option_configuration_preset = null;
    ...
    {
        return (string) $this->exportTo(SpyProductOptionConfigurationPresetTableMap::DEFAULT_STRING_FORMAT);
    }
