 ...
 *
 * @method     \SprykerFeature\Zed\Product\Persistence\Propel\SpyProductQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionConfigurationPresetValueQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SpyProductOptionConfigurationPresetQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'zed', $modelName = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionConfigurationPreset', $modelAlias = null)
    {
