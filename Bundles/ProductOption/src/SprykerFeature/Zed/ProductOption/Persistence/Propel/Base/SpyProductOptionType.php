...
*/
abstract class SpyProductOptionType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\Map\\SpyProductOptionTypeTableMap';
    ...
    /**
     * Initializes internal state of SprykerFeature\Zed\ProductOption\Persistence\Propel\Base\SpyProductOptionType object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionType'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->spyProductOptionValuesScheduledForDeletion !== null) {
                if (!$this->spyProductOptionValuesScheduledForDeletion->isEmpty()) {
                    \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueQuery::create()
            ...
            if ($this->spyProductOptionTypeTranslationsScheduledForDeletion !== null) {
                if (!$this->spyProductOptionTypeTranslationsScheduledForDeletion->isEmpty()) {
                    \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeTranslationQuery::create()
            ...
            if ($this->spyProductOptionTypeUsagesScheduledForDeletion !== null) {
                if (!$this->spyProductOptionTypeUsagesScheduledForDeletion->isEmpty()) {
                    \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionType
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionType The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionType Clone of current object.
     * @throws PropelException
     */
    ...
    public function initSpyProductOptionTypeTranslations($overrideExisting = true)
    {
        ...
        $this->collSpyProductOptionTypeTranslations->setModel('\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeTranslation');
    }
    ...
    public function initSpyProductOptionTypeUsages($overrideExisting = true)
    {
        ...
        $this->collSpyProductOptionTypeUsages->setModel('\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage');
    }
