 ...
 *
 * @method     \SprykerFeature\Zed\Tax\Persistence\Propel\SpyTaxSetQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeTranslationQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SpyProductOptionTypeQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'zed', $modelName = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionType', $modelAlias = null)
    {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = $locator->productOption()->entitySpyProductOptionType();
    ...
    /**
     * Filter the query by a related \SprykerFeature\Zed\Tax\Persistence\Propel\SpyTaxSet object
     *
     * @param \SprykerFeature\Zed\Tax\Persistence\Propel\SpyTaxSet|ObjectCollection $spyTaxSet The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($spyTaxSet instanceof \SprykerFeature\Zed\Tax\Persistence\Propel\SpyTaxSet) {
            return $this
            ...
            throw new PropelException('filterBySpyTaxSet() only accepts arguments of type \SprykerFeature\Zed\Tax\Persistence\Propel\SpyTaxSet or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\Tax\Persistence\Propel\SpyTaxSetQuery A secondary query class using the current class as primary query
     */
    public function useSpyTaxSetQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinSpyTaxSet($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SpyTaxSet', '\SprykerFeature\Zed\Tax\Persistence\Propel\SpyTaxSetQuery');
    }
    ...
    {
        if ($spyProductOptionTypeTranslation instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeTranslation) {
            return $this
            ...
            throw new PropelException('filterBySpyProductOptionTypeTranslation() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeTranslation or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeTranslationQuery A secondary query class using the current class as primary query
     */
    public function useSpyProductOptionTypeTranslationQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SpyProductOptionTypeTranslation', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeTranslationQuery');
    }
