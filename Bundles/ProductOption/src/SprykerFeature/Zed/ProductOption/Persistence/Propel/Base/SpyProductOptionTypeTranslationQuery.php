...
use SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeTranslation as ChildSpyProductOptionTypeTranslation;
 ...
 *
 * @method     \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeQuery|\SprykerEngine\Zed\Locale\Persistence\Propel\SpyLocaleQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SpyProductOptionTypeTranslationQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \SprykerFeature\Zed\ProductOption\Persistence\Propel\Base\SpyProductOptionTypeTranslationQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionTypeTranslation', $modelAlias = null)
    {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = $locator->productOption()->entitySpyProductOptionTypeTranslation();
    ...
    /**
     * Filter the query by a related \SprykerEngine\Zed\Locale\Persistence\Propel\SpyLocale object
     *
     * @param \SprykerEngine\Zed\Locale\Persistence\Propel\SpyLocale|ObjectCollection $spyLocale The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($spyLocale instanceof \SprykerEngine\Zed\Locale\Persistence\Propel\SpyLocale) {
            return $this
            ...
            throw new PropelException('filterBySpyLocale() only accepts arguments of type \SprykerEngine\Zed\Locale\Persistence\Propel\SpyLocale or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerEngine\Zed\Locale\Persistence\Propel\SpyLocaleQuery A secondary query class using the current class as primary query
     */
    public function useSpyLocaleQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSpyLocale($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SpyLocale', '\SprykerEngine\Zed\Locale\Persistence\Propel\SpyLocaleQuery');
    }
