...
use SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion as ChildSpyProductOptionTypeUsageExclusion;
...
*/
abstract class SpyProductOptionTypeUsage implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\Map\\SpyProductOptionTypeUsageTableMap';
    ...
    /**
     * Initializes internal state of SprykerFeature\Zed\ProductOption\Persistence\Propel\Base\SpyProductOptionTypeUsage object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionTypeUsage'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->spyProductOptionValueUsagesScheduledForDeletion !== null) {
                if (!$this->spyProductOptionValueUsagesScheduledForDeletion->isEmpty()) {
                    \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageQuery::create()
            ...
            if ($this->spyProductOptionTypeUsageExclusionsRelatedByFkProductOptionTypeUsageAScheduledForDeletion !== null) {
                if (!$this->spyProductOptionTypeUsageExclusionsRelatedByFkProductOptionTypeUsageAScheduledForDeletion->isEmpty()) {
                    \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusionQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage Clone of current object.
     * @throws PropelException
     */
    ...
    public function initSpyProductOptionValueUsages($overrideExisting = true)
    {
        ...
        $this->collSpyProductOptionValueUsages->setModel('\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsage');
    }
    ...
    public function initSpyProductOptionTypeUsageExclusionsRelatedByFkProductOptionTypeUsageA($overrideExisting = true)
    {
        ...
        $this->collSpyProductOptionTypeUsageExclusionsRelatedByFkProductOptionTypeUsageA->setModel('\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion');
    }
    ...
    public function initSpyProductOptionTypeUsageExclusionsRelatedByFkProductOptionTypeUsageB($overrideExisting = true)
    {
        ...
        $this->collSpyProductOptionTypeUsageExclusionsRelatedByFkProductOptionTypeUsageB->setModel('\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion');
    }
