 ...
 *
 * @method     \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SpyProductOptionTypeUsageExclusionQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'zed', $modelName = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionTypeUsageExclusion', $modelAlias = null)
    {
    ...
    public function filterByproductOptionTypeUsageA($spyProductOptionTypeUsage, $comparison = null)
    {
        if ($spyProductOptionTypeUsage instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage) {
            ...
            throw new PropelException('filterByproductOptionTypeUsageA() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage or Collection');
        }
    }
    ...
    public function useproductOptionTypeUsageAQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'productOptionTypeUsageA', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageQuery');
    }
    ...
    public function filterByproductOptionTypeUsageB($spyProductOptionTypeUsage, $comparison = null)
    {
        if ($spyProductOptionTypeUsage instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage) {
            ...
            throw new PropelException('filterByproductOptionTypeUsageB() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage or Collection');
        }
    }
    ...
    public function useproductOptionTypeUsageBQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'productOptionTypeUsageB', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageQuery');
    }
