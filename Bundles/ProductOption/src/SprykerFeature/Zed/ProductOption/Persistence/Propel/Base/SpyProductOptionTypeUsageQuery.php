 ...
 *
 * @method     \SprykerFeature\Zed\Product\Persistence\Propel\SpyProductQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SpyProductOptionTypeUsageQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \SprykerFeature\Zed\ProductOption\Persistence\Propel\Base\SpyProductOptionTypeUsageQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionTypeUsage', $modelAlias = null)
    {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = $locator->productOption()->entitySpyProductOptionTypeUsage();
    ...
    /**
     * Filter the query by a related \SprykerFeature\Zed\Product\Persistence\Propel\SpyProduct object
     *
     * @param \SprykerFeature\Zed\Product\Persistence\Propel\SpyProduct|ObjectCollection $spyProduct The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($spyProduct instanceof \SprykerFeature\Zed\Product\Persistence\Propel\SpyProduct) {
            return $this
            ...
            throw new PropelException('filterBySpyProduct() only accepts arguments of type \SprykerFeature\Zed\Product\Persistence\Propel\SpyProduct or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\Product\Persistence\Propel\SpyProductQuery A secondary query class using the current class as primary query
     */
    public function useSpyProductQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSpyProduct($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SpyProduct', '\SprykerFeature\Zed\Product\Persistence\Propel\SpyProductQuery');
    }

    /**
     * Filter the query by a related \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionType object
     *
     * @param \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionType|ObjectCollection $spyProductOptionType The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($spyProductOptionType instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionType) {
            return $this
            ...
            throw new PropelException('filterBySpyProductOptionType() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionType or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeQuery A secondary query class using the current class as primary query
     */
    public function useSpyProductOptionTypeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SpyProductOptionType', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeQuery');
    }

    /**
     * Filter the query by a related \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsage object
     *
     * @param \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsage|ObjectCollection $spyProductOptionValueUsage  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyProductOptionTypeUsageQuery The current query, for fluid interface
     */
    ...
    /**
     * Filter the query by a related \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion object
     *
     * @param \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion|ObjectCollection $spyProductOptionTypeUsageExclusion  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyProductOptionTypeUsageQuery The current query, for fluid interface
     */
    ...
    {
        if ($spyProductOptionTypeUsageExclusion instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion) {
            return $this
            ...
            throw new PropelException('filterBySpyProductOptionTypeUsageExclusionRelatedByFkProductOptionTypeUsageA() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusionQuery A secondary query class using the current class as primary query
     */
    public function useSpyProductOptionTypeUsageExclusionRelatedByFkProductOptionTypeUsageAQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SpyProductOptionTypeUsageExclusionRelatedByFkProductOptionTypeUsageA', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusionQuery');
    }
    ...
    public function filterBySpyProductOptionTypeUsageExclusionRelatedByFkProductOptionTypeUsageB($spyProductOptionTypeUsageExclusion, $comparison = null)
    {
        if ($spyProductOptionTypeUsageExclusion instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion) {
            ...
            throw new PropelException('filterBySpyProductOptionTypeUsageExclusionRelatedByFkProductOptionTypeUsageB() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion or Collection');
        }
    }
    ...
    public function useSpyProductOptionTypeUsageExclusionRelatedByFkProductOptionTypeUsageBQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SpyProductOptionTypeUsageExclusionRelatedByFkProductOptionTypeUsageB', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusionQuery');
    }
