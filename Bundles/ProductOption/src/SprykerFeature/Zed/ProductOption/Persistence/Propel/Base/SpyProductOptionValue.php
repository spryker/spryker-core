...
abstract class SpyProductOptionValue implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\Map\\SpyProductOptionValueTableMap';
    ...
    /**
     * Initializes internal state of SprykerFeature\Zed\ProductOption\Persistence\Propel\Base\SpyProductOptionValue object.
     */
     ...
     * @return $this|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValue The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionValue'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->spyProductOptionValueTranslationsScheduledForDeletion !== null) {
                if (!$this->spyProductOptionValueTranslationsScheduledForDeletion->isEmpty()) {
                    \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueTranslationQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValue
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValue The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValue (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValue Clone of current object.
     * @throws PropelException
     */
    ...
    public function initSpyProductOptionValueTranslations($overrideExisting = true)
    {
        ...
        $this->collSpyProductOptionValueTranslations->setModel('\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueTranslation');
    }
