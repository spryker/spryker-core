 ...
 *
 * @method     \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValuePriceQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueTranslationQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SpyProductOptionValueQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \SprykerFeature\Zed\ProductOption\Persistence\Propel\Base\SpyProductOptionValueQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionValue', $modelAlias = null)
    {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = $locator->productOption()->entitySpyProductOptionValue();
    ...
    /**
     * Filter the query by a related \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValuePrice object
     *
     * @param \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValuePrice|ObjectCollection $spyProductOptionValuePrice The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($spyProductOptionValuePrice instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValuePrice) {
            return $this
            ...
            throw new PropelException('filterBySpyProductOptionValuePrice() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValuePrice or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValuePriceQuery A secondary query class using the current class as primary query
     */
    public function useSpyProductOptionValuePriceQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SpyProductOptionValuePrice', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValuePriceQuery');
    }

    /**
     * Filter the query by a related \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueTranslation object
     *
     * @param \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueTranslation|ObjectCollection $spyProductOptionValueTranslation  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildSpyProductOptionValueQuery The current query, for fluid interface
     */
    ...
    {
        if ($spyProductOptionValueTranslation instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueTranslation) {
            return $this
            ...
            throw new PropelException('filterBySpyProductOptionValueTranslation() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueTranslation or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueTranslationQuery A secondary query class using the current class as primary query
     */
    public function useSpyProductOptionValueTranslationQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SpyProductOptionValueTranslation', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueTranslationQuery');
    }
