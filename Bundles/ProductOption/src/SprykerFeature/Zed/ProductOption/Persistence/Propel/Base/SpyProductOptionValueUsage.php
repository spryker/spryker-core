...
use SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageConstraint as ChildSpyProductOptionValueUsageConstraint;
...
*/
abstract class SpyProductOptionValueUsage implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\Map\\SpyProductOptionValueUsageTableMap';
    ...
    /**
     * Initializes internal state of SprykerFeature\Zed\ProductOption\Persistence\Propel\Base\SpyProductOptionValueUsage object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionValueUsage'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->spyProductOptionValueUsageConstraintsRelatedByFkProductOptionValueUsageAScheduledForDeletion !== null) {
                if (!$this->spyProductOptionValueUsageConstraintsRelatedByFkProductOptionValueUsageAScheduledForDeletion->isEmpty()) {
                    \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageConstraintQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsage
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsage The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsage (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsage Clone of current object.
     * @throws PropelException
     */
    ...
    public function initSpyProductOptionValueUsageConstraintsRelatedByFkProductOptionValueUsageA($overrideExisting = true)
    {
        ...
        $this->collSpyProductOptionValueUsageConstraintsRelatedByFkProductOptionValueUsageA->setModel('\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageConstraint');
    }
    ...
    public function initSpyProductOptionValueUsageConstraintsRelatedByFkProductOptionValueUsageB($overrideExisting = true)
    {
        ...
        $this->collSpyProductOptionValueUsageConstraintsRelatedByFkProductOptionValueUsageB->setModel('\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageConstraint');
    }
