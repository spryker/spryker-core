 ...
 *
 * @method     \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SpyProductOptionValueUsageConstraintQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'zed', $modelName = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionValueUsageConstraint', $modelAlias = null)
    {
    ...
    public function filterByproductOptionValueUsageA($spyProductOptionValueUsage, $comparison = null)
    {
        if ($spyProductOptionValueUsage instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsage) {
            ...
            throw new PropelException('filterByproductOptionValueUsageA() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsage or Collection');
        }
    }
    ...
    public function useproductOptionValueUsageAQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'productOptionValueUsageA', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageQuery');
    }
    ...
    public function filterByproductOptionValueUsageB($spyProductOptionValueUsage, $comparison = null)
    {
        if ($spyProductOptionValueUsage instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsage) {
            ...
            throw new PropelException('filterByproductOptionValueUsageB() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsage or Collection');
        }
    }
    ...
    public function useproductOptionValueUsageBQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'productOptionValueUsageB', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageQuery');
    }
