 ...
 *
 * @method     \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageConstraintQuery|\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionConfigurationPresetValueQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SpyProductOptionValueUsageQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'zed', $modelName = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionValueUsage', $modelAlias = null)
    {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = $locator->productOption()->entitySpyProductOptionValueUsage();
     ...
     *
     * @param \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage|ObjectCollection $spyProductOptionTypeUsage The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($spyProductOptionTypeUsage instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage) {
            return $this
            ...
            throw new PropelException('filterBySpyProductOptionTypeUsage() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageQuery A secondary query class using the current class as primary query
     */
    public function useSpyProductOptionTypeUsageQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SpyProductOptionTypeUsage', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageQuery');
    }

    /**
     * Filter the query by a related \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValue object
     *
     * @param \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValue|ObjectCollection $spyProductOptionValue The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($spyProductOptionValue instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValue) {
            return $this
            ...
            throw new PropelException('filterBySpyProductOptionValue() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValue or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueQuery A secondary query class using the current class as primary query
     */
    public function useSpyProductOptionValueQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SpyProductOptionValue', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueQuery');
    }
    ...
    {
        if ($spyProductOptionValueUsageConstraint instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageConstraint) {
            return $this
            ...
            throw new PropelException('filterBySpyProductOptionValueUsageConstraintRelatedByFkProductOptionValueUsageA() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageConstraint or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageConstraintQuery A secondary query class using the current class as primary query
     */
    public function useSpyProductOptionValueUsageConstraintRelatedByFkProductOptionValueUsageAQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SpyProductOptionValueUsageConstraintRelatedByFkProductOptionValueUsageA', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageConstraintQuery');
    }
    ...
    public function filterBySpyProductOptionValueUsageConstraintRelatedByFkProductOptionValueUsageB($spyProductOptionValueUsageConstraint, $comparison = null)
    {
        if ($spyProductOptionValueUsageConstraint instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageConstraint) {
            ...
            throw new PropelException('filterBySpyProductOptionValueUsageConstraintRelatedByFkProductOptionValueUsageB() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageConstraint or Collection');
        }
    }
    ...
    public function useSpyProductOptionValueUsageConstraintRelatedByFkProductOptionValueUsageBQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SpyProductOptionValueUsageConstraintRelatedByFkProductOptionValueUsageB', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionValueUsageConstraintQuery');
    }
    ...
    {
        if ($spyProductOptionConfigurationPresetValue instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionConfigurationPresetValue) {
            return $this
            ...
            throw new PropelException('filterBySpyProductOptionConfigurationPresetValue() only accepts arguments of type \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionConfigurationPresetValue or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionConfigurationPresetValueQuery A secondary query class using the current class as primary query
     */
    public function useSpyProductOptionConfigurationPresetValueQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SpyProductOptionConfigurationPresetValue', '\SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionConfigurationPresetValueQuery');
    }
