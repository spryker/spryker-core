...
class SpyProductOptionTypeUsageExclusionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'vendor.spryker.spryker.Bundles.ProductOption.src.SprykerFeature.Zed.ProductOption.Persistence.Propel.Map.SpyProductOptionTypeUsageExclusionTableMap';
     ...
     */
    const OM_CLASS = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionTypeUsageExclusion';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'vendor.spryker.spryker.Bundles.ProductOption.src.SprykerFeature.Zed.ProductOption.Persistence.Propel.SpyProductOptionTypeUsageExclusion';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionTypeUsageExclusion');
    ...
    {
        $this->addRelation('productOptionTypeUsageA', '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionTypeUsage', RelationMap::MANY_TO_ONE, array('fk_product_option_type_usage_a' => 'id_product_option_type_usage', ), 'CASCADE', null);
        $this->addRelation('productOptionTypeUsageB', '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionTypeUsage', RelationMap::MANY_TO_ONE, array('fk_product_option_type_usage_b' => 'id_product_option_type_usage', ), 'CASCADE', null);
    } // buildRelations()
     ...
     * and findPk*() calls.
     *
     * @param \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion $obj A \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion object.
     ...
     *
     * @param mixed $value A \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if (null !== ($obj = SpyProductOptionTypeUsageExclusionTableMap::getInstanceFromPool($key))) {
            ...
            /** @var SpyProductOptionTypeUsageExclusion $obj */
                ...
                $obj = $locator->productOption()->entitySpyProductOptionTypeUsageExclusion();
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsageExclusion) { // it's a model object
