...
class SpyProductOptionTypeUsageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'vendor.spryker.spryker.Bundles.ProductOption.src.SprykerFeature.Zed.ProductOption.Persistence.Propel.Map.SpyProductOptionTypeUsageTableMap';
     ...
     */
    const OM_CLASS = '\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionTypeUsage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'vendor.spryker.spryker.Bundles.ProductOption.src.SprykerFeature.Zed.ProductOption.Persistence.Propel.SpyProductOptionTypeUsage';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\SprykerFeature\\Zed\\ProductOption\\Persistence\\Propel\\SpyProductOptionTypeUsage');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SprykerFeature\Zed\ProductOption\Persistence\Propel\SpyProductOptionTypeUsage) { // it's a model object
