...
class ProductOptionStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::PRODUCT_ABSTRACT_PRODUCT_OPTION_PUBLISH, new ProductOptionPublishStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::PRODUCT_ABSTRACT_PRODUCT_OPTION_UNPUBLISH, new ProductOptionPublishStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::ENTITY_SPY_PRODUCT_ABSTRACT_PRODUCT_OPTION_GROUP_CREATE, new ProductOptionStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::ENTITY_SPY_PRODUCT_ABSTRACT_PRODUCT_OPTION_GROUP_UPDATE, new ProductOptionStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::ENTITY_SPY_PRODUCT_ABSTRACT_PRODUCT_OPTION_GROUP_DELETE, new ProductOptionStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::ENTITY_SPY_PRODUCT_OPTION_GROUP_UPDATE, new ProductOptionGroupStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::ENTITY_SPY_PRODUCT_OPTION_GROUP_DELETE, new ProductOptionGroupStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::ENTITY_SPY_PRODUCT_OPTION_VALUE_CREATE, new ProductOptionValueStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::ENTITY_SPY_PRODUCT_OPTION_VALUE_UPDATE, new ProductOptionValueStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::ENTITY_SPY_PRODUCT_OPTION_VALUE_DELETE, new ProductOptionValueStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::ENTITY_SPY_PRODUCT_OPTION_VALUE_PRICE_CREATE, new ProductOptionValuePriceStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::ENTITY_SPY_PRODUCT_OPTION_VALUE_PRICE_UPDATE, new ProductOptionValuePriceStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductOptionEvents::ENTITY_SPY_PRODUCT_OPTION_VALUE_PRICE_DELETE, new ProductOptionValuePriceStorageListener(), 0, null, $this->getConfig()->getProductOptionEventQueueName());
    }
}
