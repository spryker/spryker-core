...
namespace Spryker\Zed\ProductOptionStorage\Dependency\Service;

class ProductOptionStorageToUtilSanitizeServiceBridge implements ProductOptionStorageToUtilSanitizeServiceInterface
{
    /**
