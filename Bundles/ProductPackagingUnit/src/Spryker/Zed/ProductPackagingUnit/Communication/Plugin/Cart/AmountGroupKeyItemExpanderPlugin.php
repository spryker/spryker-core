 ...
 */
class AmountGroupKeyItemExpanderPlugin extends AbstractPlugin implements ItemExpanderPluginInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    {
        return $this->getFacade()->expandCartChangeGroupKeyWithAmount($cartChangeTransfer);
    }
}
