 ...
 */
class AmountSalesUnitItemExpanderPlugin extends AbstractPlugin implements ItemExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    {
        return $this->getFacade()->expandCartChangeWithAmountSalesUnit($cartChangeTransfer);
    }
}
