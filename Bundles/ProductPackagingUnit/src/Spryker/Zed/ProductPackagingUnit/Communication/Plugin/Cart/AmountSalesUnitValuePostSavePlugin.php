 ...
 */
class AmountSalesUnitValuePostSavePlugin extends AbstractPlugin implements PostSavePluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    {
        return $this->getFacade()->calculateAmountSalesUnitValueInQuote($quoteTransfer);
    }
}
