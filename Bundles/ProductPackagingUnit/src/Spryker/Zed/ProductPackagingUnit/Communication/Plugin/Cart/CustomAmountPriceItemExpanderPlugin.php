 ...
 */
class CustomAmountPriceItemExpanderPlugin extends AbstractPlugin implements ItemExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    {
        return $this->getFacade()->setCustomAmountPrice($cartChangeTransfer);
    }
}
