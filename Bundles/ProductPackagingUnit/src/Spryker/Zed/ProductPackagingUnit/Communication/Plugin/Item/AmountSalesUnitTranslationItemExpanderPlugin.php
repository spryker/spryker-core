...
namespace Spryker\Zed\ProductPackagingUnit\Communication\Plugin\Item;
 ...
 */
class AmountSalesUnitTranslationItemExpanderPlugin extends AbstractPlugin implements ItemExpanderPluginInterface
{
    /**
