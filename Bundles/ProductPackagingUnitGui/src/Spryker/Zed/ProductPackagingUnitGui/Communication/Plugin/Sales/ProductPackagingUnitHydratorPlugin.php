...
namespace Spryker\Zed\ProductPackagingUnitGui\Communication\Plugin\Sales;
 ...
 */
class ProductPackagingUnitHydratorPlugin extends AbstractPlugin implements HydrateOrderPluginInterface
{
    /**
     * @api
     *
