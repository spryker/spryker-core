...
class ProductPackagingUnitGuiDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    {
        $container->set(static::PROPEL_QUERY_PRODUCT_PACKAGING_UNIT_TYPE, function (Container $container) {
    ...
    {
        $container->set(static::PROPEL_QUERY_SLAES_ORDER_ITEM, function (Container $container) {
