...
use Spryker\Client\ProductPackagingUnitStorage\Dependency\Client\PriceProductStorageToPriceProductInterface;
use Spryker\Client\ProductPackagingUnitStorage\Storage\PriceAbstractStorageReaderInterface;
use Spryker\Client\ProductPackagingUnitStorage\Storage\PriceConcreteStorageReaderInterface;

class ProductViewPriceExpander implements ProductViewPriceExpanderInterface
{
    /**
     * @var \Spryker\Client\ProductPackagingUnitStorage\Storage\PriceAbstractStorageReaderInterface
     */
    protected $priceAbstractStorageReader;

    /**
     * @var \Spryker\Client\ProductPackagingUnitStorage\Storage\PriceConcreteStorageReaderInterface
     */
    protected $priceConcreteStorageReader;

    /**
     * @var \Spryker\Client\ProductPackagingUnitStorage\Dependency\Client\PriceProductStorageToPriceProductInterface
     */
    protected $priceProductClient;

    /**
     * @param \Spryker\Client\ProductPackagingUnitStorage\Storage\PriceAbstractStorageReaderInterface $priceAbstractStorageReader
     * @param \Spryker\Client\ProductPackagingUnitStorage\Storage\PriceConcreteStorageReaderInterface $priceConcreteStorageReader
     * @param \Spryker\Client\ProductPackagingUnitStorage\Dependency\Client\PriceProductStorageToPriceProductInterface $priceProductClient
     */
