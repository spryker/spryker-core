...
namespace Spryker\Client\ProductPageSearch\Dependency\Client;

use Spryker\Client\Search\Dependency\Plugin\QueryInterface;

class ProductPageSearchToSearchClientBridge implements ProductPageSearchToSearchClientInterface
{
    /**
