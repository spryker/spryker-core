...
class ProductConcretePageSearchProductAbstractEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_CREATE, new ProductConcretePageSearchProductAbstractListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_UPDATE, new ProductConcretePageSearchProductAbstractListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_DELETE, new ProductConcretePageSearchProductAbstractListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
}
