...
class ProductPageSearchEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(ProductCategoryEvents::ENTITY_SPY_PRODUCT_CATEGORY_CREATE, new ProductPageProductCategorySearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductCategoryEvents::ENTITY_SPY_PRODUCT_CATEGORY_UPDATE, new ProductPageProductCategorySearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductCategoryEvents::ENTITY_SPY_PRODUCT_CATEGORY_DELETE, new ProductPageProductCategorySearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_CREATE, new ProductPageCategorySearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_UPDATE, new ProductPageCategorySearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_DELETE, new ProductPageCategorySearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_NODE_CREATE, new ProductPageCategoryNodeSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_NODE_UPDATE, new ProductPageCategoryNodeSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(CategoryEvents::ENTITY_SPY_CATEGORY_NODE_DELETE, new ProductPageCategoryNodeSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_CREATE, new ProductPageImageSetSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_UPDATE, new ProductPageImageSetSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_DELETE, new ProductPageImageSetSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_TO_PRODUCT_IMAGE_UPDATE, new ProductPageImageSetProductImageSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_TO_PRODUCT_IMAGE_DELETE, new ProductPageImageSetProductImageSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_UPDATE, new ProductPageProductImageSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_DELETE, new ProductPageProductImageSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(PriceProductEvents::ENTITY_SPY_PRICE_PRODUCT_CREATE, new ProductPagePriceSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(PriceProductEvents::ENTITY_SPY_PRICE_PRODUCT_UPDATE, new ProductPagePriceSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(PriceProductEvents::ENTITY_SPY_PRICE_PRODUCT_DELETE, new ProductPagePriceSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(PriceProductEvents::ENTITY_SPY_PRICE_TYPE_UPDATE, new ProductPagePriceTypeSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(PriceProductEvents::ENTITY_SPY_PRICE_TYPE_DELETE, new ProductPagePriceTypeSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(PriceProductEvents::ENTITY_SPY_PRICE_PRODUCT_DEFAULT_CREATE, new PriceProductDefaultProductPagePublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(PriceProductEvents::ENTITY_SPY_PRICE_PRODUCT_DEFAULT_UPDATE, new PriceProductDefaultProductPagePublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(PriceProductEvents::ENTITY_SPY_PRICE_PRODUCT_DEFAULT_DELETE, new PriceProductDefaultProductPagePublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::PRODUCT_ABSTRACT_PUBLISH, new ProductPageProductAbstractPublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::PRODUCT_ABSTRACT_UNPUBLISH, new ProductPageProductAbstractUnpublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_CREATE, new ProductPageProductAbstractPublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_UPDATE, new ProductPageProductAbstractPublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_DELETE, new ProductPageProductAbstractUnpublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_LOCALIZED_ATTRIBUTES_CREATE, new ProductPageLocalizedAttributesSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_LOCALIZED_ATTRIBUTES_UPDATE, new ProductPageLocalizedAttributesSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_LOCALIZED_ATTRIBUTES_DELETE, new ProductPageLocalizedAttributesSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_CREATE, new ProductPageProductConcreteSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_UPDATE, new ProductPageProductConcreteSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_DELETE, new ProductPageProductConcreteSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_LOCALIZED_ATTRIBUTES_CREATE, new ProductPageProductConcreteLocalizedAttributesSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_LOCALIZED_ATTRIBUTES_UPDATE, new ProductPageProductConcreteLocalizedAttributesSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_LOCALIZED_ATTRIBUTES_DELETE, new ProductPageProductConcreteLocalizedAttributesSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSearchEvents::SYNCHRONIZATION_FILTER_PUBLISH, new ProductPageProductAbstractListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_UPDATE, new ProductPageUrlSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_DELETE, new ProductPageUrlSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_STORE_CREATE, new ProductPageProductAbstractStoreSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_STORE_UPDATE, new ProductPageProductAbstractStoreSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_STORE_DELETE, new ProductPageProductAbstractStoreSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection
            ->addListenerQueued(ProductSearchEvents::ENTITY_SPY_PRODUCT_SEARCH_CREATE, new ProductSearchListener(), 0, null, $this->getConfig()->getEventQueueName())
            ->addListenerQueued(ProductSearchEvents::ENTITY_SPY_PRODUCT_SEARCH_UPDATE, new ProductSearchListener(), 0, null, $this->getConfig()->getEventQueueName())
            ->addListenerQueued(ProductSearchEvents::ENTITY_SPY_PRODUCT_SEARCH_DELETE, new ProductSearchListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
}
