...
{
    /**
     * @deprecated Use `\Spryker\Zed\ProductPageSearch\Dependency\Facade\ProductPageSearchToProductSearchInterface::mapDynamicProductAttributesToSearchData()` instead.
     *
