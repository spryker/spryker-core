...
class ConcreteProductPricesRoutePlugin extends AbstractPlugin implements ResourceRoutePluginInterface, ResourceWithParentPluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    {
        return 'concrete-product-prices-resource';
    }
