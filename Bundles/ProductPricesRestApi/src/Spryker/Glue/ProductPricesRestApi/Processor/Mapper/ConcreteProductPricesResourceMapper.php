...
class ConcreteProductPricesResourceMapper implements ConcreteProductPricesResourceMapperInterface
{
    /**
     ...
     */
    public function mapConcreteProductPricesTransferToRestResource(PriceProductStorageTransfer $productPricesTransfer, string $idResource): RestResourceInterface
    {
