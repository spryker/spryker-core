...
namespace Spryker\Client\ProductQuantity\Dependency\Client;

class ProductQuantityToGlossaryStorageClientBridge implements ProductQuantityToGlossaryStorageClientInterface
{
    /**
