...
namespace Spryker\Service\ProductQuantity\Dependency\Service;

class ProductQuantityToUtilQuantityServiceBridge implements ProductQuantityToUtilQuantityServiceInterface
{
    /**
