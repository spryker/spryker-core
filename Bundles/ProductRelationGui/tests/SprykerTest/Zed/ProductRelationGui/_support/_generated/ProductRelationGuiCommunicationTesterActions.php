<?php  //[STAMP] beb738907bfc420e7c411a2fd6ffca16
namespace SprykerTest\Zed\ProductRelationGui\_generated;

// This class was automatically generated by build task
// You should not change it manually as it will be overwritten on next build
// @codingStandardsIgnoreFile

trait ProductRelationGuiCommunicationTesterActions
{
    /**
     ...
     * @see \SprykerTest\Zed\Category\Helper\CategoryDataHelper::haveCategory()
     */
    public function haveCategory($seedData = null): \Generated\Shared\Transfer\CategoryTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveCategory', func_get_args()));
    }
     ...
     *
     * @return \Generated\Shared\Transfer\CategoryTransfer
     * @see \SprykerTest\Zed\Category\Helper\CategoryDataHelper::haveLocalizedCategory()
     */
    public function haveLocalizedCategory($seedData = null): \Generated\Shared\Transfer\CategoryTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveLocalizedCategory', func_get_args()));
    }
     ...
     * @see \SprykerTest\Zed\Category\Helper\CategoryDataHelper::haveCategoryTemplate()
     */
    public function haveCategoryTemplate($seedData = null): ?\Generated\Shared\Transfer\CategoryTemplateTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveCategoryTemplate', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \SprykerTest\Zed\ProductCategory\Helper\AssignHelper::assignProductToCategory()
     */
    public function assignProductToCategory($idCategory, $idProductAbstract): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assignProductToCategory', func_get_args()));
    }
     ...
     */
    public function haveStore($storeOverride = null) {
     ...
     */
    public function haveProduct($productConcreteOverride = null, $productAbstractOverride = null): \Generated\Shared\Transfer\ProductConcreteTransfer {
     ...
     */
    public function haveProductAbstract($productAbstractOverride = null): \Generated\Shared\Transfer\ProductAbstractTransfer {
     ...
     */
    public function haveFullProduct($productConcreteOverride = null, $productAbstractOverride = null): \Generated\Shared\Transfer\ProductConcreteTransfer {
     ...
     */
    public function addLocalizedAttributesToProductAbstract($productAbstractTransfer, $localizedAttributes): void {
     ...
     */
    public function addLocalizedAttributesToProductConcrete($productConcreteTransfer, $localizedAttributes): void {
     ...
     *
     * @return void
     * @see \SprykerTest\Shared\ProductRelation\Helper\ProductRelationDataHelper::ensureProductRelationTableIsEmpty()
     */
    public function ensureProductRelationTableIsEmpty(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('ensureProductRelationTableIsEmpty', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \SprykerTest\Shared\ProductRelation\Helper\ProductRelationDataHelper::ensureProductRelationProductAbstractTableIsEmpty()
     */
    public function ensureProductRelationProductAbstractTableIsEmpty(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('ensureProductRelationProductAbstractTableIsEmpty', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \SprykerTest\Shared\ProductRelation\Helper\ProductRelationDataHelper::ensureProductRelationStoreTableIsEmpty()
     */
    public function ensureProductRelationStoreTableIsEmpty(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('ensureProductRelationStoreTableIsEmpty', func_get_args()));
    }
     ...
     * @see \SprykerTest\Shared\ProductRelation\Helper\ProductRelationDataHelper::haveProductRelation()
     */
    public function haveProductRelation($productAbstractSku, $idProductAbstract, $productRelationKey, $productRelationType = null, $storeRelationTransfer = null): \Generated\Shared\Transfer\ProductRelationTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveProductRelation', func_get_args()));
    }
