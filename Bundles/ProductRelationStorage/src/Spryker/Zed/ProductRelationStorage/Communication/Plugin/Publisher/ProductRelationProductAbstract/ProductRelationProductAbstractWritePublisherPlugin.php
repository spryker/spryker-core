...
class ProductRelationProductAbstractWritePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    ...
    {
        $this->getFacade()->writeCollectionByProductRelationProductAbstractEvents($transfers);
    }
    ...
    public function getSubscribedEvents(): array
    {
        return [
            ...
            ProductRelationStorageConfig::ENTITY_SPY_PRODUCT_RELATION_PRODUCT_ABSTRACT_UPDATE,
