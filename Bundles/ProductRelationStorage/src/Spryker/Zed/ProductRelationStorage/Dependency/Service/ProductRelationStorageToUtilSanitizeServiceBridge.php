...
namespace Spryker\Zed\ProductRelationStorage\Dependency\Service;

class ProductRelationStorageToUtilSanitizeServiceBridge implements ProductRelationStorageToUtilSanitizeServiceInterface
{
    /**
