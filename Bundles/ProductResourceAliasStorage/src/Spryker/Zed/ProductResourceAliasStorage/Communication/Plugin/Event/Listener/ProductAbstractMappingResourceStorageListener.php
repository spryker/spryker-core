 ...
 */
class ProductAbstractMappingResourceStorageListener extends AbstractPlugin implements EventBulkHandlerInterface
{
    /**
     * @api
     *
    ...
    public function handleBulk(array $eventTransfers, $eventName)
    {
        ...
        $this->getFacade()->updateProductAbstractStorageSkus($productAbstractIds);
    }
}
