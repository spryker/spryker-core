 ...
 */
class ProductReviewSearchPublishListener extends AbstractPlugin implements EventBulkHandlerInterface
{
    ...
    public function handleBulk(array $eventTransfers, $eventName): void
    {
        ...
        $this->getFacade()->publishProductReviews($productReviewIds);
