...
class ProductReviewSearchEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(ProductReviewEvents::PRODUCT_REVIEW_PUBLISH, new ProductReviewSearchListener(), 0, null, $this->getConfig()->getProductReviewEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductReviewEvents::PRODUCT_REVIEW_UNPUBLISH, new ProductReviewSearchListener(), 0, null, $this->getConfig()->getProductReviewEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductReviewEvents::ENTITY_SPY_PRODUCT_REVIEW_CREATE, new ProductReviewSearchListener(), 0, null, $this->getConfig()->getProductReviewEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductReviewEvents::ENTITY_SPY_PRODUCT_REVIEW_UPDATE, new ProductReviewSearchListener(), 0, null, $this->getConfig()->getProductReviewEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductReviewEvents::ENTITY_SPY_PRODUCT_REVIEW_DELETE, new ProductReviewSearchListener(), 0, null, $this->getConfig()->getProductReviewEventQueueName());
    }
}
