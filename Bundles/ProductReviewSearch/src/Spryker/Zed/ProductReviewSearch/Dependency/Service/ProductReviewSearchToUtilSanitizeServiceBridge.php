...
namespace Spryker\Zed\ProductReviewSearch\Dependency\Service;

class ProductReviewSearchToUtilSanitizeServiceBridge implements ProductReviewSearchToUtilSanitizeServiceInterface
{
    /**
