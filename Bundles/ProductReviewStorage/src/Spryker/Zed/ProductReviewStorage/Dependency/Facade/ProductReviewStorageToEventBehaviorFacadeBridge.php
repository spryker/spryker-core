...
namespace Spryker\Zed\ProductReviewStorage\Dependency\Facade;

class ProductReviewStorageToEventBehaviorFacadeBridge implements ProductReviewStorageToEventBehaviorFacadeInterface
{
    /**
