...
namespace Spryker\Zed\ProductReviewStorage\Dependency\Service;

class ProductReviewStorageToUtilSanitizeServiceBridge implements ProductReviewStorageToUtilSanitizeServiceInterface
{
