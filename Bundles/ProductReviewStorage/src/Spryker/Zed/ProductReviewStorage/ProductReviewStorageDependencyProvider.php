...
use Spryker\Zed\ProductReviewStorage\Dependency\Service\ProductReviewStorageToUtilSanitizeServiceBridge;
...
class ProductReviewStorageDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    public function provideCommunicationLayerDependencies(Container $container)
    {
        $container[static::SERVICE_UTIL_SANITIZE] = function (Container $container) {
            return new ProductReviewStorageToUtilSanitizeServiceBridge($container->getLocator()->utilSanitize()->service());
        };
