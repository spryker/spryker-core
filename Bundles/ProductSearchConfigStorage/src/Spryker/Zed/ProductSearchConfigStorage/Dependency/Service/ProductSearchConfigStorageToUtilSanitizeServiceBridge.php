...
namespace Spryker\Zed\ProductSearchConfigStorage\Dependency\Service;

class ProductSearchConfigStorageToUtilSanitizeServiceBridge implements ProductSearchConfigStorageToUtilSanitizeServiceInterface
{
    /**
