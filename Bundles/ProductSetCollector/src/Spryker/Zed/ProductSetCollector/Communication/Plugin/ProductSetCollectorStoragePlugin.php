...
namespace Spryker\Zed\ProductSetCollector\Communication\Plugin;
...
class ProductSetCollectorStoragePlugin extends AbstractCollectorPlugin
{
    ...
    public function run(
        ...
        $this->getFacade()
            ->runStorageProductSetCollector($baseQuery, $localeTransfer, $result, $dataReader, $dataWriter, $touchUpdater, $output);
    }
}
