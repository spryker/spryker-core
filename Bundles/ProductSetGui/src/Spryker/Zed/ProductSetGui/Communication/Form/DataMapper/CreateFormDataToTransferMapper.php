...
class CreateFormDataToTransferMapper
{
    ...
    public function mapData(FormInterface $productSetForm)
    {
        ...
        $generalData = $productSetForm->get(CreateProductSetFormType::FIELD_GENERAL_FORM)->getData();

        // product set
        $productSetTransfer->fromArray($generalData, true);

        // general data
        $localizedGeneralFormDataCollection = $productSetForm->get(CreateProductSetFormType::FIELD_GENERAL_FORM)
        ...
        // products
        $idProductAbstracts = $productSetForm->get(CreateProductSetFormType::FIELD_PRODUCTS_FORM)
            ->get(ProductsFormType::FIELD_ASSIGN_ID_PRODUCT_ABSTRACTS)
            ->getData();
        $productSetTransfer->setIdProductAbstracts($idProductAbstracts);

        // seo
        $localizedSeoFormDataCollection = $productSetForm->get(CreateProductSetFormType::FIELD_SEO_FORM)
        ...
        // images
        $defaultImageSetFormCollection = $productSetForm->get(CreateProductSetFormType::FIELD_IMAGES_FORM)
        ...
        foreach ($localeCollection as $localeTransfer) {
            $localizedImageSetFormCollection = $productSetForm->get(CreateProductSetFormType::FIELD_IMAGES_FORM)
