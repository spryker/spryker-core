...
class ProductSetPageSearchEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::PRODUCT_SET_PUBLISH, new ProductSetPageSearchPublishListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::PRODUCT_SET_UNPUBLISH, new ProductSetPageSearchUnpublishListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_SET_CREATE, new ProductSetPageSearchPublishListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_SET_UPDATE, new ProductSetPageSearchPublishListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_SET_DELETE, new ProductSetPageSearchUnpublishListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_SET_DATA_CREATE, new ProductSetDataPageSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_SET_DATA_UPDATE, new ProductSetDataPageSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_SET_DATA_DELETE, new ProductSetDataPageSearchUnpublishListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_ABSTRACT_SET_CREATE, new ProductAbstractProductSetPageSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_ABSTRACT_SET_UPDATE, new ProductAbstractProductSetPageSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_ABSTRACT_SET_DELETE, new ProductAbstractProductSetPageSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_UPDATE, new ProductSetPageUrlSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_DELETE, new ProductSetPageUrlSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_UPDATE, new ProductSetPageProductImageSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_DELETE, new ProductSetPageProductImageSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_CREATE, new ProductSetPageProductImageSetSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_UPDATE, new ProductSetPageProductImageSetSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_DELETE, new ProductSetPageProductImageSetSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_TO_PRODUCT_IMAGE_UPDATE, new ProductSetPageProductImageSetImageSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_TO_PRODUCT_IMAGE_DELETE, new ProductSetPageProductImageSetImageSearchListener(), 0, null, $this->getConfig()->getProductSetPageEventQueueName());
    }
}
