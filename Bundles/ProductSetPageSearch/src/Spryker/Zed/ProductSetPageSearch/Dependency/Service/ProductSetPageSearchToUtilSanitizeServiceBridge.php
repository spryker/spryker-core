...
namespace Spryker\Zed\ProductSetPageSearch\Dependency\Service;

class ProductSetPageSearchToUtilSanitizeServiceBridge implements ProductSetPageSearchToUtilSanitizeServiceInterface
{
    /**
