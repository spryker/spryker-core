...
class ProductSetStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::PRODUCT_SET_PUBLISH, new ProductSetStoragePublishListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::PRODUCT_SET_UNPUBLISH, new ProductSetStorageUnpublishListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_SET_CREATE, new ProductSetStoragePublishListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_SET_UPDATE, new ProductSetStoragePublishListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_SET_DELETE, new ProductSetStorageUnpublishListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_SET_DATA_CREATE, new ProductSetDataStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_SET_DATA_UPDATE, new ProductSetDataStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_SET_DATA_DELETE, new ProductSetDataStorageUnpublishListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_ABSTRACT_SET_CREATE, new ProductAbstractProductSetStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_ABSTRACT_SET_UPDATE, new ProductAbstractProductSetStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductSetEvents::ENTITY_SPY_PRODUCT_ABSTRACT_SET_DELETE, new ProductAbstractProductSetStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_UPDATE, new ProductSetUrlStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_DELETE, new ProductSetUrlStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_UPDATE, new ProductSetProductImageStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_DELETE, new ProductSetProductImageStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_CREATE, new ProductSetProductImageSetStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_UPDATE, new ProductSetProductImageSetStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_DELETE, new ProductSetProductImageSetStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_TO_PRODUCT_IMAGE_UPDATE, new ProductSetProductImageSetImageStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ProductImageEvents::ENTITY_SPY_PRODUCT_IMAGE_SET_TO_PRODUCT_IMAGE_DELETE, new ProductSetProductImageSetImageStorageListener(), 0, null, $this->getConfig()->getProductSetEventQueueName());
    }
}
