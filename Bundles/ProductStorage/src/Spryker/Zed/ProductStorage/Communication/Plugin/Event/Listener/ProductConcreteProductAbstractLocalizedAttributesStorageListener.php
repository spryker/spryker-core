 ...
 */
class ProductConcreteProductAbstractLocalizedAttributesStorageListener extends AbstractProductConcreteStorageListener implements EventBulkHandlerInterface
{
    /**
     * @api
     *
    ...
    public function handleBulk(array $eventEntityTransfers, $eventName)
    {
        $hydrateEventsResponseTransfer = $this->hydrateEventDataTransfer(
            (new HydrateEventsRequestTransfer())
                ...
                ->setForeignKeyName(SpyProductAbstractLocalizedAttributesTableMap::COL_FK_PRODUCT_ABSTRACT),
        );
        ...
        $this->publishConcreteProducts(
            $this->getRepository()->getProductIdTimestampMap($hydrateEventsResponseTransfer->getForeignKeyTimestampMap()),
        );
    }
}
