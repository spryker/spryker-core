...
namespace Spryker\Zed\ProductStorage\Dependency\Service;

class ProductStorageToUtilSynchronizationBridge implements ProductStorageToUtilSynchronizationInterface
{
