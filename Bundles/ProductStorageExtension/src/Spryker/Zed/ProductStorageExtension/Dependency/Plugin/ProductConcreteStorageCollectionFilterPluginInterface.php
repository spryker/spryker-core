...
/**
 * Provides ability to filter ProductConcreteStorage transfer objects.
 */
interface ProductConcreteStorageCollectionFilterPluginInterface
{
    /**
     * Specification:
     * - Filters product concrete storage transfers.
     *
     * @api
     *
