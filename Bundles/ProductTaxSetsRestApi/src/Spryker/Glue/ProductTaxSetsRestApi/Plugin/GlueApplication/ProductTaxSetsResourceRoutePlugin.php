 ...
 */
class ProductTaxSetsResourceRoutePlugin extends AbstractPlugin implements ResourceRoutePluginInterface, ResourceWithParentPluginInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    {
        return RestProductTaxSetsAttributesTransfer::class;
    }
