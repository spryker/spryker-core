...
class ProductTaxSetsRestApiConfig extends AbstractBundleConfig
{
    ...
    /**
     * @see \Spryker\Glue\ProductsRestApi\ProductsRestApiConfig::RESPONSE_CODE_CANT_FIND_ABSTRACT_PRODUCT
     */
    public const RESPONSE_CODE_CANT_FIND_ABSTRACT_PRODUCT = '301';
    public const RESPONSE_CODE_CANT_FIND_PRODUCT_TAX_SETS = '310';

    /**
     * @see \Spryker\Glue\ProductsRestApi\ProductsRestApiConfig::RESPONSE_DETAIL_CANT_FIND_ABSTRACT_PRODUCT
     */
