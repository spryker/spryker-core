 ...
 */
class ConcreteProductsProductPricesResourceRelationshipPlugin extends AbstractPlugin implements ResourceRelationshipPluginInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    {
        return 'concrete-product-prices';
    }
}
