...
use SprykerFeature\Zed\PropelHeartbeatConnector\Persistence\Propel\SpyPropelHeartbeat as ChildSpyPropelHeartbeat;
...
abstract class SpyPropelHeartbeatQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \SprykerFeature\Zed\PropelHeartbeatConnector\Persistence\Propel\Base\SpyPropelHeartbeatQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\SprykerFeature\\Zed\\PropelHeartbeatConnector\\Persistence\\Propel\\SpyPropelHeartbeat', $modelAlias = null)
    {
