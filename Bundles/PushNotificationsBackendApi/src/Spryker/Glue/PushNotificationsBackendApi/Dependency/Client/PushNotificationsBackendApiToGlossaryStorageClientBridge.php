...
namespace Spryker\Glue\PushNotificationsBackendApi\Dependency\Client;

class PushNotificationsBackendApiToGlossaryStorageClientBridge implements PushNotificationsBackendApiToGlossaryStorageClientInterface
{
    /**
