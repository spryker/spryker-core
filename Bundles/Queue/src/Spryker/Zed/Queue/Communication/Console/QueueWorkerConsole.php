...
class QueueWorkerConsole extends Console
{
    ...
    protected function configure()
    {
        ...
        $this->addOption(static::OPTION_STOP_WHEN_EMPTY, static::OPTION_STOP_WHEN_EMPTY_SHORT, InputOption::VALUE_NONE, 'Stops worker execution when the queues are empty.');
