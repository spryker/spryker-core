...
class QuoteDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    public const PLUGINS_QUOTE_UNLOCK_PRE_CHECK = 'PLUGINS_QUOTE_UNLOCK_PRE_CHECK';
    ...
    public function provideBusinessLayerDependencies(Container $container): Container
    {
        ...
        $container = $this->addQuoteUnlockPreCheckPlugins($container);
     ...
     * @return \Spryker\Zed\Kernel\Container
     */
    protected function addQuoteUnlockPreCheckPlugins(Container $container): Container
    {
        $container[static::PLUGINS_QUOTE_UNLOCK_PRE_CHECK] = function (Container $container) {
            return $this->getQuoteUnlockPreCheckPlugins();
        };
