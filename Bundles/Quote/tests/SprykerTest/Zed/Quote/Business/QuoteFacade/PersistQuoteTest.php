...
class PersistQuoteTest extends Unit
{
    ...
    public function testPersistQuote(QuoteTransfer $quoteTransfer, QuoteTransfer $expectedQuoteTransfer): void
    {
        ...
        $this->assertSame($actualQuoteTransfer->getCurrency()->toArray(), $expectedQuoteTransfer->getCurrency()->toArray());
        $this->assertSame($actualQuoteTransfer->getStore()->toArray(), $expectedQuoteTransfer->getStore()->toArray());
