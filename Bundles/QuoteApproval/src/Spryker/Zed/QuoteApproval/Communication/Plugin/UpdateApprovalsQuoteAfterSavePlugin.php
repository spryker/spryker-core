 ...
 */
class UpdateApprovalsQuoteAfterSavePlugin extends AbstractPlugin implements QuoteWritePluginInterface
{
    /**
     * {@inheritdoc}
     * - Save approvals on quote save.
     *
     * @api
     *
    ...
    {
        if (!$quoteTransfer->isPropertyModified(QuoteTransfer::APPROVALS)) {
            return $quoteTransfer;
        }

        return $this->getFacade()->updateApprovals($quoteTransfer);
    }
}
