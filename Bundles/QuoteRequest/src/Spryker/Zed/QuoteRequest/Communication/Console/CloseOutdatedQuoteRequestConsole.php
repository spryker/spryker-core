...
{
    public const COMMAND_NAME = 'quote-request:close-outdated';
    public const COMMAND_DESCRIPTION = 'Updates status to "closed" for all requests for quote where valid_until less than current time.';
