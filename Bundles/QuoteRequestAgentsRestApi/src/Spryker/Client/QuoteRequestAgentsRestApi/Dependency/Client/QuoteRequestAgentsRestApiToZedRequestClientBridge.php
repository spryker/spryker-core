...
namespace Spryker\Client\QuoteRequestAgentsRestApi\Dependency\Client;

use Spryker\Shared\Kernel\Transfer\TransferInterface;

class QuoteRequestAgentsRestApiToZedRequestClientBridge implements QuoteRequestAgentsRestApiToZedRequestClientInterface
{
    /**
