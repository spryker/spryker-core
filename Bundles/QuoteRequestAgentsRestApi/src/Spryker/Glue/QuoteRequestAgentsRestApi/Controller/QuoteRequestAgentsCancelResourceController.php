 ...
 */
class QuoteRequestAgentsCancelResourceController extends AbstractController
{
    /**
     * @Glue({
     *     "post": {
     ...
     *              "ref": "acceptLanguage"
     *          }],
     *          "requestAttributesClassName": "\\Generated\\Shared\\Transfer\\RestAgentQuoteRequestCancelAttributesTransfer",
     *          "responses": {
     *              "400": "Bad request",
