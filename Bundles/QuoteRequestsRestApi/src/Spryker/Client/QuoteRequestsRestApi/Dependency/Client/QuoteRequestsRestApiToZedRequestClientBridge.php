...
namespace Spryker\Client\QuoteRequestsRestApi\Dependency\Client;

use Spryker\Shared\Kernel\Transfer\TransferInterface;

class QuoteRequestsRestApiToZedRequestClientBridge implements QuoteRequestsRestApiToZedRequestClientInterface
{
    /**
