...
namespace Spryker\Glue\QuoteRequestsRestApi\Dependency\Service;

use ArrayObject;

class QuoteRequestsRestApiToShipmentServiceBridge implements QuoteRequestsRestApiToShipmentServiceInterface
{
    /**
