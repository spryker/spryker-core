...
namespace SprykerFeature\Zed\Refund\Persistence\Propel\Base;
...
use SprykerFeature\Zed\Refund\Persistence\Propel\SpyShipmentCarrier as ChildSpyShipmentCarrier;
use SprykerFeature\Zed\Refund\Persistence\Propel\SpyShipmentCarrierQuery as ChildSpyShipmentCarrierQuery;
use SprykerFeature\Zed\Refund\Persistence\Propel\SpyShipmentMethod as ChildSpyShipmentMethod;
use SprykerFeature\Zed\Refund\Persistence\Propel\SpyShipmentMethodQuery as ChildSpyShipmentMethodQuery;
use SprykerFeature\Zed\Refund\Persistence\Propel\Map\SpyShipmentMethodTableMap;
 ...
 *
 *
* @package    propel.generator.vendor.spryker.spryker.Bundles.Refund.src.SprykerFeature.Zed.Refund.Persistence.Propel.Base
*/
abstract class SpyRefund implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\SprykerFeature\\Zed\\Refund\\Persistence\\Propel\\Map\\SpyRefundTableMap';
    ...
    /**
     * Initializes internal state of SprykerFeature\Zed\Refund\Persistence\Propel\Base\SpyShipmentMethod object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\SprykerFeature\Zed\Refund\Persistence\Propel\SpyShipmentMethod The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\SprykerFeature\\Zed\\Refund\\Persistence\\Propel\\SpyShipmentMethod'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\SprykerFeature\Zed\Refund\Persistence\Propel\SpyShipmentMethod
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SprykerFeature\Zed\Refund\Persistence\Propel\SpyShipmentMethod The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SprykerFeature\Zed\Refund\Persistence\Propel\SpyShipmentMethod (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SprykerFeature\Zed\Refund\Persistence\Propel\SpyShipmentMethod Clone of current object.
     * @throws PropelException
     */
    ...
    public function initShipmentMethodss($overrideExisting = true)
    {
        ...
        $this->collShipmentMethodss->setModel('\SprykerFeature\Zed\Sales\Persistence\Propel\SpySalesOrder');
    }
    ...
    public function getShipmentMethodss(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collShipmentMethodss || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collShipmentMethodss) {
                ...
                $collShipmentMethodss = SpySalesOrderQuery::create(null, $criteria)
    ...
    {
        /** @var SpySalesOrder[] $shipmentMethodssToDelete */
     ...
     * @return $this|\SprykerFeature\Zed\Refund\Persistence\Propel\SpyShipmentMethod The current object (for fluent API support)
     */
    public function addShipmentMethods(SpySalesOrder $l)
    {
        if ($this->collShipmentMethodss === null) {
            $this->initShipmentMethodss();
            $this->collShipmentMethodssPartial = true;
    ...
    /**
     * @param SpySalesOrder $shipmentMethods The SpySalesOrder object to add.
     */
    protected function doAddShipmentMethods(SpySalesOrder $shipmentMethods)
    {
    ...
    /**
     * @param  SpySalesOrder $shipmentMethods The SpySalesOrder object to remove.
     * @return $this|ChildSpyShipmentMethod The current object (for fluent API support)
     */
    public function removeShipmentMethods(SpySalesOrder $shipmentMethods)
    {
