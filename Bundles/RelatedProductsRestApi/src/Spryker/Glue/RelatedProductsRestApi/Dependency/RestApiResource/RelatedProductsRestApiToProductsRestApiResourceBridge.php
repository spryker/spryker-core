...
namespace Spryker\Glue\RelatedProductsRestApi\Dependency\RestApiResource;

use Spryker\Glue\GlueApplication\Rest\JsonApi\RestResourceInterface;
use Spryker\Glue\GlueApplication\Rest\Request\Data\RestRequestInterface;

class RelatedProductsRestApiToProductsRestApiResourceBridge implements RelatedProductsRestApiToProductsRestApiResourceInterface
{
    /**
