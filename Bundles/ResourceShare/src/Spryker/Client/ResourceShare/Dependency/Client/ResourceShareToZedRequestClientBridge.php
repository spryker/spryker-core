...
namespace Spryker\Client\ResourceShare\Dependency\Client;

use Spryker\Shared\Kernel\Transfer\TransferInterface;

class ResourceShareToZedRequestClientBridge implements ResourceShareToZedRequestClientInterface
{
    /**
