<?php  //[STAMP] 420a262472f854e98e85791d8a4502aa
...
use Testify\Helper\Environment;
use Propel\Helper\Connection;
use Application\Module\Yves;
use Application\Module\Zed;
use Sales\Helper\Presentation;
use Sales\Helper\Sales;

trait ZedPresentationTesterActions
{
    /**
     ...
     *
     * @return $this
     * @see \Application\Module\Yves::amYves()
     */
     ...
     *
     * @return $this
     * @see \Application\Module\Zed::amZed()
     */
     ...
     *
     * @return void
     * @see \Application\Module\Zed::amLoggedInUser()
     */
     ...
     *
     * @return $this
     * @see \Application\Module\Infrastructure::runCollectors()
     */
    public function runCollectors() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('runCollectors', func_get_args()));
    }
     ...
     *
     * @return int
     * @see \Sales\Helper\Sales::createOrder()
     */
     ...
     *
     * @return void
     * @see \Sales\Helper\Sales::createOrderWithOneItem()
     */
     ...
     *
     * @return int
     * @see \Sales\Helper\Sales::createSalesOrderItemForOrder()
     */
     ...
     *
     * @return void
     * @see \Sales\Helper\Sales::createDiscountForSalesOrderItem()
     */
