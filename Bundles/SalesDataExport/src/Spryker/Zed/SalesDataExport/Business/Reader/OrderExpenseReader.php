...
class OrderExpenseReader extends AbstractCsvReader
{
    /**
    ...
    {
        $ordersData = $this->salesDataExportRepository->getOrderExpenseData($dataExportConfigurationTransfer, $offset, $limit);
