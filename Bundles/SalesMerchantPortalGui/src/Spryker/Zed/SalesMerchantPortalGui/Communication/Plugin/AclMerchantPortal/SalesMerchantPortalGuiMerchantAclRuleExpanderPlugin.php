...
namespace Spryker\Zed\SalesMerchantPortalGui\Communication\Plugin\AclMerchantPortal;
 ...
 */
class SalesMerchantPortalGuiMerchantAclRuleExpanderPlugin extends AbstractPlugin implements MerchantAclRuleExpanderPluginInterface
{
    /**
    ...
    /**
     * {@inheritDoc}
     * - Adds `sales-merchant-portal-gui` to list of `AclRules`.
     *
     * @api
     *
    ...
    public function expand(array $ruleTransfers): array
    {
        $ruleTransfers[] = (new RuleTransfer())
            ->setBundle('sales-merchant-portal-gui')
