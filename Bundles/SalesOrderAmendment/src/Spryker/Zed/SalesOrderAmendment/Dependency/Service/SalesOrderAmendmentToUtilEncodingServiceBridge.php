...
namespace Spryker\Zed\SalesOrderAmendment\Dependency\Service;

class SalesOrderAmendmentToUtilEncodingServiceBridge implements SalesOrderAmendmentToUtilEncodingServiceInterface
{
    /**
