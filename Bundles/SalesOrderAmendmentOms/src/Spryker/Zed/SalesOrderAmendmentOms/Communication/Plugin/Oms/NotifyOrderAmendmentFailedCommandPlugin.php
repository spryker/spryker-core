 ...
 */
class NotifyOrderAmendmentFailedCommandPlugin extends AbstractPlugin implements CommandByOrderInterface
{
    /**
     * {@inheritDoc}
     ...
     * - Sends a mail notification that the order amendment has failed if the sales order amendment quote is found.
     *
     * @api
     *
    ...
    public function run(array $orderItems, SpySalesOrder $orderEntity, ReadOnlyArrayObject $data): array
    {
        $this->getBusinessFactory()
            ...
            ->notifyOrderAmendmentFailed($orderEntity->getOrderReference(), $orderEntity->getIdSalesOrder());
