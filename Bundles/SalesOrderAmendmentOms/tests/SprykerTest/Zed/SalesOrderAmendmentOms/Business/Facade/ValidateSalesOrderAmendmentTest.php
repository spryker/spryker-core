...
{
    /**
     * @uses \Spryker\Zed\SalesOrderAmendmentOms\Business\Validator\SalesOrderAmendmentValidator::GLOSSARY_KEY_VALIDATION_AMENDMENT_ORDER_DOES_NOT_EXIST
     *
     * @var string
     */
    ...
    /**
     * @uses \Spryker\Zed\SalesOrderAmendmentOms\Business\Validator\SalesOrderAmendmentValidator::GLOSSARY_KEY_VALIDATION_AMENDED_ORDER_DOES_NOT_EXIST
     *
     * @var string
     */
     ...
     * @return void
     */
    public function testShouldReturnValidationErrorWhenAmendmentOrderDoesNotExist(): void
    {
        // Arrange
        $saveOrderTransfer = $this->tester->haveOrderWithTwoItems();
        $salesOrderAmendmentTransfer = (new SalesOrderAmendmentTransfer())
            ->setAmendmentOrderReference('non-existing-order-reference')
    ...
    public function testShouldThrowExceptionWhenAmendmentOrderReferenceIsNotProvided(): void
    {
        ...
        // Assert
        $this->expectException(NullValueException::class);
        $this->expectExceptionMessage(sprintf('Property "amendmentOrderReference" of transfer `%s` is null.', SalesOrderAmendmentTransfer::class));
