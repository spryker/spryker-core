 ...
 * @group Plugin
 * @group Oms
 * @group NotifyOrderAmendmentFailedCommandPluginTest
 * Add your own group annotations below this line
 */
class NotifyOrderAmendmentFailedCommandPluginTest extends Unit
{
    /**
     * @var string
     */
    ...
    public function testRunDoesNothingWhenSalesOrderAmendmentQuoteIsNotFound(): void
    {
        ...
        $plugin = $this->createNotifyOrderAmendmentFailedCommandPlugin($mailFacadeMock, $salesOrderAmendmentFacadeMock);
    ...
    public function testRunSendsNotificationWhenSalesOrderAmendmentQuoteExists(): void
    {
        ...
        $mailFacadeMock->expects($this->once())->method('handleMail')
            ->with($this->callback(function (MailTransfer $mailTransfer) {
                return $mailTransfer->getType() === static::MAIL_TYPE_ORDER_AMENDMENT_FAILED
     ...
     *
     * @return \Spryker\Zed\SalesOrderAmendmentOms\Communication\Plugin\Oms\NotifyOrderAmendmentFailedCommandPlugin
     */
    protected function createNotifyOrderAmendmentFailedCommandPlugin(
    ...
    ): NotifyOrderAmendmentFailedCommandPlugin {
        $plugin = new NotifyOrderAmendmentFailedCommandPlugin();
