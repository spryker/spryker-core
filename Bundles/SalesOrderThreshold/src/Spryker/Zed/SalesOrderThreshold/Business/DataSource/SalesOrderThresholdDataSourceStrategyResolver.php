...
class SalesOrderThresholdDataSourceStrategyResolver implements SalesOrderThresholdDataSourceStrategyResolverInterface
{
    ...
    public function findApplicableThresholds(QuoteTransfer $quoteTransfer): array
    {
        ...
        foreach ($this->salesOrderThresholdDataSourceStrategyPlugins as $salesOrderThresholdDataSourceStrategyPlugin) {
            $salesOrderThresholdTransfers = array_merge($salesOrderThresholdTransfers, $salesOrderThresholdDataSourceStrategyPlugin->findApplicableThresholds($quoteTransfer));
        }

        return array_merge($salesOrderThresholdTransfers, $this->findGlobalApplicableThresholds($quoteTransfer));
    }
    ...
    public function findGlobalApplicableThresholds(QuoteTransfer $quoteTransfer): array
    {
        ...
        $salesOrderThresholdTransfers = $this->salesOrderThresholdReader
