 ...
 */
class IsMerchantPaidOutConditionPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
     * {@inheritDoc}
    ...
    public function check(SpySalesOrderItem $orderItem)
    {
        ...
        return $this->getFacade()->isPayoutSupportedForPaymentMethodUsedForOrder($salesOrderItemTransfer, $orderTransfer);
    }
}
