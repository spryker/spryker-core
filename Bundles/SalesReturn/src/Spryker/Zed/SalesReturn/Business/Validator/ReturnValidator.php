...
class ReturnValidator implements ReturnValidatorInterface
{
     ...
     */
    public function __construct(SalesReturnToStoreFacadeInterface $storeFacade)
    {
    ...
    public function validateReturnRequest(
        ...
        if (!$this->isAllItemsRelatedToCustomer($createReturnRequestTransfer, $itemTransfers)) {
     ...
     * @return bool
     */
    protected function isAllItemsRelatedToCustomer(CreateReturnRequestTransfer $createReturnRequestTransfer, ArrayObject $itemTransfers): bool
    {
