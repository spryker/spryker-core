...
namespace Spryker\Client\SalesReturnPageSearch\Dependency\Client;

use Spryker\Client\SearchExtension\Dependency\Plugin\QueryInterface;

class SalesReturnPageSearchToSearchClientBridge implements SalesReturnPageSearchToSearchClientInterface
{
    /**
