...
namespace Spryker\Client\SalesReturnPageSearch\Plugin\Elasticsearch\Query;
...
{
    protected const SOURCE_IDENTIFIER = 'return-reason';
    ...
    protected function setTypeFilter(BoolQuery $boolQuery): BoolQuery
    {
        ...
        $typeFilter->setField(ReturnReasonIndexMap::TYPE, SalesReturnPageSearchConfig::RETURN_REASON_RESOURCE_NAME);
