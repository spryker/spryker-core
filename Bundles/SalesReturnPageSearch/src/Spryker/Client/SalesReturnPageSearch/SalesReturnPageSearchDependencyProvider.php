...
use Spryker\Client\SalesReturnPageSearch\Dependency\Client\SalesReturnPageSearchToSearchClientBridge;

/**
 * @method \Spryker\Client\SalesReturnPageSearch\SalesReturnPageSearchConfig getConfig()
 */
class SalesReturnPageSearchDependencyProvider extends AbstractDependencyProvider
{
    ...
    protected function addSearchClient(Container $container): Container
    {
        $container->set(static::CLIENT_SEARCH, function (Container $container) {
            return new SalesReturnPageSearchToSearchClientBridge(
