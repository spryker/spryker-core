...
class SpySearchPageElementTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'vendor.spryker.spryker.Bundles.SearchPage.src.SprykerFeature.Zed.SearchPage.Persistence.Propel.Map.SpySearchPageElementTableMap';
     ...
     */
    const OM_CLASS = '\\SprykerFeature\\Zed\\SearchPage\\Persistence\\Propel\\SpySearchPageElement';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'vendor.spryker.spryker.Bundles.SearchPage.src.SprykerFeature.Zed.SearchPage.Persistence.Propel.SpySearchPageElement';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\SprykerFeature\\Zed\\SearchPage\\Persistence\\Propel\\SpySearchPageElement');
 ...
 // buildRelations()
    ...
    public static function doDelete($values, ConnectionInterface $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SprykerFeature\Zed\SearchPage\Persistence\Propel\SpySearchPageElement) { // it's a model object
