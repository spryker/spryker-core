...
namespace Spryker\Zed\SecurityMerchantPortalGui\Communication\Plugin\AclMerchantPortal;
 ...
 */
class SecurityMerchantPortalGuiMerchantUserAclRuleExpanderPlugin extends AbstractPlugin implements MerchantUserAclRuleExpanderPluginInterface
{
    /**
    ...
    /**
     * {@inheritDoc}
     * - Adds `security-merchant-portal-gui` to list of `AclRules`.
     *
     * @api
     *
