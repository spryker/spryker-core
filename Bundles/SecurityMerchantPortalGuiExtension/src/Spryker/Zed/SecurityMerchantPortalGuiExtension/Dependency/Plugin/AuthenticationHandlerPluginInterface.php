...
/**
 * Use this plugin to enable Multi-Factor Authentication for a merchant user in login process.
 */
interface AuthenticationHandlerPluginInterface
{
    ...
    /**
     * Specification:
     * - Validates whether the multi-factor authentication method is enabled for the provided merchant user.
