...
class ServicePointAddressUpdater implements ServicePointAddressUpdaterInterface
{
    ...
    public function updateServicePointAddressCollection(
        ...
        if ($validServicePointAddressTransfers->count()) {
            ...
            $validServicePointAddressTransfers = $this->getTransactionHandler()->handleTransaction(function () use ($validServicePointAddressTransfers) {
                return $this->executeUpdateServicePointAddressCollectionTransaction($validServicePointAddressTransfers);
            });
        }
     ...
     */
    protected function executeUpdateServicePointAddressCollectionTransaction(
        ...
        foreach ($servicePointAddressTransfers as $entityIdentifier => $servicePointAddressTransfer) {
            $servicePointAddressTransfer = $this->servicePointEntityManager->updateServicePointAddress($servicePointAddressTransfer);
