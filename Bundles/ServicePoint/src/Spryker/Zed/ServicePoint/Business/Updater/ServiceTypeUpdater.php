...
class ServiceTypeUpdater implements ServiceTypeUpdaterInterface
{
    ...
    public function updateServiceTypeCollection(
        ...
        if ($validServiceTypeTransfers->count()) {
            $validServiceTypeTransfers = $this->getTransactionHandler()->handleTransaction(function () use ($validServiceTypeTransfers) {
                return $this->executeUpdateServiceTypeCollectionTransaction($validServiceTypeTransfers);
            });
        }
     ...
     */
    protected function executeUpdateServiceTypeCollectionTransaction(
        ...
        foreach ($serviceTypeTransfers as $entityIdentifier => $serviceTypeTransfer) {
            $serviceTypeTransfer = $this->servicePointEntityManager->updateServiceType($serviceTypeTransfer);
