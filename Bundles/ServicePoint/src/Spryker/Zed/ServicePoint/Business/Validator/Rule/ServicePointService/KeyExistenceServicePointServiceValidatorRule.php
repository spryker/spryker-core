...
class KeyExistenceServicePointServiceValidatorRule implements ServicePointServiceValidatorRuleInterface
{
    /**
     * @var string
     */
    ...
    public function validate(ArrayObject $servicePointServiceTransfers): ErrorCollectionTransfer
    {
        ...
        foreach ($servicePointServiceTransfers as $entityIdentifier => $servicePointServiceTransfer) {
            if ($this->hasServicePointServiceWithKey($servicePointServiceTransfer)) {
                $this->errorAdder->addError(
                    $errorCollectionTransfer,
                    $entityIdentifier,
                    static::GLOSSARY_KEY_VALIDATION_SERVICE_POINT_SERVICE_KEY_EXISTS,
                );
            }
        }
     ...
     * @return bool
     */
    protected function hasServicePointServiceWithKey(ServicePointServiceTransfer $servicePointServiceTransfer): bool
    {
        ...
        if ($servicePointServiceTransfer->getUuid()) {
            $servicePointServiceConditionsTransfer
