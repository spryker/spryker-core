...
class UuidExistenceServiceTypeValidatorRule implements ServiceTypeValidatorRuleInterface, TerminationAwareValidatorRuleInterface
{
    /**
     * @var string
     */
    ...
    public function validate(ArrayObject $serviceTypeTransfers): ErrorCollectionTransfer
    {
        ...
        foreach ($serviceTypeTransfers as $entityIdentifier => $serviceTypeTransfer) {
            if (!$this->hasServiceTypeWithUuid($serviceTypeTransfer)) {
