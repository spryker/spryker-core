 ...
 */
class ServicePointAddressDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFacade()->importServicePointAddresses($dataImporterConfigurationTransfer);
    }
    ...
    {
        return ServicePointDataImportConfig::IMPORT_TYPE_SERVICE_POINT_ADDRESS;
    }
}
