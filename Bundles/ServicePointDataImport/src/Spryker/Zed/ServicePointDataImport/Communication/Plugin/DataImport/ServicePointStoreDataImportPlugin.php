 ...
 */
class ServicePointStoreDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFacade()->importServicePointStores($dataImporterConfigurationTransfer);
    }
    ...
    {
        return ServicePointDataImportConfig::IMPORT_TYPE_SERVICE_POINT_STORE;
    }
}
