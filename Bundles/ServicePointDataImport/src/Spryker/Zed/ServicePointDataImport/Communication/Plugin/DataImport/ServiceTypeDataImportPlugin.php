 ...
 */
class ServiceTypeDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFacade()->importServiceTypes($dataImporterConfigurationTransfer);
    }
    ...
    {
        return ServicePointDataImportConfig::IMPORT_TYPE_SERVICE_TYPE;
    }
}
