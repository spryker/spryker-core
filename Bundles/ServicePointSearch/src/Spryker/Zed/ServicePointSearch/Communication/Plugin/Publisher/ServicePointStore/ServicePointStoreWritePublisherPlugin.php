...
namespace Spryker\Zed\ServicePointSearch\Communication\Plugin\Publisher\ServicePointStore;
...
class ServicePointStoreWritePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    ...
    {
        $this->getFacade()->writeCollectionByServicePointStoreEvents($eventEntityTransfers);
    }
    ...
    {
        return [
            ServicePointSearchConfig::ENTITY_SPY_SERVICE_POINT_STORE_CREATE,
