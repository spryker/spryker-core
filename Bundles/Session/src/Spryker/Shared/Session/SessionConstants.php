...
interface SessionConstants
{
    ...
    public const YVES_SESSION_REDIS_CONFIGURATION = 'SESSION:YVES_SESSION_REDIS_CONFIGURATION';
    public const YVES_SESSION_REDIS_OPTIONS = 'SESSION:YVES_SESSION_REDIS_OPTIONS';
    ...
    public const ZED_SESSION_REDIS_CONFIGURATION = 'SESSION:ZED_SESSION_REDIS_CONFIGURATION';
    public const ZED_SESSION_REDIS_OPTIONS = 'SESSION:ZED_SESSION_REDIS_OPTIONS';
}
