...
namespace Spryker\Yves\Session\Model\Storage;
 ...
 * When using SessionClient within Yves Console context, it will use this storage.
 */
class ConsoleMemorySessionStorage implements SessionStorageInterface
{
    protected const SESSION_ID = 'CONSOLE_MOCKSESSID';
