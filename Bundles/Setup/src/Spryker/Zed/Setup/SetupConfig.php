...
class SetupConfig extends AbstractBundleConfig
{
    ...
    {
        return $this->get(SetupConstants::ENABLE_SCHEDULER, APPLICATION_ENV !== 'production');
    }
    ...
    {
        return $this->get(SetupConstants::ENABLE_DEPLOY_VARS, APPLICATION_ENV !== 'development');
    }
}
