...
class ShareCartByUuidActivatorStrategy implements ShareCartByUuidActivatorStrategyInterface
{
    ...
    protected function shareCartWithLoggedInCompanyUser(ResourceShareRequestTransfer $resourceShareRequestTransfer): ResourceShareResponseTransfer
    {
        ...
        $newShareDetailTransfer = $this->getShareDetailFromShareCartRequestTransfer($shareCartRequestTransfer);
     ...
     */
    protected function getShareDetailFromShareCartRequestTransfer(ShareCartRequestTransfer $shareCartRequestTransfer): ShareDetailTransfer
    {
        $shareDetails = $shareCartRequestTransfer->getShareDetails();

        return $shareDetails->offsetGet(0);
    }
