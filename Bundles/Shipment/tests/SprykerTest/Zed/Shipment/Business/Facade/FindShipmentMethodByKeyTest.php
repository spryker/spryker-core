 ...
 * @group Business
 * @group Facade
 * @group FindShipmentMethodByKeyTest
 * Add your own group annotations below this line
 */
class FindShipmentMethodByKeyTest extends Unit
{
    /**
    ...
    public function testExecutesStackOfShipmentMethodCollectionExpanderPlugins(): void
    {
        ...
        $shipmentMethodTransfer = $this->tester->haveShipmentMethod([ShipmentMethodTransfer::SHIPMENT_METHOD_KEY => 'shipment-method-key']);
