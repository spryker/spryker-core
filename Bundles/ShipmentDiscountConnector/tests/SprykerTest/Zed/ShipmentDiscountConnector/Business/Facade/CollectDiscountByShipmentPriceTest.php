 ...
 * @group Business
 * @group Facade
 * @group CollectDiscountByShipmentPriceTest
 * Add your own group annotations below this line
 */
class CollectDiscountByShipmentPriceTest extends Test
{
    /**
    ...
    /**
     * @dataProvider collectDiscountByShipmentPriceShouldUseQuoteLevelShipmentExpensesDataProvider
     *
     ...
     * @return void
     */
    public function testCollectDiscountByShipmentPriceShouldUseQuoteLevelShipmentExpenses(
     ...
     * @return array
     */
    public function collectDiscountByShipmentPriceShouldUseQuoteLevelShipmentExpensesDataProvider(): array
    {
        return [
    ...
    protected function getFacadeWithMockedDecisionRules(): ShipmentDiscountConnectorFacadeInterface
    {
        ...
        $mockedBusinessFactory = $this->createPartialMock(
            ...
            ['createShipmentPriceDiscountDecisionRule', 'createShipmentPriceDiscountDecisionRuleWithMultiShipment', 'getShipmentService']
        );
        $mockedBusinessFactory->method('createShipmentPriceDiscountDecisionRule')->willReturn($mockedQuoteLevelShipmentDecisionRule);
        $mockedBusinessFactory->method('createShipmentPriceDiscountDecisionRuleWithMultiShipment')->willReturn($mockedMultiShipmentDecisionRule);
