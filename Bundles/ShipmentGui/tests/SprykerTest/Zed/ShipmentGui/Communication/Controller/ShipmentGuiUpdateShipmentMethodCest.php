 ...
 * @group Communication
 * @group Controller
 * @group ShipmentGuiUpdateShipmentMethodCest
 * Add your own group annotations below this line
 */
class ShipmentGuiUpdateShipmentMethodCest
{
    /**
     * @var string
     */
    protected const PAGE_BREADCRUMB = 'Administration / Delivery Methods / Edit';
