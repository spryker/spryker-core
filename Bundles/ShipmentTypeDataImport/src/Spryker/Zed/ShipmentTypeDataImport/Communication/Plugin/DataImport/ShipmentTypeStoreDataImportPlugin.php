 ...
 */
class ShipmentTypeStoreDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFacade()->importShipmentTypeStores($dataImporterConfigurationTransfer);
    }
    ...
    {
        return ShipmentTypeDataImportConfig::IMPORT_TYPE_SHIPMENT_TYPE_STORE;
    }
}
