...
namespace Spryker\Client\ShipmentTypeServicePoint\Dependency\Client;
...
class ShipmentTypeServicePointToServicePointStorageClientBridge implements ShipmentTypeServicePointToServicePointStorageClientInterface
{
    /**
