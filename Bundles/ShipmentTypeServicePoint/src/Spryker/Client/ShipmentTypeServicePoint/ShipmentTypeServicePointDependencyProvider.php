...
use Spryker\Client\ShipmentTypeServicePoint\Dependency\Client\ShipmentTypeServicePointToServicePointStorageClientBridge;

class ShipmentTypeServicePointDependencyProvider extends AbstractDependencyProvider
{
    /**
     * @var string
     */
    ...
    protected function addServicePointStorageClient(Container $container): Container
    {
        $container->set(static::CLIENT_SERVICE_POINT_STORAGE, function (Container $container) {
            return new ShipmentTypeServicePointToServicePointStorageClientBridge(
