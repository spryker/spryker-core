...
namespace SprykerTest\Client\ShipmentTypeServicePoint\Client;
...
use Spryker\Client\ShipmentTypeServicePoint\ShipmentTypeServicePointDependencyProvider;
use SprykerTest\Client\ShipmentTypeServicePoint\ShipmentTypeServicePointClientTester;
...
class ExpandShipmentTypeStorageCollectionWithServiceTypeTest extends Unit
{
    ...
    /**
     * @var \SprykerTest\Client\ShipmentTypeServicePoint\ShipmentTypeServicePointClientTester
     */
    protected ShipmentTypeServicePointClientTester $tester;
    ...
    public function setUp(): void
    {
        ...
        $this->tester->setDependency(
            ShipmentTypeServicePointDependencyProvider::CLIENT_SERVICE_POINT_STORAGE,
    ...
    /**
     * @return \PHPUnit\Framework\MockObject\MockObject|\Spryker\Client\ShipmentTypeServicePoint\Dependency\Client\ShipmentTypeServicePointToServicePointStorageClientInterface
     */
    protected function getServicePointStorageClientMock(): ShipmentTypeServicePointToServicePointStorageClientInterface
    {
        ...
        $servicePointStorageClientMock = $this->getMockBuilder(ShipmentTypeServicePointToServicePointStorageClientInterface::class)
            ->getMock();
