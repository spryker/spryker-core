...
namespace SprykerTest\Glue\ShipmentTypeServicePointsRestApi\Plugin\GlueApplication;
...
class ServiceTypeByShipmentTypesResourceRelationshipPluginTest extends Unit
{
    ...
    /**
     * @return \PHPUnit\Framework\MockObject\MockObject|\Spryker\Glue\ShipmentTypeServicePointsRestApi\Dependency\Resource\ShipmentTypeServicePointsRestApiToServicePointsRestApiResourceInterface
     */
    protected function mockServicePointsRestApiResource(): ShipmentTypeServicePointsRestApiToServicePointsRestApiResourceInterface
    {
        $servicePointsRestApiResourceMock = $this->getMockBuilder(ShipmentTypeServicePointsRestApiToServicePointsRestApiResourceInterface::class)->getMock();
        ...
        $this->tester->setDependency(
            ShipmentTypeServicePointsRestApiDependencyProvider::RESOURCE_SERVICE_POINTS_REST_API,
