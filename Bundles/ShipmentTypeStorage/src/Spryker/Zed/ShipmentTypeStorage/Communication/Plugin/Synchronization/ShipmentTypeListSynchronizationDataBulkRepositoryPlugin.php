 ...
 */
class ShipmentTypeListSynchronizationDataBulkRepositoryPlugin extends AbstractPlugin implements SynchronizationDataBulkRepositoryPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    public function getData(int $offset, int $limit, array $ids = []): array
    {
        ...
        return $this->getRepository()->getShipmentTypeListStorageSynchronizationDataTransfers($filterTransfer, $ids);
    }
    ...
    {
        return ShipmentTypeStorageConfig::SHIPMENT_TYPE_LIST_RESOURCE_NAME;
    }
