...
class ShoppingListPermissionGroupMapper implements ShoppingListPermissionGroupMapperInterface
{
    ...
    public function mapShoppingListPermissionGroupTransfer(
        ...
        return $permissionGroupTransfer->fromArray($permissionGroupEntityTransfer->modifiedToArray(), true);
    }
    ...
    public function mapTransferToEntity(
        ...
        $permissionGroupEntity->fromArray($permissionGroupTransfer->modifiedToArray());
