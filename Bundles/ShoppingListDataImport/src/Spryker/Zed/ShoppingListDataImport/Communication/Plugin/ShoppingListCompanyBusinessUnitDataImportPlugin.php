...
class ShoppingListCompanyBusinessUnitDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    ...
    public function import(
        ...
        return $this->getFacade()->importShoppingListCompanyBusinessUnit($dataImporterConfigurationTransfer);
    }
    ...
    {
        return ShoppingListDataImportConfig::IMPORT_TYPE_SHOPPING_LIST_COMPANY_BUSINESS_UNIT;
    }
}
