 ...
 */
class ShoppingListDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * @api
     *
    ...
    public function import(
        ...
        return $this->getFacade()->importShoppingLists($dataImporterConfigurationTransfer);
    }
    ...
    {
        return ShoppingListDataImportConfig::IMPORT_TYPE_SHOPPING_LIST;
    }
}
