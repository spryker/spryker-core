...
class ShoppingListStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(ShoppingListEvents::ENTITY_SPY_SHOPPING_LIST_CREATE, new ShoppingListStorageListener(), 0, null, $this->getConfig()->getShoppingListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ShoppingListEvents::ENTITY_SPY_SHOPPING_LIST_UPDATE, new ShoppingListStorageListener(), 0, null, $this->getConfig()->getShoppingListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ShoppingListEvents::SHOPPING_LIST_UNPUBLISH, new ShoppingListStoragePublishListener(), 0, null, $this->getConfig()->getShoppingListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ShoppingListEvents::ENTITY_SPY_SHOPPING_LIST_ITEM_CREATE, new ShoppingListItemStorageListener(), 0, null, $this->getConfig()->getShoppingListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ShoppingListEvents::ENTITY_SPY_SHOPPING_LIST_ITEM_DELETE, new ShoppingListItemStorageListener(), 0, null, $this->getConfig()->getShoppingListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ShoppingListEvents::ENTITY_SPY_SHOPPING_LIST_COMPANY_USER_UPDATE, new ShoppingListCompanyUserStorageListener(), 0, null, $this->getConfig()->getShoppingListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ShoppingListEvents::ENTITY_SPY_SHOPPING_LIST_COMPANY_USER_CREATE, new ShoppingListCompanyUserStorageListener(), 0, null, $this->getConfig()->getShoppingListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ShoppingListEvents::ENTITY_SPY_SHOPPING_LIST_COMPANY_USER_DELETE, new ShoppingListCompanyUserStorageListener(), 0, null, $this->getConfig()->getShoppingListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ShoppingListEvents::ENTITY_SPY_SHOPPING_LIST_COMPANY_BUSINESS_UNIT_CREATE, new ShoppingListCompanyBusinessUnitStorageListener(), 0, null, $this->getConfig()->getShoppingListEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(ShoppingListEvents::ENTITY_SPY_SHOPPING_LIST_COMPANY_BUSINESS_UNIT_UPDATE, new ShoppingListCompanyBusinessUnitStorageListener(), 0, null, $this->getConfig()->getShoppingListEventQueueName());
    }
}
