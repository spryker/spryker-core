...
class ShoppingListStorageDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    {
        $container->set(static::PROPEL_QUERY_SHOPPING_LIST, function (Container $container) {
    ...
    {
        $container->set(static::PROPEL_QUERY_SHOPPING_LIST_ITEM, function (Container $container) {
