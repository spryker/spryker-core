...
class ShoppingListsResourceMapper implements ShoppingListsResourceMapperInterface
{
    /**
...
//        $restShoppingListAttributesTransfer->setNumberOfItems($shoppingListTransfer->getNumberOfItems() ?? 0);
