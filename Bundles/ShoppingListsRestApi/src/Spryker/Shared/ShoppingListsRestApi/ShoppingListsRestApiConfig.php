...
class ShoppingListsRestApiConfig extends AbstractBundleConfig
{
    ...
    public const RESPONSE_CODE_SHOPPING_LIST_CANNOT_MANAGE = '1506';
    public const RESPONSE_DETAIL_SHOPPING_LIST_CANNOT_MANAGE = 'Requested operation requires write access permission.';
