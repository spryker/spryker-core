...
class ShoppingListsRestApiToCompanyUserFacadeBridge implements ShoppingListsRestApiToCompanyUserFacadeInterface
{
    /**
    ...
    {
        return $this->companyUserFacade->findCompanyUserByUuid($companyUserTransfer);
    }
}
