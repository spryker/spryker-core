 ...
 */
class MySqlStorageReaderProviderPlugin extends AbstractPlugin implements StorageReaderProviderPluginInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    {
        return $this->getFactory()->createMySqlStorageReader();
    }
}
