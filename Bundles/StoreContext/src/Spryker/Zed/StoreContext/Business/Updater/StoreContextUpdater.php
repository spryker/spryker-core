...
class StoreContextUpdater implements StoreContextUpdaterInterface
{
    /**
    ...
    public function updateStoreContextCollection(
        ...
        return $this->storeContextWriter->updateStoreContextCollection($storeContextCollectionRequestTransfer);
    }
}
