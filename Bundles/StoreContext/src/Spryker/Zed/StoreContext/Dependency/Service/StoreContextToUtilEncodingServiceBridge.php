...
namespace Spryker\Zed\StoreContext\Dependency\Service;

class StoreContextToUtilEncodingServiceBridge implements StoreContextToUtilEncodingServiceInterface
{
    /**
