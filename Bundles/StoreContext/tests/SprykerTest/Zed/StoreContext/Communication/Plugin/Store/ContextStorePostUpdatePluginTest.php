 ...
 * @group Plugin
 * @group Store
 * @group ContextStorePostUpdatePluginTest
 * Add your own group annotations below this line
 */
class ContextStorePostUpdatePluginTest extends Unit
{
    /**
     * @var int
     */
    ...
    public function testExecuteReturnsCorrectStoreResponseTransfer(): void
    {
        ...
        $mockFacade = $this->createPartialMock(StoreContextFacade::class, ['updateStoreContextCollection']);
        $mockFacade->method('updateStoreContextCollection')
            ->with(
                $this->callback(
                    /**
        ...
        $plugin = new ContextStorePostUpdatePlugin();
