 ...
 * @group Plugin
 * @group Store
 * @group ContextStorePreCreateValidationPluginTest
 * Add your own group annotations below this line
 */
class ContextStorePreCreateValidationPluginTest extends Unit
{
    /**
     * @var int
     */
    ...
    public function testValidateReturnsCorrectStoreResponseTransfer(): void
    {
        ...
        $plugin = new ContextStorePreCreateValidationPlugin();
