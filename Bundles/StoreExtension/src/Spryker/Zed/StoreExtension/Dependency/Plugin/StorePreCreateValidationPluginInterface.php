 ...
 *
 * Use this plugin when you need to run a validation before Store is created.
 */
interface StorePreCreateValidationPluginInterface
{
    /**
     * Specification:
     * - Plugin is triggered before store is created.
     *
     * @api
     *
