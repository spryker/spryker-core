...
namespace Spryker\Zed\StoreStorage\Communication\Plugin\Publisher\CountryStore;
 ...
 */
class CountryStoreWritePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        $this->getFacade()->writeCollectionByCountryStoreEvents($transfers);
    }
    ...
    {
        return [
            StoreStorageConfig::ENTITY_SPY_COUNTRY_STORE_CREATE,
            StoreStorageConfig::ENTITY_SPY_COUNTRY_STORE_DELETE,
        ];
    }
}
