...
namespace Spryker\Zed\StoreStorage\Communication\Plugin\Publisher\CurrencyStore;
 ...
 */
class CurrencyStoreWritePublisherPlugin extends AbstractPlugin implements PublisherPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        $this->getFacade()->writeCollectionByCurrencyStoreEvents($transfers);
    }
    ...
    {
        return [
            StoreStorageConfig::ENTITY_SPY_CURRENCY_STORE_CREATE,
            StoreStorageConfig::ENTITY_SPY_CURRENCY_STORE_DELETE,
        ];
    }
}
