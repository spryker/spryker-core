...
namespace SprykerTest\Zed\StoreStorage\Communication\Plugin\Publisher\LocaleStore;
 ...
 * @group Publisher
 * @group LocaleStore
 * @group LocaleStoreStoragePublisherTest
 * Add your own group annotations below this line
 */
class LocaleStoreStoragePublisherTest extends Unit
{
    /**
     * @var string
     */
     ...
     * @return void
     */
    public function testStoreLocaleWritePublisherStoreData(): void
    {
        // Arrange
        ...
        $eventTransfers = [
            (new EventEntityTransfer())
                ->setForeignKeys([
                    SpyLocaleStoreTableMap::COL_FK_STORE => $storeTransfer->getIdStore(),
                ]),
        ];

        // Act
        (new LocaleStoreWritePublisherPlugin())->handleBulk($eventTransfers, StoreStorageConfig::ENTITY_SPY_LOCALE_STORE_CREATE);
