...
class TaxProductStorageSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        return $eventCollection->addListenerQueued(ProductEvents::PRODUCT_ABSTRACT_PUBLISH, new TaxProductStoragePublishListener(), 0, null, $this->getConfig()->getTaxProductEventQueueName());
    }
    ...
    {
        return $eventCollection->addListenerQueued(ProductEvents::PRODUCT_ABSTRACT_UNPUBLISH, new TaxProductStorageUnpublishListener(), 0, null, $this->getConfig()->getTaxProductEventQueueName());
    }
    ...
    {
        return $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_CREATE, new TaxProductStoragePublishListener(), 0, null, $this->getConfig()->getTaxProductEventQueueName());
    }
    ...
    {
        return $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_UPDATE, new TaxProductStoragePublishListener(), 0, null, $this->getConfig()->getTaxProductEventQueueName());
    }
    ...
    {
        return $eventCollection->addListenerQueued(ProductEvents::ENTITY_SPY_PRODUCT_ABSTRACT_DELETE, new TaxProductStorageUnpublishListener(), 0, null, $this->getConfig()->getTaxProductEventQueueName());
    }
}
