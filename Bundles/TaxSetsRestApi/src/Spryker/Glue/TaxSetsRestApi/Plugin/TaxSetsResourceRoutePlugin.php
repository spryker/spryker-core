 ...
 */
class TaxSetsResourceRoutePlugin extends AbstractPlugin implements ResourceRoutePluginInterface, ResourceWithParentPluginInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    {
        return TaxSetsRestApiConfig::RESOURCE_TAX_SETS;
    }
