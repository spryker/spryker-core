...
class Schema extends AbstractObject implements ReferableInterface
{
    ...
    public function getObjectSpecification(): ObjectSpecification
    {
        return (new ObjectSpecification())
            ...
            ->setProperty('not', new PropertyDefinition(__CLASS__))
            ->setProperty('items', new PropertyDefinition(__CLASS__))
            ->setProperty('properties', new PropertyDefinition(Schemas::class))
            ->setProperty('additionalProperties', new PropertyDefinition(__CLASS__))
