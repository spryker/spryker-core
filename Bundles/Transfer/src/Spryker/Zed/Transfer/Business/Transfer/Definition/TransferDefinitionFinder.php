...
namespace Spryker\Zed\Transfer\Business\Transfer\Definition;
...
class TransferDefinitionFinder implements FinderInterface
{
    ...
    public function getXmlTransferDefinitionFiles()
    {
        ...
        $finder->in($existingSourceDirectories)->name($this->transferConfig->getTransferFileNamePattern())->depth('< 1');
    ...
    protected function getExistingSourceDirectories()
    {
        ...
        foreach ($this->transferConfig->getSourceDirectories() as $sourceDirectory) {
