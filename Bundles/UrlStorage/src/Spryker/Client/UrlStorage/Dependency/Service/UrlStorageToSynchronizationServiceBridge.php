...
namespace Spryker\Client\UrlStorage\Dependency\Service;

class UrlStorageToSynchronizationServiceBridge implements UrlStorageToSynchronizationServiceInterface
{
    /**
