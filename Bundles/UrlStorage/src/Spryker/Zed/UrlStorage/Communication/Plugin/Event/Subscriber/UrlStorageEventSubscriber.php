...
class UrlStorageEventSubscriber extends AbstractPlugin implements EventSubscriberInterface
{
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::URL_PUBLISH, new UrlStoragePublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::URL_UNPUBLISH, new UrlStorageUnpublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_CREATE, new UrlStoragePublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_UPDATE, new UrlStoragePublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_DELETE, new UrlStorageUnpublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_REDIRECT_CREATE, new RedirectStoragePublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_REDIRECT_UPDATE, new RedirectStoragePublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
    ...
    {
        $eventCollection->addListenerQueued(UrlEvents::ENTITY_SPY_URL_REDIRECT_DELETE, new RedirectStorageUnpublishListener(), 0, null, $this->getConfig()->getEventQueueName());
    }
}
