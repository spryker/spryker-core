...
namespace Spryker\Zed\UserPasswordResetMail\Dependency\Facade;

use Generated\Shared\Transfer\MailTransfer;

class UserPasswordResetMailToMailFacadeBridge implements UserPasswordResetMailToMailFacadeInterface
{
    /**
