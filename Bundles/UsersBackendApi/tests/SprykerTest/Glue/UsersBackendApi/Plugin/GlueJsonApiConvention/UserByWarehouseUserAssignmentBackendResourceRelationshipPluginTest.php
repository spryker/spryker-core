...
use SprykerTest\Glue\UsersBackendApi\UsersBackendApiTester;
...
class UserByWarehouseUserAssignmentBackendResourceRelationshipPluginTest extends Unit
{
     ...
     * @var string
     */
    protected const RESOURCE_NAME_USERS = 'users';
    ...
    /**
     * @var \SprykerTest\Glue\UsersBackendApi\UsersBackendApiTester
     */
    protected UsersBackendApiTester $tester;
    ...
    public function testAddRelationshipsWillAddUsersResourceToWarehouseUserAssignmentsResource(): void
    {
        ...
        $this->assertSame(static::RESOURCE_NAME_USERS, $usersGlueResourceTransfer->getType());
