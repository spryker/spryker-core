 ...
 * @group Resource
 * @group GetUserResourceCollectionTest
 * Add your own group annotations below this line
 */
class GetUserResourceCollectionTest extends Unit
{
    /**
    ...
    public function testShouldReturnCollectionOfUserResourcesFilteredByUuid(): void
    {
        ...
        // Act
        $userResourceCollectionTransfer = $this->tester->getResource()->getUserResourceCollection($userCriteriaTransfer);
    ...
    protected function assertUserResourceCollectionTransfer(
        ...
        $this->assertInstanceOf(UsersRestAttributesTransfer::class, $userResourceTransfer->getAttributes());

        /** @var \Generated\Shared\Transfer\UsersRestAttributesTransfer $usersRestAttributesTransfer */
        $usersRestAttributesTransfer = $userResourceTransfer->getAttributesOrFail();
        $this->assertSame($expectedUserTransfer->getFirstNameOrFail(), $usersRestAttributesTransfer->getFirstName());
        $this->assertSame($expectedUserTransfer->getLastNameOrFail(), $usersRestAttributesTransfer->getLastName());
        $this->assertSame($expectedUserTransfer->getUsernameOrFail(), $usersRestAttributesTransfer->getUsername());
    }
}
