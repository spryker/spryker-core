...
class WishlistsRestApiToWishlistClientBridge implements WishlistsRestApiToWishlistClientInterface
{
     ...
     */
    public function validateAndCreateWishlist(WishlistTransfer $wishlistTransfer): WishlistResponseTransfer
    {
     ...
     * @return \Generated\Shared\Transfer\WishlistResponseTransfer
     */
    public function validateAndUpdateWishlist(WishlistTransfer $wishlistTransfer): WishlistResponseTransfer
    {
     ...
     */
    public function removeWishlist(WishlistTransfer $wishlistTransfer): WishlistTransfer
    {
        return $this->wishlistClient->removeWishlist($wishlistTransfer);
    }
     ...
     */
    public function getWishlistOverviewWithoutProductDetails(WishlistOverviewRequestTransfer $wishlistOverviewRequestTransfer): WishlistOverviewResponseTransfer
    {
