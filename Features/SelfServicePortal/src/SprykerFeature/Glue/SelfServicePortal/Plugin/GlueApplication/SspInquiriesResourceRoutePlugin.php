 ...
 */
class SspInquiriesResourceRoutePlugin extends AbstractPlugin implements ResourceRoutePluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    {
        return SelfServicePortalConfig::RESOURCE_SSP_INQUIRIES;
    }
    ...
    {
        return 'StorefrontApi\\RestApi\\SspInquiriesResource';
    }
    ...
    {
        return RestSspInquiriesAttributesTransfer::class;
    }
}
