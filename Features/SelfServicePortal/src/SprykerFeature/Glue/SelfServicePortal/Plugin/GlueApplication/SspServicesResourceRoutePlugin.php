 ...
 */
class SspServicesResourceRoutePlugin extends AbstractPlugin implements ResourceRoutePluginInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    {
        return SelfServicePortalConfig::RESOURCE_SSP_SERVICES;
    }
    ...
    {
        return 'StorefrontApi\\RestApi\\SspServicesResource';
    }
    ...
    {
        return RestSspServiceAttributesTransfer::class;
    }
}
