...
class ProductAbstractToProductAbstractTypeDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    ...
    {
        return $this->getBusinessFactory()->getProductAbstractToProductAbstractTypeDataImporter()->import($dataImporterConfigurationTransfer);
    }
    ...
    {
        return SelfServicePortalConfig::IMPORT_TYPE_PRODUCT_ABSTRACT_TO_PRODUCT_ABSTRACT_TYPE;
    }
}
