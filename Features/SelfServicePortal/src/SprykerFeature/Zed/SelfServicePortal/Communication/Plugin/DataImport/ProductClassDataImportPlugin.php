 ...
 */
class ProductClassDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    /**
     * {@inheritDoc}
     * - Imports product classes.
     *
     * @api
     *
    ...
    {
        return SelfServicePortalConfig::IMPORT_TYPE_PRODUCT_CLASS;
    }
}
