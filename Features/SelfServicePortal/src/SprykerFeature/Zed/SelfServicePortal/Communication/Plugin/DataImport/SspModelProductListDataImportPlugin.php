 ...
 */
class SspModelProductListDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
     /**
      * {@inheritDoc}
    ...
    {
        return SelfServicePortalConfig::IMPORT_TYPE_SSP_MODEL_PRODUCT_LIST;
    }
}
