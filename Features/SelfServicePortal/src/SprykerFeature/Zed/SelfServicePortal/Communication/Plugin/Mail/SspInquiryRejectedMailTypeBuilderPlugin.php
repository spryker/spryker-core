...
class SspInquiryRejectedMailTypeBuilderPlugin extends AbstractPlugin implements MailTypeBuilderPluginInterface
{
     ...
     * @var string
     */
    protected const MAIL_TEMPLATE_HTML = 'SelfServicePortal/Mail/ssp-inquiry_rejected.html.twig';

    /**
     * @var string
     */
    protected const MAIL_TEMPLATE_TEXT = 'SelfServicePortal/Mail/ssp-inquiry_rejected.text.twig';

    /**
     * @var string
     */
    protected const GLOSSARY_KEY_MAIL_SUBJECT = 'self_service_portal.inquiry.mail.trans.ssp_inquiry_rejected.subject';
