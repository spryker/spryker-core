 ...
 */
class ProductClassProductConcretePostCreatePlugin extends AbstractPlugin implements ProductConcreteCreatePluginInterface
{
    /**
     * {@inheritDoc}
     * - Saves product classes for a newly created product concrete.
