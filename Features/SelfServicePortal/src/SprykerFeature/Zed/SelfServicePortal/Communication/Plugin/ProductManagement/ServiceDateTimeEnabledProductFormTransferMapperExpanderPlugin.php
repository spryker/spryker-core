 ...
 */
class ServiceDateTimeEnabledProductFormTransferMapperExpanderPlugin extends AbstractPlugin implements ProductFormTransferMapperExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Maps service date time enabled field from form data to `ProductConcreteTransfer`.
     *
     * @api
     *
    ...
    public function map(ProductConcreteTransfer $productConcrete, array $formData): ProductConcreteTransfer
    {
        return $this->getFactory()
            ...
            ->mapServiceDateTimeFormDataToProductConcrete($productConcrete, $formData);
    }
}
