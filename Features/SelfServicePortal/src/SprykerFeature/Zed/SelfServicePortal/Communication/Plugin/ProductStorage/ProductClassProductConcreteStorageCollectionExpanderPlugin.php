 ...
 */
class ProductClassProductConcreteStorageCollectionExpanderPlugin extends AbstractPlugin implements ProductConcreteStorageCollectionExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Expands `ProductConcreteStorage` transfers with product classes.
     * - Adds product classes to the product attributes.
     *
     * @api
     *
    ...
    public function expand(array $productConcreteStorageTransfers): array
    {
        return $this->getBusinessFactory()
            ->createProductClassProductConcreteStorageExpander()
            ->expandProductConcreteStorageTransfersWithProductClasses($productConcreteStorageTransfers);
    }
}
