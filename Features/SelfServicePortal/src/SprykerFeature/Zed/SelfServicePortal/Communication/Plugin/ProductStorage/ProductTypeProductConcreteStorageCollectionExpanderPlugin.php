 ...
 */
class ProductTypeProductConcreteStorageCollectionExpanderPlugin extends AbstractPlugin implements ProductConcreteStorageCollectionExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Expands `ProductConcreteStorage` transfers with product type information.
     *
     * @api
     *
    ...
    public function expand(array $productConcreteStorageTransfers): array
    {
        return $this->getBusinessFactory()
            ->createProductTypeProductConcreteStorageExpander()
            ->expandProductConcreteStorageTransfersWithProductTypes($productConcreteStorageTransfers);
    }
}
