 ...
 */
class SspFileDashboardDataExpanderPlugin extends AbstractPlugin implements DashboardDataExpanderPluginInterface
{
    /**
     * {@inheritDoc}
     * - Provides file attachment data for the Self Service Portal dashboard.
     *
     * @api
     *
    ...
    public function provideDashboardData(
        ...
        return $this->getBusinessFactory()
            ->createFileDashboardDataExpander()
            ->provideFileAttachmentDashboardData($dashboardResponseTransfer, $dashboardRequestTransfer);
    }
}
