 ...
 */
class SspInquiryDashboardDataExpanderPlugin extends AbstractPlugin implements DashboardDataExpanderPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    public function provideDashboardData(
        ...
        return $this->getBusinessFactory()
            ->createInquiryDashboardDataExpander()
            ->provideSspInquiryDashboardData($dashboardResponseTransfer, $dashboardRequestTransfer);
    }
}
