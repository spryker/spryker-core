 ...
 * @group Plugin
 * @group Inquiry
 * @group ApproveSspInquiryCommandPluginTest
 *
 * Add your own group annotations below this line
 */
class ApproveSspInquiryCommandPluginTest extends Unit
{
    /**
    ...
    /**
     * @var \SprykerFeature\Zed\SelfServicePortal\Communication\Plugin\StateMachine\ApproveSspInquiryCommandPlugin
     */
    protected $approveSspInquiryCommandPlugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->selfServicePortalInquiryBusinessFactoryMock = $this->getMockBuilder(SelfServicePortalBusinessFactory::class)
            ->onlyMethods(['getMailFacade', 'getConfig', 'getCustomerFacade', 'createSspInquiryReader', 'createSspInquiryApprovalHandler'])
            ->getMock();
        ...
        $sspInquiryApprovalHandler = new SspInquiryApprovalHandler(
        ...
        $this->selfServicePortalInquiryBusinessFactoryMock->method('createSspInquiryApprovalHandler')->willReturn($sspInquiryApprovalHandler);

        $this->approveSspInquiryCommandPlugin = new ApproveSspInquiryCommandPlugin();
        $this->approveSspInquiryCommandPlugin->setBusinessFactory($this->selfServicePortalInquiryBusinessFactoryMock);
        $this->approveSspInquiryCommandPlugin->setFacade($this->selfServicePortalFacadeMock);
    ...
    public function testRun(): void
    {
        ...
        // Act
        $this->approveSspInquiryCommandPlugin->run($stateMachineItemTransfer);
    }
}
