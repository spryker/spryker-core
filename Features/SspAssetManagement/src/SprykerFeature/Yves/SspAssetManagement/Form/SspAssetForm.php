...
namespace SprykerFeature\Yves\SspAssetManagement\Form;
...
class SspAssetForm extends AbstractType
{
        ...
        $builder->add(static::FIELD_NAME, TextType::class, [
            ...
            'constraints' => [
                ...
                new Length([
                    'min' => 3,
                    'max' => 255,
                    'minMessage' => 'ssp_asset.form.name.validation.min',
                ]),
            ],
        ]);
    ...
    protected function addSerialNumberField(FormBuilderInterface $builder)
    {
        $builder->add(static::FIELD_SERIAL_NUMBER, TextType::class, [
            'label' => 'ssp_asset.form.serial_number',
            'required' => false,
            'constraints' => [
                new Length([
                    'max' => 255,
                    'minMessage' => 'ssp_asset.form.serial_number.validation.min',
                ]),
            ],
        ]);
    ...
    protected function addNoteField(FormBuilderInterface $builder)
    {
        $builder->add(static::FIELD_NOTE, TextareaType::class, [
            'label' => 'ssp_asset.form.note',
            'required' => false,
            'constraints' => [
                new Length([
                    'max' => 1000,
                    'minMessage' => 'ssp_asset.form.note.validation.min',
                ]),
            ],
            'attr' => ['rows' => 5],
        ]);
