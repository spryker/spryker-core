    ...
    protected function addFileField(FormBuilderInterface $builder, array $options)
    {
        $builder->add(static::FIELD_FILE, FileType::class, [
            ...
            'attr' => [
                ...
                'maxTotalSize' => $this->convertToReadableSize($this->normalizeBinaryFormat($this->getConfig()->getFileMaxSize())),
                'descriptionMessage' => 'ssp_asset.form.image.description',
