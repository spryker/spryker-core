...
class AssetAttachmentForm extends AbstractType
{
     ...
     * @var string
     */
    protected const DATASOURCE_URL_ASSET = '/ssp-asset-management/autocomplete/asset';
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $actionUrl = Url::generate('/ssp-asset-management/asset-attachment/index', ['id-file' => $options[static::OPTION_ID_FILE]]);
