...
use Orm\Zed\SspAssetManagement\Persistence\Map\SpySspAssetToCompanyBusinessUnitTableMap;
...
class AssignedBusinessUnitTable extends AbstractTable
{
     ...
     * @var string
     */
    protected const BASE_URL = '/ssp-asset-management/assigned-business-unit-list';
     ...
     * @param \Orm\Zed\SspAssetManagement\Persistence\SpySspAssetToCompanyBusinessUnitQuery $sspAssetToCompanyBusinessUnitQuery
