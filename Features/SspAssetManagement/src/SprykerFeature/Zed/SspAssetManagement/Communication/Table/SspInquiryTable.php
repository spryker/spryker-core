...
class SspInquiryTable extends AbstractTable
{
     ...
     * @var string
     */
    protected const BASE_URL = '/ssp-asset-management/ssp-asset-inquiry-list';
     ...
     * @param \Orm\Zed\SspInquiryManagement\Persistence\SpySspInquirySspAssetQuery $sspInquirySspAssetQuery
