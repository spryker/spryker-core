...
namespace SprykerFeatureTest\Zed\SspAssetManagement\Communication\Form\DataProvider;
...
class SspAssetFormDataProviderTest extends Unit
{
    ...
    /**
     * @return \SprykerFeature\Zed\SspAssetManagement\Communication\Form\DataProvider\SspAssetFormDataProvider
     */
    protected function createSspAssetFormDataProvider(): SspAssetFormDataProvider
    {
        return new SspAssetFormDataProvider(
            $this->createSspAssetManagementFacadeMock(),
            $this->createSspAssetManagementConfigMock(),
    ...
    /**
     * @return \SprykerFeature\Zed\SspAssetManagement\Business\SspAssetManagementFacadeInterface|\PHPUnit\Framework\MockObject\MockObject
     */
    protected function createSspAssetManagementFacadeMock(): SspAssetManagementFacadeInterface
    {
        return $this->createMock(SspAssetManagementFacadeInterface::class);
    }

    /**
     * @return \SprykerFeature\Zed\SspAssetManagement\SspAssetManagementConfig|\PHPUnit\Framework\MockObject\MockObject
     */
    protected function createSspAssetManagementConfigMock(): SspAssetManagementConfig
    {
        return $this->createMock(SspAssetManagementConfig::class);
    }
