...
class AttachFileForm extends AbstractType
{
    ...
    /**
     * @uses \SprykerFeature\Zed\SspFileManagement\Communication\Controller\AutocompleteController::companyAction()
     *
     * @var string
     */
    protected const DATASOURCE_URL_COMPANY = '/ssp-file-management/autocomplete/company';

    /**
     * @uses \SprykerFeature\Zed\SspFileManagement\Communication\Controller\AutocompleteController::companyUserAction()
     *
     * @var string
     */
    protected const DATASOURCE_URL_COMPANY_USER = '/ssp-file-management/autocomplete/company-user';

    /**
     * @uses \SprykerFeature\Zed\SspFileManagement\Communication\Controller\AutocompleteController::companyBusinessUnitAction()
     *
     * @var string
     */
    protected const DATASOURCE_URL_COMPANY_BUSINESS_UNIT = '/ssp-file-management/autocomplete/company-business-unit';
    ...
    protected function replaceCompanyField(FormInterface $form, array $choices): void
    {
        $form->add(static::FIELD_COMPANY_IDS, Select2ComboBoxType::class, [
            ...
            'choices' => $choices,
            'attr' => [
                'data-autocomplete-url' => static::DATASOURCE_URL_COMPANY,
    ...
    protected function replaceCompanyUserField(FormInterface $form, array $choices): void
    {
        $form->add(static::FIELD_COMPANY_USER_IDS, Select2ComboBoxType::class, [
            ...
            'choices' => $choices,
            'attr' => [
                'data-autocomplete-url' => static::DATASOURCE_URL_COMPANY_USER,
                'data-minimum-input-length' => static::DATASOURCE_MIN_CHARACTERS,
                'data-placeholder' => static::PLACEHOLDER_SEARCH,
    ...
    protected function replaceCompanyBusinessUnitField(FormInterface $form, array $choices): void
    {
        $form->add(static::FIELD_COMPANY_BUSINESS_UNIT_IDS, Select2ComboBoxType::class, [
            ...
            'choices' => $choices,
            'attr' => [
                'data-autocomplete-url' => static::DATASOURCE_URL_COMPANY_BUSINESS_UNIT,
                'data-minimum-input-length' => static::DATASOURCE_MIN_CHARACTERS,
                'data-placeholder' => static::PLACEHOLDER_SEARCH,
