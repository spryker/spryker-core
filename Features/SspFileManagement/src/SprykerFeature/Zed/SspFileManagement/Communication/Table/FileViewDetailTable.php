...
class FileViewDetailTable extends AbstractTable
{
    /**
     * @uses \SprykerFeature\Zed\SspFileManagement\Communication\Controller\ViewController::tableAction()
     *
     * @var string
     */
    protected const ROUTE_FILE_VIEW_DETAIL_TABLE = 'table?%s=%d';
    ...
    protected function buildLinks(array $item): string
    {
        ...
        $buttons[] = $this->generateFormButton(
            Url::generate(AbstractController::URL_SSP_FILE_MANAGEMENT_UNLINK, [
                AbstractController::REQUEST_PARAM_ID_FILE => $item[static::COL_ID_FILE],
                AbstractController::REQUEST_PARAM_ENTITY_TYPE => $item[static::COL_ENTITY_TYPE],
                AbstractController::REQUEST_PARAM_ENTITY_ID => $item[static::COL_ENTITY_ID],
            ]),
            'Unlink',
    ...
    protected function getFileUnionQuerySql(FileAttachmentFileViewDetailTableCriteriaTransfer $fileAttachmentFileViewDetailTableCriteriaTransfer): array
    {
        ...
        if (!$fileAttachmentFileViewDetailTableCriteriaTransfer->getEntityType() || $fileAttachmentFileViewDetailTableCriteriaTransfer->getEntityType() === SspFileManagementConfig::ENTITY_TYPE_COMPANY_BUSINESS_UNIT) {
        ...
        if (!$fileAttachmentFileViewDetailTableCriteriaTransfer->getEntityType() || $fileAttachmentFileViewDetailTableCriteriaTransfer->getEntityType() === SspFileManagementConfig::ENTITY_TYPE_COMPANY_USER) {
