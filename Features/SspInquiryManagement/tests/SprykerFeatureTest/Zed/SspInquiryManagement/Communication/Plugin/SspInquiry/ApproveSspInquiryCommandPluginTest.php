...
namespace SprykerFeatureTest\Zed\SspInquiryManagement\Communication\Plugin\SspInquiry;
...
class ApproveSspInquiryCommandPluginTest extends Unit
{
    ...
    /**
     * @var \SprykerFeature\Zed\SspInquiryManagement\Communication\Plugin\SspInquiryManagement\ApproveSspInquiryCommandPlugin
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->approveSspInquiryCommandPlugin->setFactory($this->sspInquiryCommunicationFactoryMock);
        $this->approveSspInquiryCommandPlugin->setFacade($this->sspInquiryManagementFacadeMock);
        $this->approveSspInquiryCommandPlugin->setConfig($this->sspInquiryManagementConfigMock);
    }
