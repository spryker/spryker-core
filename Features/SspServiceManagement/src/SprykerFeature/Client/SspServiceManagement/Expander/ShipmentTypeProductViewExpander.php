...
namespace SprykerFeature\Client\SspServiceManagement\Expander;
...
class ShipmentTypeProductViewExpander implements ShipmentTypeProductViewExpanderInterface
{
    ...
    /**
     * @param \SprykerFeature\Client\SspServiceManagement\Reader\ShipmentTypeStorageReaderInterface $shipmentTypeStorageReader
     */
