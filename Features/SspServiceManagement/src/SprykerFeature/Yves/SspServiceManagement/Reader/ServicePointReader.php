...
use SprykerFeature\Yves\SspServiceManagement\Controller\ServicePointSearchController;
    ...
    public function searchServicePoints(ServicePointSearchRequestTransfer $servicePointSearchRequestTransfer): string
    {
        ...
        return $this->twigEnvironment->render(
            ...
            [
                ...
                'searchRoute' => SspServiceManagementPageRouteProviderPlugin::ROUTE_NAME_SSP_SERVICE_MANAGEMENT_SERVICE_POINT_SEARCH,
                'items' => $itemTransfers,
            ],
        );
    }
