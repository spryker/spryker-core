...
namespace SprykerFeature\Zed\SspServiceManagement\Business\Canceler;
...
class OrderItemCanceler implements OrderItemCancelerInterface
{
     ...
     * @var string
     */
    protected const GLOSSARY_KEY_VALIDATION_STATUS_CHANGE_FAILED = 'ssp_service_management.validation.status_change_failed';
