...
class CreateOfferFormDataProvider
{
    ...
    /**
     * @var array<string, \SprykerFeature\Zed\SspServiceManagement\Communication\Form\DataTransformer\DataTransformerInterface<mixed, mixed>>
     */
     ...
     * @param array<string, \SprykerFeature\Zed\SspServiceManagement\Communication\Form\DataTransformer\DataTransformerInterface<mixed, mixed>> $formDataTransformers
    ...
    protected function prepareShipmentTypeChoices(ShipmentTypeCollectionTransfer $shipmentTypeCollectionTransfer): array
    {
        ...
        foreach ($shipmentTypeCollectionTransfer->getShipmentTypes() as $shipmentTypeTransfer) {
            $shipmentTypeChoices[$shipmentTypeTransfer->getNameOrFail()] = (string)$shipmentTypeTransfer->getUuidOrFail();
        }
    ...
    protected function prepareServicePointChoices(ServicePointCollectionTransfer $servicePointCollectionTransfer): array
    {
        ...
        foreach ($servicePointCollectionTransfer->getServicePoints() as $servicePointTransfer) {
            $servicePointChoices[$servicePointTransfer->getNameOrFail()] = (string)$servicePointTransfer->getIdServicePointOrFail();
        }
