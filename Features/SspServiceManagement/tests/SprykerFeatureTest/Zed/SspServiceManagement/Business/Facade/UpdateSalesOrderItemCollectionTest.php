...
namespace SprykerFeatureTest\Zed\SspServiceManagement\Business\Facade;
...
use SprykerFeatureTest\Zed\SspServiceManagement\SspServiceManagementBusinessTester;
...
class UpdateSalesOrderItemCollectionTest extends Unit
{
    ...
    /**
     * @uses \SprykerFeature\Zed\SspServiceManagement\Business\Updater\OrderItemScheduleUpdater::GLOSSARY_KEY_VALIDATION_NO_ORDER_ITEMS_PROVIDED
     *
     * @var string
     */
    ...
    /**
     * @uses \SprykerFeature\Zed\SspServiceManagement\Business\Updater\OrderItemScheduleUpdater::GLOSSARY_KEY_VALIDATION_NO_PAYMENT_METHODS_FOUND
     *
     * @var string
     */
    ...
    /**
     * @var \SprykerFeatureTest\Zed\SspServiceManagement\SspServiceManagementBusinessTester
     */
    protected SspServiceManagementBusinessTester $tester;
    ...
    {
        // Arrange
        $this->tester->setDependency(SspServiceManagementDependencyProvider::FACADE_SALES, $this->salesFacade);
