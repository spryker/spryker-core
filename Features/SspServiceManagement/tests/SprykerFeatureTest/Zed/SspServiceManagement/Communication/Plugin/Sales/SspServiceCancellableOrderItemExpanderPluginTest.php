...
use SprykerFeature\Zed\SspServiceManagement\Communication\SspServiceManagementCommunicationFactory;
...
class SspServiceCancellableOrderItemExpanderPluginTest extends Unit
{
    ...
    /**
     * @var \SprykerFeature\Zed\SspServiceManagement\Communication\Plugin\Sales\SspServiceCancellableOrderItemExpanderPlugin
     */
    ...
    protected function setUp(): void
    {
        ...
        $factoryMock = $this->createPartialMock(
            SspServiceManagementCommunicationFactory::class,
            ['getOmsFacade'],
        );
        ...
        $this->plugin->setFactory($factoryMock);
    }
