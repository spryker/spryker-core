...
namespace SprykerFeatureTest\Zed\SspServiceManagement\Communication\Plugin\SspAssetManagement;
...
class ServiceSspAssetManagementExpanderPluginTest extends Unit
{
     ...
     */
    protected function createFactoryMock(SspServiceCollectionTransfer $sspServiceCollectionTransfer): SspServiceManagementBusinessFactory
    {
        $factoryMock = $this->createPartialMock(SspServiceManagementBusinessFactory::class, ['createServiceReader']);
