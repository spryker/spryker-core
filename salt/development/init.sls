...
cd /data/shop/development/current; /data/shop/development/current/composer.phar --self-update; /data/shop/development/current/composer.phar --dev install; chown -R vagrant /data/shop/development/current; chgrp -R vagrant /data/shop/development/current:
  cmd.run:
