...
oh-my-zsh:
  cmd.run:
    - name: cd /home/vagrant; [[ -d /home/vagrant/.oh-my-zsh ]] || sudo -u vagrant git clone git://github.com/robbyrussell/oh-my-zsh.git /home/vagrant/.oh-my-zsh; chsh -s /bin/zsh vagrant
