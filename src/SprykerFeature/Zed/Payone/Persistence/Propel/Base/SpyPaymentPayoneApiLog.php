...
*/
abstract class SpyPaymentPayoneApiLog implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\SprykerFeature\\Zed\\Payone\\Persistence\\Propel\\Map\\SpyPaymentPayoneApiLogTableMap';
    ...
    /**
     * Initializes internal state of SprykerFeature\Zed\Payone\Persistence\Propel\Base\SpyPaymentPayoneApiLog object.
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\SprykerFeature\Zed\Payone\Persistence\Propel\SpyPaymentPayoneApiLog
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SprykerFeature\Zed\Payone\Persistence\Propel\SpyPaymentPayoneApiLog The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SprykerFeature\Zed\Payone\Persistence\Propel\SpyPaymentPayoneApiLog (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SprykerFeature\Zed\Payone\Persistence\Propel\SpyPaymentPayoneApiLog Clone of current object.
     * @throws PropelException
     */
