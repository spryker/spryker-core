...
abstract class SpyPaymentPayoneApiLogQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \SprykerFeature\Zed\Payone\Persistence\Propel\Base\SpyPaymentPayoneApiLogQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\SprykerFeature\\Zed\\Payone\\Persistence\\Propel\\SpyPaymentPayoneApiLog', $modelAlias = null)
    {
