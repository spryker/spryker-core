...
abstract class SpyPaymentPayoneTransactionStatusLogQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id_payment_payone_transaction_status_log`, `fk_payment_payone`, `transaction_id`, `reference_id`, `mode`, `status`, `transaction_time`, `sequence_number`, `clearing_type`, `portal_id`, `balance`, `receivable`, `created_at`, `updated_at` FROM `spy_payment_payone_transaction_status_log` WHERE `id_payment_payone_transaction_status_log` = :p0';
        try {
