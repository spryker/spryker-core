...
class SpyPaymentPayoneTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'vendor.spryker.payone.src.SprykerFeature.Zed.Payone.Persistence.Propel.Map.SpyPaymentPayoneTableMap';
     ...
     */
    const OM_CLASS = '\\SprykerFeature\\Zed\\Payone\\Persistence\\Propel\\SpyPaymentPayone';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'vendor.spryker.payone.src.SprykerFeature.Zed.Payone.Persistence.Propel.SpyPaymentPayone';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPaymentPayone', 'PaymentMethod', 'TransactionId', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('idPaymentPayone', 'paymentMethod', 'transactionId', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(SpyPaymentPayoneTableMap::COL_ID_PAYMENT_PAYONE, SpyPaymentPayoneTableMap::COL_PAYMENT_METHOD, SpyPaymentPayoneTableMap::COL_TRANSACTION_ID, SpyPaymentPayoneTableMap::COL_CREATED_AT, SpyPaymentPayoneTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id_payment_payone', 'payment_method', 'transaction_id', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPaymentPayone' => 0, 'PaymentMethod' => 1, 'TransactionId' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('idPaymentPayone' => 0, 'paymentMethod' => 1, 'transactionId' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(SpyPaymentPayoneTableMap::COL_ID_PAYMENT_PAYONE => 0, SpyPaymentPayoneTableMap::COL_PAYMENT_METHOD => 1, SpyPaymentPayoneTableMap::COL_TRANSACTION_ID => 2, SpyPaymentPayoneTableMap::COL_CREATED_AT => 3, SpyPaymentPayoneTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id_payment_payone' => 0, 'payment_method' => 1, 'transaction_id' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\SprykerFeature\\Zed\\Payone\\Persistence\\Propel\\SpyPaymentPayone');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SprykerFeature\Zed\Payone\Persistence\Propel\SpyPaymentPayone) { // it's a model object
